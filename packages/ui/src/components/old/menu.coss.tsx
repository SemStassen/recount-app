  ...
  return (
    <MenuPrimitive.Portal>
      ...
      >
        <MenuPrimitive.Popup
          className={cn(
            "flex not-[class*='w-']:min-w-32 origin-(--transform-origin) rounded-lg border bg-popover outline-none focus:outline-none",
            className
          )}
      ...
      {variant === "switch" ? (
        <>
          ...
          <MenuPrimitive.CheckboxItemIndicator
            className="inline-flex h-[calc(var(--thumb-size)+2px)] w-[calc(var(--thumb-size)*2-2px)] shrink-0 items-center rounded-full p-px outline-none transition-colors duration-200 [--thumb-size:--spacing(4)] focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-1 focus-visible:ring-offset-background data-checked:bg-primary data-unchecked:bg-input data-disabled:opacity-64 sm:[--thumb-size:--spacing(3)]"
            keepMounted
          >
            <span className="pointer-events-none block aspect-square h-full origin-left rounded-(--thumb-size) bg-background in-[[data-slot=menu-checkbox-item][data-checked]]:origin-[var(--thumb-size)_50%] in-[[data-slot=menu-checkbox-item][data-checked]]:translate-x-[calc(var(--thumb-size)-4px)] [transition:translate_.15s,transform-origin_.15s]" />
          </MenuPrimitive.CheckboxItemIndicator>
        </>
      ) : (
        <>
