    ...
    <SheetPortal>
      ...
      <SheetViewport side={side} variant={variant}>
        <SheetPrimitive.Popup
          className={cn(
            "flex max-h-full min-h-0 w-full min-w-0 flex-col bg-popover text-popover-foreground transition-[opacity,translate] duration-200 ease-in-out will-change-transform data-ending-style:opacity-0 data-starting-style:opacity-0",
            side === "bottom" &&
            ...
            variant === "inset" &&
              "sm:rounded-xl sm:border sm:**:data-[slot=sheet-footer]:rounded-b-xl",
            className
          )}
