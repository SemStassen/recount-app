...
export function CommandPanel({
  ...
  return (
    <div
      className={cn(
        "min-h-0 rounded-t-xl not-has-[+[data-slot=command-footer]]:rounded-b-xl border-t bg-popover **:data-[slot=scroll-area-scrollbar]:mt-2",
        className
      )}
      {...props}
    />
