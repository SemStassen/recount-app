...
export class AiAssistantError extends Schema.TaggedErrorClass<AiAssistantError>()(
  "AiAssistantError",
  {
...
export class AiAssistant extends Context.Service<
  AiAssistant,
  {
...
>()("acme/AiAssistant") {
  static readonly layer = Layer.effect(
    ...
    Effect.gen(function* () {
      ...
      const newSession = yield* Chat.fromPrompt(
        Prompt.empty.pipe(
          Prompt.setSystem(
