...
it.effect(
  "withTransaction surfaces acquire failures instead of defecting",
  () =>
    Effect.gen(function* () {
...
it.effect(
  "withTransaction surfaces missing-client acquire as ConnectionError",
  () =>
    Effect.gen(function* () {
      const sql = yield* PgClient.fromPool({
