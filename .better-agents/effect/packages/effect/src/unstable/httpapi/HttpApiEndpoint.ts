 ...
 * @since 4.0.0
 */
export const isHttpApiEndpoint = (
  u: unknown
): u is HttpApiEndpoint<any, any, any> => Predicate.hasProperty(u, TypeId);
 ...
 * @since 4.0.0
 */
export type PayloadMap = ReadonlyMap<
  string,
  {
...
/** @internal */
export function getSuccessSchemas(
  endpoint: AnyWithProps
 ...
 * @since 4.0.0
 */
export type Params<Endpoint extends Any> =
  Endpoint extends HttpApiEndpoint<
    infer _Name,
    infer _Method,
    infer _Path,
 ...
 * @since 4.0.0
 */
export type Query<Endpoint extends Any> =
  Endpoint extends HttpApiEndpoint<
    infer _Name,
    infer _Method,
    infer _Path,
 ...
 * @since 4.0.0
 */
export type MiddlewareProvides<Endpoint extends Any> =
 ...
 * @since 4.0.0
 */
export type MiddlewareClient<Endpoint extends Any> =
  HttpApiMiddleware.MiddlewareClient<Middleware<Endpoint>>;
 ...
 * @since 4.0.0
 */
export type MiddlewareError<Endpoint extends Any> = HttpApiMiddleware.Error<
  Middleware<Endpoint>
>;
 ...
 * @since 4.0.0
 */
export type Errors<Endpoint extends Any> =
  Endpoint extends HttpApiEndpoint<
    infer _Name,
    infer _Method,
    infer _Path,
 ...
 * @since 4.0.0
 */
export type ClientResponseMode =
  | "decoded-only"
...
export type Handler<Endpoint extends Any, E, R> = (
  ...
  Endpoint["~Success"]["Type"] | HttpServerResponse,
 ...
 * @since 4.0.0
 */
export type HandlerRawWithName<
  Endpoints extends Any,
  Name extends string,
  E,
  R,
> = HandlerRaw<WithName<Endpoints, Name>, E, R>;
 ...
 * @since 4.0.0
 */
export type SuccessWithName<
  Endpoints extends Any,
  Name extends string,
> = Success<WithName<Endpoints, Name>>["Type"];
 ...
 * @since 4.0.0
 */
export type ErrorsWithName<Endpoints extends Any, Name extends string> = Errors<
 ...
 * @since 4.0.0
 */
export type ServerServicesWithName<
  Endpoints extends Any,
  Name extends string,
> = ServerServices<WithName<Endpoints, Name>>;
...
export type MiddlewareWithName<
  Endpoints extends Any,
  Name extends string,
> = Middleware<WithName<Endpoints, Name>>;
 ...
 * @since 4.0.0
 */
export type MiddlewareServicesWithName<
  Endpoints extends Any,
  Name extends string,
> = MiddlewareServices<WithName<Endpoints, Name>>;
 ...
 * @since 4.0.0
 */
export type ExcludeProvidedWithName<
  Endpoints extends Any,
  Name extends string,
  R,
> = ExcludeProvided<WithName<Endpoints, Name>, R>;
...
export type AddPrefix<
  ...
  Prefix extends HttpRouter.PathInput,
> =
  Endpoint extends HttpApiEndpoint<
    infer _Name,
    infer _Method,
...
export type AddMiddleware<
  Endpoint extends Any,
  M extends HttpApiMiddleware.AnyId,
> =
  Endpoint extends HttpApiEndpoint<
    infer _Name,
    infer _Method,
...
export const make =
  <Method extends HttpMethod>(
    ...
    <
      ...
      const Success extends Schema.Top | ReadonlyArray<Schema.Top> =
  ...
  >(
    ...
    Payload extends Schema.Struct.Fields
      ...
      : Payload extends ReadonlyArray<Schema.Top>
        ? Payload[number]
        : Payload,
    Headers extends Schema.Struct.Fields ? Schema.Struct<Headers> : Headers,
    Success extends ReadonlyArray<Schema.Top> ? Success[number] : Success,
  ...
  > => {
    ...
    const transformStringTree = disableCodecs
      ? identity
...
type ExtractSchemaOrArray<
  S extends Schema.Struct.Fields | Schema.Top | ReadonlyArray<Schema.Top>,
> = S extends Schema.Struct.Fields
  ? Schema.Struct<S>
  : S extends ReadonlyArray<Schema.Top>
    ? S[number]
    : S;
 ...
 * @since 4.0.0
 */
export interface Json<S extends Schema.Top> extends Schema.Codec<
  S["Type"],
  Schema.Json,
  S["DecodingServices"],
  S["EncodingServices"]
 ...
 * @since 4.0.0
 */
export interface StringTree<S extends Schema.Top> extends Schema.Codec<
  S["Type"],
  Schema.StringTree,
  S["DecodingServices"],
  S["EncodingServices"]
...
function getPayload(
  ...
  const result: Map<
    string,
    {
      encoding: HttpApiSchema.PayloadEncoding;
  ...
  for (const schema of schemas) {
    ...
    if (existing) {
      if (existing.encoding._tag !== encoding._tag) {
        throw new Error(
          `Multiple payload encodings for content-type: ${encoding.contentType}`
        );
      }
      if (existing.encoding._tag === "Multipart") {
        throw new Error(
          `Multiple multipart payloads for content-type: ${encoding.contentType}`
        );
      }
