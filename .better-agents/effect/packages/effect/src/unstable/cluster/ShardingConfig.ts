 ...
 * @since 4.0.0
 */
export class ShardingConfig extends Context.Service<
  ShardingConfig,
  {
    /**
 ...
 */
export const layer = (
  options?: Partial<ShardingConfig["Service"]>
...
export const config: Config.Config<ShardingConfig["Service"]> = Config.all({
  ...
  availableShardGroups: Config.schema(
  ...
  assignedShardGroups: Config.schema(
    Schema.Array(Schema.String),
    "shardGroups"
  ).pipe(
    Config.withDefault(["default"])
