 ...
 */
export const getCommandsForCommandPath = <
  Name extends string,
  Input,
  E,
  R,
 ...
 */
export const getGlobalFlagsForCommandPath = <
  Name extends string,
  Input,
  E,
  R,
...
const collectDeclaredGlobalFlags = (
  command: Command.Any
): ReadonlyArray<GlobalFlag.GlobalFlag<any>> => {
 ...
 */
export const getGlobalFlagsForCommandTree = <
  Name extends string,
  Input,
  E,
  R,
...
>(
  ...
  dedupeGlobalFlags([...builtIns, ...collectDeclaredGlobalFlags(command)]);
 ...
 */
export const getHelpForCommandPath = <
  Name extends string,
  Input,
  E,
  R,
...
>(
  ...
  Effect.gen(function* () {
    ...
    const currentCommand =
      commands.length > 0 ? commands[commands.length - 1] : command;
