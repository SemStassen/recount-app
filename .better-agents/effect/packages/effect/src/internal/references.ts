...
/** @internal */
export const CurrentConcurrency = Context.Reference<"unbounded" | number>(
...
export const TracerTimingEnabled = Context.Reference<boolean>(
  "effect/References/TracerTimingEnabled",
  {
    defaultValue: constTrue,
  }
);
...
>("effect/References/TracerSpanAnnotations", { defaultValue: () => ({}) });
...
export const CurrentLogAnnotations = Context.Reference<
  ReadonlyRecord<string, unknown>
>("effect/References/CurrentLogAnnotations", { defaultValue: () => ({}) });

/** @internal */
export const CurrentLogLevel: Context.Reference<Severity> =
  Context.Reference<Severity>("effect/References/CurrentLogLevel", {
    defaultValue: () => "Info",
  });
...
export const UnhandledLogLevel: Context.Reference<Severity | undefined> =
  Context.Reference("effect/References/UnhandledLogLevel", {
