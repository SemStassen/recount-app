 ...
 * @since 4.0.0
 */
export const META_SCHEMA_URI_DRAFT_07 =
  "http://json-schema.org/draft-07/schema";
 ...
 * @since 4.0.0
 */
export const META_SCHEMA_URI_DRAFT_2020_12 =
  "https://json-schema.org/draft/2020-12/schema";
  ...
  function walk(node: unknown, isRoot: boolean): unknown {
    ...
    for (const k of Object.keys(node)) {
      ...
      switch (k) {
        case "$ref":
          out.$ref =
            typeof v === "string" ? v.replace(RE_DEFINITIONS, "#/$defs") : v;
          break;
    ...
    if (prefixItems !== undefined) {
      if (Array.isArray(prefixItems)) {
        ...
        if (additionalItems !== undefined)
          out.items = walk(additionalItems, false);
      } else {
 ...
 * @since 4.0.0
 */
export function fromSchemaDraft2020_12(
  js: JsonSchema
 ...
 * @since 4.0.0
 */
export function fromSchemaOpenApi3_1(
  js: JsonSchema
): Document<"draft-2020-12"> {
  const schema = rewrite_refs(js, (ref) =>
    ref.replace(RE_COMPONENTS_SCHEMAS, "#/$defs")
  ) as JsonSchema;
 ...
 * @since 4.0.0
 */
export function fromSchemaOpenApi3_0(
  schema: JsonSchema
): Document<"draft-2020-12"> {
 ...
 * @since 4.0.0
 */
export function toDocumentDraft07(
...
/** @internal */
export const VALID_OPEN_API_COMPONENTS_SCHEMAS_KEY_REGEXP =
  /^[a-zA-Z0-9.\-_]+$/;
 ...
 * @since 4.0.0
 */
export function resolveTopLevel$ref(
  document: Document<"draft-2020-12">
): Document<"draft-2020-12"> {
