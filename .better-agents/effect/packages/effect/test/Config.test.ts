...
describe("Config", () => {
  ...
  at ["b"]`
      ...
      it("iterable", async () => {
        const config = Config.all(
          new Set([Config.nonEmptyString("a"), Config.finite("b")])
        );
  ...
  at ["d"]`
    ...
    describe("withDefault", () => {
      it("value", async () => {
        ...
        const config = Config.finite("a").pipe(
  ...
  at ["a"]`
      ...
      it("redacted", async () => {
        ...
        const config = Config.redacted("a").pipe(
          Config.withDefault(defaultValue)
        );
  ...
  at ["b"]["a"]`
        ...
        it("name + nested + nested", async () => {
          const config = Config.string("a").pipe(
            Config.nested("b"),
            Config.nested("c")
          );
  ...
  at ["database"]["host"]`
    ...
    describe("unwrap", () => {
      it("plain object", async () => {
        ...
        await assertSuccess(
          config,
          ConfigProvider.fromUnknown({ a2: "value" }),
          { a: "value" }
        );
      });
  ...
  describe("fromEnv", () => {
    ...
    describe("leafs and containers", () => {
      it("node can be both leaf and object", async () => {
        ...
        await assertSuccess(
          config,
          ConfigProvider.fromEnv({ env: { a: "1", a_b: "2" } }),
          { a: 1 }
        );
      });
      ...
      it("node can be both leaf and array", async () => {
        ...
        await assertSuccess(
          config,
          ConfigProvider.fromEnv({ env: { a: "1", a_0: "2" } }),
          { a: 1 }
        );
      });
      ...
      it("if a node can be both object and array, it should be an object", async () => {
        const schema = Schema.Struct({
          a: Schema.Struct({ b: Schema.Number }),
        });
        const config = Config.schema(schema);
    ...
    it("Null", async () => {
      ...
      await assertSuccess(
        config,
        ConfigProvider.fromEnv({ env: { a: "null" } }),
        null
      );
      await assertFailure(
        config,
  ...
  at ["a"]`
    ...
    it("Boolean", async () => {
      ...
      await assertSuccess(
        config,
        ConfigProvider.fromEnv({ env: { a: "true" } }),
        true
      );
      await assertSuccess(
        config,
        ConfigProvider.fromEnv({ env: { a: "false" } }),
        false
      );
      await assertFailure(
        config,
  ...
  at ["a"]`
    ...
    describe("Struct", () => {
      ...
      it("literal property", async () => {
        ...
        await assertSuccess(
          config,
          ConfigProvider.fromEnv({ env: { a: "b" } }),
          { a: "b" }
        );
        await assertSuccess(
          config,
          ConfigProvider.fromEnv({ env: { a: "c" } }),
          { a: "c" }
        );
      });
      ...
      it("array property", async () => {
        ...
        await assertSuccess(
          config,
          ConfigProvider.fromEnv({ env: { a_0: "1" } }),
          { a: [1] }
        );
        await assertSuccess(
          config,
          ConfigProvider.fromEnv({ env: { a_0: "1", a_1: "2" } }),
          { a: [1, 2] }
        );
        await assertSuccess(
          config,
    ...
    it("Record(String, Finite)", async () => {
      ...
      await assertSuccess(config, ConfigProvider.fromEnv({ env: { a: "1" } }), {
        a: 1,
      });
      await assertSuccess(
        config,
        ConfigProvider.fromEnv({ env: { a: "1", b: "2" } }),
        { a: 1, b: 2 }
      );
      await assertFailure(
        config,
  ...
  at ["b"]`
    ...
    describe("Tuple", () => {
      ...
      it("required elements", async () => {
        const schema = Schema.Struct({
          a: Schema.Tuple([Schema.String, Schema.Finite]),
        });
        const config = Config.schema(schema);

        await assertSuccess(
          config,
          ConfigProvider.fromEnv({ env: { a_0: "a", a_1: "2" } }),
          { a: ["a", 2] }
        );
        await assertFailure(
          config,
  ...
  at ["a"][1]`
    ...
    describe("Union", () => {
      ...
      it("inclusive", async () => {
        ...
        await assertSuccess(
          config,
          ConfigProvider.fromEnv({ env: { b: "1" } }),
          { b: 1 }
        );
        await assertSuccess(
          config,
    ...
    it("Suspend", async () => {
      ...
      await assertSuccess(
        config,
        ConfigProvider.fromEnv({ env: { a: "1", as: "" } }),
        { a: "1", as: [] }
      );
      await assertSuccess(
        config,
  ...
  describe("fromUnknown", () => {
    ...
    it("Undefined", async () => {
      ...
      await assertSuccess(
        config,
        ConfigProvider.fromUnknown(undefined),
        undefined
      );
      await assertFailure(
        config,
...
Expected "Infinity" | "-Infinity" | "NaN", got "a"`
  ...
  at ["a"]`
      ...
      it("literal property", async () => {
        ...
        await assertSuccess(config, ConfigProvider.fromUnknown({ a: "b" }), {
          a: "b",
        });
        await assertSuccess(config, ConfigProvider.fromUnknown({ a: "c" }), {
          a: "c",
        });
      });
      ...
      it("array property", async () => {
        ...
        await assertSuccess(config, ConfigProvider.fromUnknown({ a: "" }), {
          a: [],
        });
        await assertSuccess(config, ConfigProvider.fromUnknown({ a: "1" }), {
          a: [1],
    ...
    it("Record(String, Finite)", async () => {
      ...
      await assertSuccess(
        config,
        ConfigProvider.fromUnknown({ a: "1", b: "2" }),
        { a: 1, b: 2 }
      );
      await assertFailure(
        config,
  ...
  at ["b"]`
    ...
    describe("Tuple", () => {
      ...
      it("required elements", async () => {
        ...
        await assertSuccess(config, ConfigProvider.fromUnknown(["a", "2"]), [
          "a",
          2,
        ]);
        await assertFailure(
  ...
  at [1]`
    ...
    it("Array(Finite)", async () => {
      ...
      await assertSuccess(
        config,
        ConfigProvider.fromUnknown(["1", "2"]),
        [1, 2]
      );
      await assertFailure(
        config,
  ...
  at [1]`
    ...
    describe("Union", () => {
      ...
      it("inclusive", async () => {
        ...
        await assertSuccess(config, ConfigProvider.fromUnknown({ b: "1" }), {
          b: 1,
        });
        await assertSuccess(
          config,
    ...
    it("Suspend", async () => {
      ...
      await assertSuccess(
        config,
        ConfigProvider.fromUnknown({ a: "1", as: [] }),
        { a: "1", as: [] }
      );
      await assertSuccess(
        config,
