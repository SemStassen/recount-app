...
describe("toStandardJSONSchemaV1", () => {
  ...
  it("should support both standards", () => {
    ...
    const both = Schema.toStandardSchemaV1(
  ...
  describe("draft-07", () => {
    it("should return the input JSON Schema", () => {
      ...
      const standardJSONSchema = Schema.toStandardJSONSchemaV1(schema);
      deepStrictEqual(
        standardConvertToJSONSchemaInput(standardJSONSchema, "draft-07"),
        {
          type: "array",
          items: [{ type: "string" }],
          minItems: 1,
    ...
    it("should return the output JSON Schema", () => {
      ...
      const standardJSONSchema = Schema.toStandardJSONSchemaV1(schema);
      deepStrictEqual(
        standardConvertToJSONSchemaOutput(standardJSONSchema, "draft-07"),
        {
          type: "array",
          items: [{ type: "number" }],
          minItems: 1,
