...
describe("toJsonSchemaDocument", () => {
        ...
        assertJsonSchemaDocument(
          ...
          },
          {
            includeAnnotationKey: (key) =>
              key === "markdownDescription" || key === "defaultSnippets",
          }
        );
      });

      it("passthroughs at check level", () => {
        const schema = Schema.String.annotate({ description: "A string" }).pipe(
          Schema.check(
  ...
  describe("identifier handling", () => {
    ...
    it("using the same identifier annotated schema twice", () => {
      ...
      assertJsonSchemaDocument(Schema.Union([S, S]), {
        schema: {
          anyOf: [{ $ref: "#/$defs/id" }, { $ref: "#/$defs/id" }],
        },
        definitions: {
          id: { type: "string" },
        },
    ...
    it("should handle duplicate identifiers on different schemas with different representations", () => {
      ...
      assertJsonSchemaDocument(S, {
        schema: {
          anyOf: [{ $ref: "#/$defs/id" }, { $ref: "#/$defs/id1" }],
        },
        definitions: {
  ...
  describe("String", () => {
    it("String", () => {
      assertJsonSchemaDocument(Schema.String, {
        schema: {
          type: "string",
        },
      });
    ...
    it("String & annotate", () => {
      assertJsonSchemaDocument(Schema.String.annotate({ description: "a" }), {
        schema: {
          type: "string",
          description: "a",
        },
    ...
    it("String & check", () => {
      assertJsonSchemaDocument(Schema.String.check(Schema.isMinLength(2)), {
        schema: {
          type: "string",
          allOf: [{ minLength: 2 }],
        },
    ...
    it("String & check & annotate", () => {
      assertJsonSchemaDocument(
        ...
        }),
        {
          schema: {
            type: "string",
            allOf: [{ minLength: 2, description: "a" }],
          },
        }
      );
    });
    ...
    describe("checks", () => {
      it("isPattern", () => {
        assertJsonSchemaDocument(
          Schema.String.check(Schema.isPattern(/^abb+$/)),
          {
            schema: {
              type: "string",
              allOf: [{ pattern: "^abb+$" }],
      ...
      describe("isLengthBetween", () => {
        ...
        it("NonEmptyArray", () => {
          assertJsonSchemaDocument(
            Schema.NonEmptyArray(Schema.String).check(
      ...
      describe("isMaxLength", () => {
        it("String", () => {
          assertJsonSchemaDocument(Schema.String.check(Schema.isMaxLength(2)), {
            schema: {
              type: "string",
              allOf: [{ maxLength: 2 }],
            },
      ...
      it("isUUID", () => {
        assertJsonSchemaDocument(
          Schema.String.annotate({ description: "description" }).check(
            Schema.isUUID()
          ),
          {
            schema: {
  ...
  describe("Finite", () => {
    it("Finite", () => {
      assertJsonSchemaDocument(Schema.Finite, {
        schema: {
          type: "number",
        },
      });
      assertJsonSchemaDocument(Schema.Finite.annotate({ description: "a" }), {
        schema: {
          type: "number",
          allOf: [
            {
    ...
    describe("checks", () => {
      it("isInt", () => {
        assertJsonSchemaDocument(Schema.Finite.check(Schema.isInt()), {
          schema: {
            type: "integer",
          },
        });
      ...
      it("isInt32", () => {
        assertJsonSchemaDocument(Schema.Finite.check(Schema.isInt32()), {
          schema: {
            type: "integer",
            allOf: [{ maximum: 2147483647, minimum: -2147483648 }],
          },
        });
      });

      it("isUint32", () => {
        assertJsonSchemaDocument(Schema.Finite.check(Schema.isUint32()), {
          schema: {
            type: "integer",
            allOf: [{ maximum: 4294967295, minimum: 0 }],
          },
        });
        assertJsonSchemaDocument(
      ...
      it("isGreaterThan", () => {
        assertJsonSchemaDocument(Schema.Finite.check(Schema.isGreaterThan(1)), {
          schema: {
            type: "number",
      ...
      it("isLessThanOrEqualTo", () => {
        assertJsonSchemaDocument(
          Schema.Finite.check(Schema.isLessThanOrEqualTo(1)),
          {
            schema: {
              type: "number",
              allOf: [{ maximum: 1 }],
      ...
      it("isBetween", () => {
        ...
        assertJsonSchemaDocument(
          ...
          ),
          {
            schema: {
              type: "number",
              allOf: [{ exclusiveMinimum: 1, maximum: 10 }],
            },
          }
        );
        assertJsonSchemaDocument(
          ...
          ),
          {
            schema: {
              type: "number",
              allOf: [{ minimum: 1, exclusiveMaximum: 10 }],
            },
          }
        );
        assertJsonSchemaDocument(
          ...
          ),
          {
            schema: {
              type: "number",
              allOf: [{ exclusiveMinimum: 1, exclusiveMaximum: 10 }],
            },
          }
        );
      });
      ...
      it("isMultipleOf", () => {
        assertJsonSchemaDocument(Schema.Int.check(Schema.isMultipleOf(2)), {
          schema: {
            type: "integer",
            allOf: [{ multipleOf: 2 }],
          },
  ...
  describe("Union of literals", () => {
    it("strings", () => {
      ...
      assertJsonSchemaDocument(schema.annotate({ ...jsonAnnotations }), {
        schema: {
          type: "string",
          enum: ["a", "b"],
          ...jsonAnnotations,
  ...
  describe("Struct", () => {
    ...
    describe("required property", () => {
      ...
      it("String & annotate & annotateKey", () => {
        assertJsonSchemaDocument(
          Schema.Struct({
            a: Schema.String.annotate({ description: "a" }).annotateKey({
              description: "a-key",
            }),
          }),
          {
    ...
    describe("optionalKey", () => {
      ...
      it("String & annotateKey", () => {
        assertJsonSchemaDocument(
          Schema.Struct({
            ...
            b: Schema.optionalKey(Schema.String).annotateKey({
              description: "b-key",
            }),
          }),
          {
      ...
      it("String & annotate & annotateKey", () => {
        assertJsonSchemaDocument(
          Schema.Struct({
            a: Schema.optionalKey(
              Schema.String.annotate({ description: "a" }).annotateKey({
                description: "a-key",
              })
            ),
            b: Schema.optionalKey(Schema.String)
              .annotate({ description: "b" })
              .annotateKey({ description: "b-key" }),
            c: Schema.optionalKey(
              Schema.String.annotate({ description: "a" }).annotateKey({
                description: "a-key",
              })
            )
              .annotate({ description: "c-outer" })
              .annotateKey({ description: "c-outer-key" }),
          }),
          {
            schema: {
              type: "object",
    ...
    describe("optional", () => {
      ...
      it("String & annotateKey", () => {
        assertJsonSchemaDocument(
          Schema.Struct({
            a: Schema.optional(Schema.String).annotateKey({
              description: "a-key",
            }),
            b: Schema.optional(
    ...
    describe("UndefinedOr", () => {
      ...
      it("String & annotateKey", () => {
        assertJsonSchemaDocument(
          Schema.Struct({
            a: Schema.UndefinedOr(Schema.String).annotateKey({
              description: "a-key",
            }),
            b: Schema.UndefinedOr(
              Schema.String.annotate({ description: "b" })
            ).annotateKey({ description: "b-key" }),
          }),
          {
      ...
      it("UndefinedOr(String) to String", () => {
        assertJsonSchemaDocument(
          Schema.Struct({
            a: Schema.UndefinedOr(Schema.String).pipe(
              Schema.encodeTo(Schema.String, {
                decode: SchemaGetter.passthrough(),
  ...
  describe("Record", () => {
    it("Record(String, Never)", () => {
      assertJsonSchemaDocument(Schema.Record(Schema.String, Schema.Never), {
        schema: {
          type: "object",
          additionalProperties: false,
        },
    ...
    it("Record(String, Finite)", () => {
      assertJsonSchemaDocument(Schema.Record(Schema.String, Schema.Finite), {
        schema: {
          type: "object",
          additionalProperties: {
            type: "number",
    ...
    describe("checks", () => {
      it("isMinProperties", () => {
        assertJsonSchemaDocument(
          Schema.Record(Schema.String, Schema.Finite).check(
  ...
  describe("Tuple", () => {
    ...
    describe("required element", () => {
      it("String", () => {
        assertJsonSchemaDocument(Schema.Tuple([Schema.String]), {
          schema: {
            type: "array",
      ...
      it("String & annotateKey", () => {
        assertJsonSchemaDocument(
          Schema.Tuple([Schema.String.annotateKey({ description: "a-key" })]),
          {
            schema: {
              type: "array",
              prefixItems: [
      ...
      it("String & annotateKey", () => {
        assertJsonSchemaDocument(
          Schema.Tuple([
            ...
            Schema.optionalKey(Schema.String).annotateKey({
              description: "b-key",
            }),
          ]),
          {
  ...
  describe("Array", () => {
    it("Array(String)", () => {
      assertJsonSchemaDocument(Schema.Array(Schema.String), {
        schema: {
          type: "array",
          items: { type: "string" },
        },
    ...
    describe("checks", () => {
      ...
      it("UniqueArray", () => {
        assertJsonSchemaDocument(Schema.UniqueArray(Schema.String), {
          schema: {
            type: "array",
            items: { type: "string" },
  ...
  describe("Union", () => {
    it("empty union", () => {
      ...
      assertJsonSchemaDocument(
        Schema.Union([]).annotate({ description: "a" }),
        {
          schema: {
            not: {},
            description: "a",
    ...
    it("single member", () => {
      ...
      assertJsonSchemaDocument(
        Schema.Union([Schema.String]).annotate({ description: "a" }),
        {
          schema: {
            anyOf: [
              {
      ...
      assertJsonSchemaDocument(
        Schema.Union([
          Schema.String.annotate({ description: "inner" }),
        ]).annotate({ description: "outer" }),
        {
          schema: {
            anyOf: [
              {
    ...
    it("String | Number", () => {
      assertJsonSchemaDocument(Schema.Union([Schema.String, Schema.Finite]), {
        schema: {
    ...
    it("String | BigInt", () => {
      assertJsonSchemaDocument(Schema.Union([Schema.String, Schema.BigInt]), {
        schema: {
          anyOf: [
            {
              type: "string",
  ...
  it("mutually recursive schemas", () => {
    ...
    assertJsonSchemaDocument(Operation, {
      schema: {
        $ref: "#/$defs/Operation",
      },
      definitions: {
    ...
    assertJsonSchemaDocument(Expression, {
      schema: {
        $ref: "#/$defs/Expression",
      },
      definitions: {
  ...
  describe("fromJsonString", () => {
    it("top level fromJsonString", () => {
      assertJsonSchemaDocument(Schema.fromJsonString(Schema.FiniteFromString), {
        schema: {
          type: "string",
          contentMediaType: "application/json",
          contentSchema: {
