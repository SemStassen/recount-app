...
describe("fromJsonSchemaDocument", () => {
  function assertFromJsonSchema(
    ...
    if (runtime !== undefined) {
      strictEqual(
        SchemaRepresentation.toCodeDocument(multiDocument).codes[0].runtime,
        runtime
      );
    }
  }
        ...
        assertFromJsonSchema(
          { schema: { type: "string", maxLength: 1 } },
          {
            representation: {
              _tag: "String",
              checks: [
                { _tag: "Filter", meta: { _tag: "isMaxLength", maxLength: 1 } },
              ],
            },
          },
          ...
          { schema: { type: "number", minimum: 1 } },
          {
            representation: {
              ...
              checks: [
                ...
                {
                  _tag: "Filter",
                  meta: { _tag: "isGreaterThanOrEqualTo", minimum: 1 },
                },
              ],
            },
          },
          ...
          { schema: { type: "number", maximum: 1 } },
          {
            representation: {
              ...
              checks: [
                ...
                {
                  _tag: "Filter",
                  meta: { _tag: "isLessThanOrEqualTo", maximum: 1 },
                },
              ],
            },
          },
          ...
          { schema: { type: "number", exclusiveMinimum: 1 } },
          {
            representation: {
              ...
              checks: [
                ...
                {
                  _tag: "Filter",
                  meta: { _tag: "isGreaterThan", exclusiveMinimum: 1 },
                },
              ],
            },
          },
          ...
          { schema: { type: "number", exclusiveMaximum: 1 } },
          {
            representation: {
              ...
              checks: [
                ...
                {
                  _tag: "Filter",
                  meta: { _tag: "isLessThan", exclusiveMaximum: 1 },
                },
              ],
            },
          },
              ...
              },
              {
                parameter: {
                  ...
                  checks: [
                    {
                      _tag: "Filter",
                      meta: { _tag: "isPattern", regExp: new RegExp("b*") },
                    },
                  ],
                },
                type: {
          ...
          { schema: { type: "object", maxProperties: 1 } },
          {
            representation: {
              ...
              checks: [
                {
                  _tag: "Filter",
                  meta: { _tag: "isMaxProperties", maxProperties: 1 },
                },
              ],
            },
          },
                  ...
                  meta: {
                    ...
                    propertyNames: {
                      ...
                      checks: [
                        {
                          _tag: "Filter",
                          meta: { _tag: "isMinLength", minLength: 2 },
                        },
                      ],
                    },
                  },
              ...
              allOf: [
                {
                  minLength: 1,
                  description: "b",
                  allOf: [{ maxLength: 2, description: "c" }],
                },
              ],
            },
          },
          ...
          },
          {
            representation: {
              ...
              checks: [
                ...
                {
                  _tag: "Filter",
                  meta: { _tag: "isGreaterThanOrEqualTo", minimum: 2 },
                },
                {
                  _tag: "Filter",
