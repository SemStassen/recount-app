...
describe("Serializers", () => {
    ...
    describe("schemas without encoding", () => {
      ...
      describe("Declaration", () => {
        it("instanceOf without annotations", async () => {
          ...
          await decoding.fail(
            ...
            `Expected null, got "https://effect.website/"`
          );
        });
      ...
      describe("Number", () => {
        it("Number", async () => {
          ...
          await decoding.fail(
            null,
            `Expected number | "Infinity" | "-Infinity" | "NaN", got null`
          );
          await decoding.fail(
            "a",
        ...
        describe("checks", () => {
          ...
          it("isGreaterThanOrEqualTo", async () => {
            ...
            await encoding.fail(
              -1,
              `Expected a value greater than or equal to 1, got -1`
            );
            await encoding.succeed(1.2);
            await encoding.succeed(Infinity, "Infinity");
            await encoding.fail(
              -Infinity,
              "Expected a value greater than or equal to 1, got -Infinity"
            );
            await encoding.fail(
              NaN,
              "Expected a value greater than or equal to 1, got NaN"
            );
      ...
      it("Record(Symbol, Date)", async () => {
        ...
        await encoding.succeed(
          {
            [Symbol.for("a")]: new Date("2021-01-01"),
            [Symbol.for("b")]: new Date("2021-01-01"),
          },
          {
            "Symbol(a)": "2021-01-01T00:00:00.000Z",
            "Symbol(b)": "2021-01-01T00:00:00.000Z",
          }
        );
      ...
      it("Suspend", async () => {
        ...
        const schema = Schema.Struct({
          ...
          categories: Schema.Array(
            Schema.suspend((): Schema.Codec<Category> => schema)
          ),
        });
        const asserts = new TestSchema.Asserts(Schema.toCodecJson(schema));
      ...
      it("Class", async () => {
        ...
        const asserts = new TestSchema.Asserts(
          Schema.toCodecJson(Schema.toType(A))
        );
      ...
      it("ErrorClass", async () => {
        ...
        const asserts = new TestSchema.Asserts(
          Schema.toCodecJson(Schema.toType(E))
        );
      ...
      it("URL", async () => {
        ...
        await decoding.fail("not a url", `Invalid URL string: not a url`);
      });
      ...
      it("RegExp", async () => {
        ...
        await encoding.succeed(new RegExp("a", "i"), {
          source: "a",
          flags: "i",
        });
      ...
      it("Duration", async () => {
        ...
        await encoding.succeed(Duration.negativeInfinity, {
        ...
        await encoding.succeed(Duration.millis(1), {
          _tag: "Millis",
          value: 1,
        });
        await encoding.succeed(Duration.millis(-1), {
      ...
      describe("Redacted", () => {
        it("Redacted(Option(String))", async () => {
          ...
          const encoding = asserts.encoding();
          await encoding.succeed(Redacted.make(Option.none()), {
            _tag: "None",
          });
          await encoding.succeed(Redacted.make(Option.some("a")), {
            _tag: "Some",
            value: "a",
          });
  ...
  at ["label"]`
        ...
        it("encoding a Redacted with a different label", async () => {
          ...
          const encoding = asserts.encoding();
          await encoding.succeed(Redacted.make("a", { label: "API key" }), "a");
        });
      });
    ...
    describe("schemas with encoding", () => {
      ...
      it("Class", async () => {
        ...
        const encoding = asserts.encoding();
        await encoding.succeed(new A({ a: 0 }), {
      ...
      it("Error", async () => {
        ...
        const encoding = asserts.encoding();
        await encoding.succeed(new E({ a: 0 }), {
          a: "1970-01-01T00:00:00.000Z",
        });
    ...
    it("StandardSchemaV1FailureResult", async () => {
      ...
      const asserts = new TestSchema.Asserts(
        Schema.toCodecJson(Schema.StandardSchemaV1FailureResult)
      );
  ...
  describe("toCodecStringTree", () => {
    ...
    describe("schemas without encoding", () => {
      ...
      it("Declaration", async () => {
        ...
        await decoding.fail(
          "https://effect.website/",
          `Expected undefined, got "https://effect.website/"`
        );
      });
      ...
      describe("Number", () => {
        it("Number", async () => {
          ...
          await decoding.fail(
            Infinity,
            `Expected string | "Infinity" | "-Infinity" | "NaN", got Infinity`
          );
          await decoding.fail(
            -Infinity,
            `Expected string | "Infinity" | "-Infinity" | "NaN", got -Infinity`
          ...
          await decoding.fail(
            NaN,
            `Expected string | "Infinity" | "-Infinity" | "NaN", got NaN`
          );
          await decoding.fail(
            null,
            `Expected string | "Infinity" | "-Infinity" | "NaN", got null`
          );
          await decoding.fail(
            "a",
...
Expected "Infinity" | "-Infinity" | "NaN", got "a"`
      ...
      it("Symbol", async () => {
        ...
        await decoding.fail(
          "a",
          `Expected a string representing a symbol, got "a"`
        );
      });
      ...
      it("Class", async () => {
        ...
        const asserts = new TestSchema.Asserts(
          Schema.toCodecStringTree(Schema.toType(A))
        );
      ...
      it("ErrorClass", async () => {
        ...
        const asserts = new TestSchema.Asserts(
          Schema.toCodecStringTree(Schema.toType(E))
        );
      ...
      it("Redacted(Option(String))", async () => {
        ...
        const encoding = asserts.encoding();
        await encoding.succeed(Redacted.make(Option.none()), { _tag: "None" });
        await encoding.succeed(Redacted.make(Option.some("a")), {
          _tag: "Some",
          value: "a",
        });
    ...
    it("should handle optional keys", async () => {
      ...
      const serializer = Schema.toCodecStringTree(schema);
      const asserts = new TestSchema.Asserts(
        Schema.toCodecStringTree(serializer)
      );
  ...
  describe("toEncoderXml", () => {
    async function assertXml<T, E, RD>(
      schema: Schema.Codec<T, E, RD>,
      value: T,
      expected: string
    ) {
    ...
    async function assertXmlFailure<T, E, RD>(
      schema: Schema.Codec<T, E, RD>,
      value: T,
      message: string
    ) {
    ...
    it("should use the identifier as the root name", async () => {
      ...
      await assertXml(
        ...
        "value",
        `<a_b data-name="a b">value</a_b>`
      );
      await assertXml(
        Schema.String.annotate({ identifier: "a", title: "b" }),
        "value",
        "<a>value</a>"
      );
    });
    ...
    it("should use the title as the root name", async () => {
      await assertXml(
        Schema.String.annotate({ title: "a" }),
        "value",
        "<a>value</a>"
      );
      await assertXml(
        Schema.String.annotate({ title: "a b" }),
        "value",
        `<a_b data-name="a b">value</a_b>`
      );
    });
  ...
  <item>3</item>
    ...
    it("Array with custom item name", async () => {
      const serializer = Schema.toEncoderXml(
        Schema.toCodecStringTree(Schema.Array(Schema.Number)),
        {
...
line2</root>`
    ...
    it("XML Encoder Options - rootName", async () => {
      const serializer = Schema.toEncoderXml(
        Schema.toCodecStringTree(Schema.String),
        {
          rootName: "custom",
        }
      );
      strictEqual(
        await Effect.runPromise(serializer("test")),
        "<custom>test</custom>"
      );
    });
    ...
    it("XML Encoder Options - pretty: false", async () => {
      ...
      strictEqual(
        await Effect.runPromise(serializer({ a: 1, b: "test" })),
        "<root><a>1</a><b>test</b></root>"
      );
    });
  ...
  <m>2</m>
    ...
    it("Circular Reference Detection", async () => {
      ...
      const serializer = Schema.toEncoderXml(
        Schema.toCodecStringTree(Schema.Any)
      );
      try {
