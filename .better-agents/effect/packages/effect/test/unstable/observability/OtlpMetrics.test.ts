...
describe("OtlpMetrics", () => {
  ...
  describe("delta temporality", () => {
    ...
    it.effect(
      "reports histogram count and sum deltas across export intervals",
      () =>
        Effect.gen(function* () {
    ...
    it.effect(
      "reports summary count and sum deltas across export intervals",
      () =>
        Effect.gen(function* () {
  ...
  describe("Summary", () => {
    it.effect("exports quantile metrics", () =>
      Effect.gen(function* () {
        ...
        const quantilesMetric = findMetric(
          requests[0],
          `${metricName}_quantiles`
        );
