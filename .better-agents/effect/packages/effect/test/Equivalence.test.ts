...
describe("Equivalence", () => {
  ...
  it("combine", () => {
    ...
    const E0: Equivalence.Equivalence<T> = Equivalence.mapInput((x: T) => x[0])(
      Equivalence.strictEqual<string>()
    );
    const E1: Equivalence.Equivalence<T> = Equivalence.mapInput((x: T) => x[1])(
  ...
  it("combineAll", () => {
    ...
    const E2: Equivalence.Equivalence<T> = Equivalence.mapInput((x: T) => x[2])(
      Equivalence.strictEqual<boolean>()
    );
