...
describe("Duration", () => {
  it("fromInputUnsafe", () => {
    ...
    deepStrictEqual(
      Duration.fromInputUnsafe("10 micros"),
      Duration.micros(10n)
    );
    ...
    deepStrictEqual(
      Duration.fromInputUnsafe("10 seconds"),
      Duration.seconds(10)
    );
    deepStrictEqual(Duration.fromInputUnsafe("1 minute"), Duration.minutes(1));
    deepStrictEqual(
      Duration.fromInputUnsafe("10 minutes"),
      Duration.minutes(10)
    );
    ...
    deepStrictEqual(
      Duration.fromInputUnsafe("1.5 seconds"),
    ...
    deepStrictEqual(
      Duration.fromInputUnsafe("-Infinity"),
      Duration.negativeInfinity
    );

    deepStrictEqual(
      Duration.fromInputUnsafe([500, 123456789]),
      Duration.nanos(500123456789n)
    );
    deepStrictEqual(
      Duration.fromInputUnsafe([-500, 123456789]),
      Duration.nanos(-500000000000n + 123456789n)
    );
    deepStrictEqual(Duration.fromInputUnsafe([Infinity, 0]), Duration.infinity);
    deepStrictEqual(
      Duration.fromInputUnsafe([-Infinity, 0]),
      Duration.negativeInfinity
    );
    ...
    deepStrictEqual(
      Duration.fromInputUnsafe([0, -Infinity]),
      Duration.negativeInfinity
    );
    ...
    deepStrictEqual(
      Duration.fromInputUnsafe({ minutes: 45 }),
      Duration.minutes(45)
    );
    deepStrictEqual(
    ...
    deepStrictEqual(
      Duration.fromInputUnsafe({ milliseconds: 500 }),
      Duration.millis(500)
    );
    deepStrictEqual(
    ...
    deepStrictEqual(
      Duration.fromInputUnsafe({ hours: -1 }),
      Duration.hours(-1)
    );
    deepStrictEqual(
  ...
  it("fromInput", () => {
    ...
    assertSome(
      Duration.fromInput([500, 123456789]),
      Duration.nanos(500123456789n)
    );
    assertSome(
      Duration.fromInput([-500, 123456789]),
  ...
  it("Order", () => {
    ...
    deepStrictEqual(
      Duration.Order(Duration.millis(1), Duration.nanos(2_000_000n)),
      -1
    );
    ...
    deepStrictEqual(
      Duration.Order(Duration.nanos(2_000_000n), Duration.millis(1)),
      1
    );
  ...
  it("Equivalence", () => {
    ...
    assertTrue(
      Duration.Equivalence(Duration.millis(1), Duration.nanos(1_000_000n))
    );
    ...
    assertTrue(
      Duration.Equivalence(Duration.nanos(1_000_000n), Duration.millis(1))
    );
  ...
  it("max", () => {
    deepStrictEqual(
      Duration.max(Duration.millis(1), Duration.millis(2)),
      Duration.millis(2)
    );
    deepStrictEqual(
      Duration.max(Duration.minutes(1), Duration.millis(2)),
      Duration.minutes(1)
    );
  });
  ...
  it("min", () => {
    deepStrictEqual(
      Duration.min(Duration.millis(1), Duration.millis(2)),
      Duration.millis(1)
    );
    deepStrictEqual(
      Duration.min(Duration.minutes(1), Duration.millis(2)),
      Duration.millis(2)
    );
  });
  ...
  it("divide", () => {
    ...
    assertSome(
      Duration.divide(Duration.seconds(1), 3),
      Duration.nanos(333333333n)
    );
    ...
    assertSome(
      Duration.divide(Duration.infinity, -2),
      Duration.negativeInfinity
    );
    assertSome(
      Duration.divide(Duration.negativeInfinity, -2),
      Duration.infinity
    );
  ...
  it("divideUnsafe", () => {
    // millis
    deepStrictEqual(
      Duration.divideUnsafe(Duration.minutes(1), 2),
      Duration.seconds(30)
    );
    deepStrictEqual(
      Duration.divideUnsafe(Duration.seconds(1), 3),
      Duration.nanos(333333333n)
    );
    deepStrictEqual(Duration.divideUnsafe(Duration.zero, 2), Duration.zero);
    deepStrictEqual(
      Duration.divideUnsafe(Duration.minutes(1), 0.5),
      Duration.minutes(2)
    );
    deepStrictEqual(
      Duration.divideUnsafe(Duration.minutes(1), 1.5),
      Duration.seconds(40)
    );

    // nanos
    deepStrictEqual(
      Duration.divideUnsafe(Duration.nanos(2n), 2),
      Duration.nanos(1n)
    );
    deepStrictEqual(
      Duration.divideUnsafe(Duration.nanos(1n), 3),
      Duration.zero
    );
    ...
    // infinity
    deepStrictEqual(
      Duration.divideUnsafe(Duration.infinity, 2),
      Duration.infinity
    );

    // divide by zero (IEEE 754 sign rules)
    deepStrictEqual(
      Duration.divideUnsafe(Duration.minutes(1), 0),
      Duration.infinity
    );
    deepStrictEqual(
      Duration.divideUnsafe(Duration.minutes(1), -0),
    ...
    deepStrictEqual(
      Duration.divideUnsafe(Duration.nanos(1n), 0),
      Duration.infinity
    );
    deepStrictEqual(
      Duration.divideUnsafe(Duration.nanos(1n), -0),
    ...
    // bad by
    deepStrictEqual(
      Duration.divideUnsafe(Duration.minutes(1), NaN),
      Duration.zero
    );
    deepStrictEqual(
      Duration.divideUnsafe(Duration.nanos(1n), NaN),
      Duration.zero
    );
    deepStrictEqual(
      Duration.divideUnsafe(Duration.infinity, NaN),
      Duration.zero
    );

    deepStrictEqual(
      Duration.divideUnsafe(Duration.minutes(1), Infinity),
      Duration.zero
    );
    deepStrictEqual(
      Duration.divideUnsafe(Duration.nanos(1n), Infinity),
      Duration.zero
    );
    deepStrictEqual(
      Duration.divideUnsafe(Duration.infinity, Infinity),
      Duration.zero
    );
  ...
  it("times", () => {
    ...
    deepStrictEqual(
      Duration.times(Duration.nanos(2n), 10),
      Duration.nanos(20n)
    );
  ...
  it("sum", () => {
    // millis
    deepStrictEqual(
      Duration.sum(Duration.seconds(30), Duration.seconds(30)),
      Duration.minutes(1)
    );

    // nanos
    deepStrictEqual(
      Duration.sum(Duration.nanos(30n), Duration.nanos(30n)),
      Duration.nanos(60n)
    );

    // infinity
    deepStrictEqual(
      Duration.sum(Duration.infinity, Duration.seconds(30)),
      Duration.infinity
    );
    deepStrictEqual(
      Duration.sum(Duration.seconds(30), Duration.infinity),
      Duration.infinity
    );
    deepStrictEqual(
      Duration.sum(Duration.infinity, Duration.nanos(1n)),
      Duration.infinity
    );
    deepStrictEqual(
      Duration.sum(Duration.nanos(1n), Duration.infinity),
      Duration.infinity
    );
    deepStrictEqual(
      Duration.sum(Duration.infinity, Duration.infinity),
      Duration.infinity
    );
  });
  ...
  it("subtract", () => {
    // millis
    deepStrictEqual(
      Duration.subtract(Duration.seconds(30), Duration.seconds(10)),
      Duration.seconds(20)
    );
    deepStrictEqual(
      Duration.subtract(Duration.seconds(30), Duration.seconds(30)),
      Duration.zero
    );
    deepStrictEqual(
    ...
    // nanos
    deepStrictEqual(
      Duration.subtract(Duration.nanos(30n), Duration.nanos(10n)),
      Duration.nanos(20n)
    );
    deepStrictEqual(
      Duration.subtract(Duration.nanos(30n), Duration.nanos(30n)),
      Duration.zero
    );
    deepStrictEqual(
      Duration.subtract(Duration.nanos(30n), Duration.nanos(40n)),
      Duration.nanos(-10n)
    );

    // infinity
    deepStrictEqual(
      Duration.subtract(Duration.infinity, Duration.seconds(30)),
      Duration.infinity
    );
    deepStrictEqual(
      Duration.subtract(Duration.infinity, Duration.nanos(30n)),
      Duration.infinity
    );
    deepStrictEqual(
      Duration.subtract(Duration.seconds(30), Duration.infinity),
      Duration.negativeInfinity
    );
    deepStrictEqual(
      Duration.subtract(Duration.nanos(30n), Duration.infinity),
      Duration.negativeInfinity
    );
    deepStrictEqual(
      Duration.subtract(Duration.infinity, Duration.infinity),
      Duration.zero
    );

    // negativeInfinity
    deepStrictEqual(
      Duration.subtract(Duration.infinity, Duration.negativeInfinity),
      Duration.infinity
    );
    deepStrictEqual(
      Duration.subtract(Duration.negativeInfinity, Duration.infinity),
      Duration.negativeInfinity
    );
    deepStrictEqual(
      Duration.subtract(Duration.negativeInfinity, Duration.negativeInfinity),
      Duration.zero
    );
    deepStrictEqual(
      Duration.subtract(Duration.negativeInfinity, Duration.seconds(5)),
      Duration.negativeInfinity
    );
    deepStrictEqual(
      Duration.subtract(Duration.seconds(5), Duration.negativeInfinity),
      Duration.infinity
    );
  });
  ...
  it("isGreaterThan", () => {
    assertTrue(
      pipe(Duration.seconds(30), Duration.isGreaterThan(Duration.seconds(20)))
    );
    assertFalse(
      pipe(Duration.seconds(30), Duration.isGreaterThan(Duration.seconds(30)))
    );
    assertFalse(
      pipe(Duration.seconds(30), Duration.isGreaterThan(Duration.seconds(60)))
    );

    assertTrue(
      pipe(Duration.nanos(30n), Duration.isGreaterThan(Duration.nanos(20n)))
    );
    assertFalse(
      pipe(Duration.nanos(30n), Duration.isGreaterThan(Duration.nanos(30n)))
    );
    assertFalse(
      pipe(Duration.nanos(30n), Duration.isGreaterThan(Duration.nanos(60n)))
    );

    assertTrue(
      pipe(Duration.millis(1), Duration.isGreaterThan(Duration.nanos(1n)))
    );

    assertTrue(
      pipe(Duration.infinity, Duration.isGreaterThan(Duration.seconds(20)))
    );
    assertFalse(
      pipe(
        Duration.seconds(-Infinity),
        Duration.isGreaterThan(Duration.infinity)
      )
    );
    assertFalse(
      pipe(Duration.nanos(1n), Duration.isGreaterThan(Duration.infinity))
    );
  });
  ...
  it("isGreaterThanOrEqualTo", () => {
    assertTrue(
      pipe(
        Duration.seconds(30),
        Duration.isGreaterThanOrEqualTo(Duration.seconds(20))
      )
    );
    assertTrue(
      pipe(
        Duration.seconds(30),
        Duration.isGreaterThanOrEqualTo(Duration.seconds(30))
      )
    );
    assertFalse(
      pipe(
        Duration.seconds(30),
        Duration.isGreaterThanOrEqualTo(Duration.seconds(60))
      )
    );
    ...
    assertTrue(
      pipe(
        Duration.nanos(30n),
        Duration.isGreaterThanOrEqualTo(Duration.nanos(20n))
      )
    );
    assertTrue(
      pipe(
        Duration.nanos(30n),
        Duration.isGreaterThanOrEqualTo(Duration.nanos(30n))
      )
    );
    assertFalse(
      pipe(
        Duration.nanos(30n),
        Duration.isGreaterThanOrEqualTo(Duration.nanos(60n))
      )
    );
  });
  ...
  it("isLessThan", () => {
    assertTrue(
      pipe(Duration.seconds(20), Duration.isLessThan(Duration.seconds(30)))
    );
    assertFalse(
      pipe(Duration.seconds(30), Duration.isLessThan(Duration.seconds(30)))
    );
    assertFalse(
      pipe(Duration.seconds(60), Duration.isLessThan(Duration.seconds(30)))
    );

    assertTrue(
      pipe(Duration.nanos(20n), Duration.isLessThan(Duration.nanos(30n)))
    );
    assertFalse(
      pipe(Duration.nanos(30n), Duration.isLessThan(Duration.nanos(30n)))
    );
    assertFalse(
      pipe(Duration.nanos(60n), Duration.isLessThan(Duration.nanos(30n)))
    );

    assertTrue(
      pipe(Duration.nanos(1n), Duration.isLessThan(Duration.millis(1)))
    );
  });
  ...
  it("isLessThanOrEqualTo", () => {
    assertTrue(
      pipe(
        Duration.seconds(20),
        Duration.isLessThanOrEqualTo(Duration.seconds(30))
      )
    );
    assertTrue(
      pipe(
    ...
    assertTrue(
      pipe(
        Duration.nanos(20n),
        Duration.isLessThanOrEqualTo(Duration.nanos(30n))
      )
    );
    assertTrue(
      pipe(
  ...
  it("toJSON", () => {
    deepStrictEqual(Duration.seconds(2).toJSON(), {
      _id: "Duration",
      _tag: "Millis",
      millis: 2000,
    });
    deepStrictEqual(Duration.nanos(5n).toJSON(), {
      _id: "Duration",
      _tag: "Nanos",
      nanos: "5",
    });
    deepStrictEqual(Duration.millis(1.5).toJSON(), {
      _id: "Duration",
      _tag: "Nanos",
      nanos: "1500000",
    });
    deepStrictEqual(Duration.infinity.toJSON(), {
      _id: "Duration",
      _tag: "Infinity",
    });
  });
  ...
  it(".pipe()", () => {
    deepStrictEqual(
      Duration.seconds(1).pipe(Duration.sum(Duration.seconds(1))),
      Duration.seconds(2)
    );
  });
  ...
  it("zero", () => {
    deepStrictEqual(
      Duration.sum(Duration.seconds(1), Duration.zero),
      Duration.seconds(1)
    );
  });
  ...
  it("toNanosUnsafe", () => {
    ...
    strictEqual(
      Duration.millis(1.0005).pipe(Duration.toNanosUnsafe),
      1_000_500n
    );
    strictEqual(
      Duration.millis(100).pipe(Duration.toNanosUnsafe),
      100_000_000n
    );
  });
  ...
  it("toHrTime", () => {
    ...
    deepStrictEqual(
      Duration.nanos(1_000_000_001n).pipe(Duration.toHrTime),
      [1, 1]
    );
    deepStrictEqual(
      Duration.millis(1001).pipe(Duration.toHrTime),
      [1, 1_000_000]
    );
  ...
  it("negative values", () => {
    ...
    deepStrictEqual(
      Duration.negate(Duration.infinity),
      Duration.negativeInfinity
    );
    deepStrictEqual(
      Duration.negate(Duration.negativeInfinity),
      Duration.infinity
    );
    ...
    deepStrictEqual(Duration.toHrTime(Duration.negativeInfinity), [
      -Infinity,
      0,
    ]);
    ...
    deepStrictEqual(
      Duration.Order(Duration.negativeInfinity, Duration.negativeInfinity),
      0
    );
    deepStrictEqual(
      Duration.Order(Duration.negativeInfinity, Duration.seconds(-5)),
      -1
    );
    deepStrictEqual(
      Duration.Order(Duration.seconds(-5), Duration.negativeInfinity),
      1
    );
    deepStrictEqual(
      Duration.Order(Duration.negativeInfinity, Duration.infinity),
      -1
    );
    deepStrictEqual(
      Duration.Order(Duration.infinity, Duration.negativeInfinity),
      1
    );
    deepStrictEqual(
      Duration.Order(Duration.seconds(-5), Duration.seconds(-3)),
      -1
    );
    deepStrictEqual(
      Duration.Order(Duration.seconds(-3), Duration.seconds(-5)),
      1
    );

    // Equivalence with negatives
    assertTrue(
      Duration.Equivalence(Duration.negativeInfinity, Duration.negativeInfinity)
    );
    assertFalse(
      Duration.Equivalence(Duration.negativeInfinity, Duration.infinity)
    );

    // sum with negativeInfinity
    deepStrictEqual(
      Duration.sum(Duration.infinity, Duration.negativeInfinity),
      Duration.zero
    );
    deepStrictEqual(
      Duration.sum(Duration.negativeInfinity, Duration.infinity),
      Duration.zero
    );
    deepStrictEqual(
      Duration.sum(Duration.negativeInfinity, Duration.negativeInfinity),
      Duration.negativeInfinity
    );
    deepStrictEqual(
      Duration.sum(Duration.negativeInfinity, Duration.seconds(5)),
      Duration.negativeInfinity
    );

    // times with negatives
    deepStrictEqual(
      Duration.times(Duration.infinity, -1),
      Duration.negativeInfinity
    );
    deepStrictEqual(
      Duration.times(Duration.negativeInfinity, -1),
      Duration.infinity
    );
    deepStrictEqual(Duration.times(Duration.infinity, 0), Duration.zero);
    deepStrictEqual(
      Duration.times(Duration.seconds(5), -2),
      Duration.seconds(-10)
    );
    ...
    deepStrictEqual(Duration.negativeInfinity.toJSON(), {
      _id: "Duration",
  ...
  it("ReducerSum", () => {
    deepStrictEqual(
      Duration.ReducerSum.combine(Duration.millis(1), Duration.millis(2)),
      Duration.millis(3)
    );
  });
  ...
  it("CombinerMax", () => {
    deepStrictEqual(
      Duration.CombinerMax.combine(Duration.millis(1), Duration.millis(2)),
      Duration.millis(2)
    );
  });
  ...
  it("CombinerMin", () => {
    deepStrictEqual(
      Duration.CombinerMin.combine(Duration.millis(1), Duration.millis(2)),
      Duration.millis(1)
    );
  });
});
