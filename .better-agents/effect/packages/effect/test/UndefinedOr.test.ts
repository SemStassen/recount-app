...
describe("UndefinedOr", () => {
  ...
  it("match", () => {
    strictEqual(
      UndefinedOr.match(1, { onDefined: (a) => a, onUndefined: () => 0 }),
      1
    );
    strictEqual(
      UndefinedOr.match(undefined, {
        onDefined: (a) => a,
        onUndefined: () => 0,
      }),
      0
  ...
  it("getOrThrowWith", () => {
    ...
    throws(
      () => UndefinedOr.getOrThrowWith(undefined, () => new Error("test")),
      new Error("test")
    );
  });
  ...
  it("getOrThrow returns defined values and throws the default missing error", () => {
    ...
    throws(
      () => UndefinedOr.getOrThrow(undefined),
