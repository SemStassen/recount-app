...
describe("Deferred", () => {
  describe("success", () => {
    ...
    it.effect(
      "complete - should memoize the result of the provided effect",
      () =>
        Effect.gen(function* () {
          let value = 0;
  ...
  describe("failure", () => {
    ...
    it.effect(
      "complete - should memoize the failure of the provided effect",
      () =>
        Effect.gen(function* () {
          const deferred = yield* Deferred.make<number, string>();
          assert.isTrue(
            yield* Deferred.complete(deferred, Effect.fail("boom"))
          );
          assert.isFalse(
            yield* Deferred.complete(deferred, Effect.fail("boom2"))
          );
  ...
  describe("polling", () => {
    it.effect(
      "poll - should return Option.none when the deferred is incomplete",
      () =>
        Effect.gen(function* () {
          const deferred = yield* Deferred.make<number>();
    ...
    it.effect(
      "poll - should return Option.some when the deferred was completed",
      () =>
        Effect.gen(function* () {
          const deferred = yield* Deferred.make<number>();
    ...
    it.effect(
      "poll - should return Option.some when the deferred was failed",
      () =>
        Effect.gen(function* () {
          const deferred = yield* Deferred.make<number, string>();
    ...
    it.effect(
      "poll - should return Option.some when the deferred was interrupted",
      () =>
        Effect.gen(function* () {
          const deferred = yield* Deferred.make<number, string>();
