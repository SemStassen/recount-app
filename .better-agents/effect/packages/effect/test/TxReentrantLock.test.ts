      ...
      Effect.gen(function* () {
        ...
        yield* Effect.scoped(
          Effect.gen(function* () {
            ...
            assert.strictEqual(
              yield* Effect.tx(TxReentrantLock.readLocked(lock)),
              true
            );
          })
        );
      ...
      Effect.gen(function* () {
        ...
        yield* Effect.scoped(
          Effect.gen(function* () {
            ...
            assert.strictEqual(
              yield* Effect.tx(TxReentrantLock.writeLocked(lock)),
              true
            );
          })
        );
  ...
  describe("withLock operations", () => {
    ...
    it.effect("withLock is alias for withWriteLock", () =>
      Effect.gen(function* () {
        ...
        assert.strictEqual(
          yield* Effect.tx(TxReentrantLock.locked(lock)),
          false
        );
      })
    );
    ...
    it.effect("withReadLock releases on failure", () =>
      Effect.gen(function* () {
        ...
        const result = yield* Effect.exit(
          TxReentrantLock.withReadLock(lock, Effect.fail("boom"))
        );
    ...
    it.effect("withWriteLock releases on failure", () =>
      Effect.gen(function* () {
        ...
        const result = yield* Effect.exit(
          TxReentrantLock.withWriteLock(lock, Effect.fail("boom"))
        );
