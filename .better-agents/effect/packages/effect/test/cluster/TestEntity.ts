...
export const TestEntity = Entity.make("TestEntity", [
  ...
  Rpc.make("WithTransaction", {
    ...
    Context.add(ClusterSchema.WithTransaction, true)
  ),
]).annotateRpcs(ClusterSchema.Persisted, true);

export class TestEntityState extends Context.Service<TestEntityState>()(
  "TestEntityState",
  {
...
export const TestEntityLayer = TestEntityNoState.pipe(
