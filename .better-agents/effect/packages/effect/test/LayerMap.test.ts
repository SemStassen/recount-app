...
describe("LayerMap", () => {
  ...
  it.effect("Service supports dynamic idleTimeToLive", () =>
    Effect.gen(function* () {
      ...
      class LookupMap extends LayerMap.Service<LookupMap>()(
        "LayerMapTest/LookupMap",
        {
      ...
      class RecordMap extends LayerMap.Service<RecordMap>()(
        "LayerMapTest/RecordMap",
        {
          layers: {
            short: makeLayer("short", acquired, released),
            long: makeLayer("long", acquired, released),
      ...
      yield* Effect.scoped(
        LookupMap.contextEffect("short:a").pipe(Effect.provide(LookupMap.layer))
      );
      yield* Effect.scoped(
        RecordMap.contextEffect("short").pipe(Effect.provide(RecordMap.layer))
      );
