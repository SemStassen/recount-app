...
describe("Cause", () => {
  ...
  describe("findErrorOption", () => {
    ...
    it("returns None when no Fail reason exists", () => {
      assert.strictEqual(
        Option.isNone(Cause.findErrorOption(Cause.die("defect"))),
        true
      );
      assert.strictEqual(
        Option.isNone(Cause.findErrorOption(Cause.empty)),
        true
      );
    });
  });
  ...
  describe("isNoSuchElementError", () => {
    it("returns true for NoSuchElementError instances", () => {
      assert.strictEqual(
        Cause.isNoSuchElementError(new Cause.NoSuchElementError()),
        true
      );
    });
  ...
  describe("NoSuchElementErrorTypeId", () => {
    it("is a string constant", () => {
      assert.strictEqual(
        Cause.NoSuchElementErrorTypeId,
  ...
  describe("isIllegalArgumentError", () => {
    it("returns true for IllegalArgumentError instances", () => {
      assert.strictEqual(
        Cause.isIllegalArgumentError(new Cause.IllegalArgumentError()),
        true
      );
    });
  ...
  describe("IllegalArgumentErrorTypeId", () => {
    it("is a string constant", () => {
      assert.strictEqual(
        Cause.IllegalArgumentErrorTypeId,
  ...
  describe("isExceededCapacityError", () => {
    it("returns true for ExceededCapacityError instances", () => {
      assert.strictEqual(
        Cause.isExceededCapacityError(new Cause.ExceededCapacityError()),
        true
      );
    });
  ...
  describe("ExceededCapacityErrorTypeId", () => {
    it("is a string constant", () => {
      assert.strictEqual(
        Cause.ExceededCapacityErrorTypeId,
  ...
  describe("isUnknownError", () => {
    it("returns true for UnknownError instances", () => {
      assert.strictEqual(
        Cause.isUnknownError(new Cause.UnknownError("x")),
        true
      );
    });
