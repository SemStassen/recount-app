...
const setTo2024NZ = TestClock.setTime(
  new Date("2023-12-31T11:00:00.000Z").getTime()
);
const assertSomeIso = (
  value: Option.Option<DateTime.DateTime>,
  expected: string
) => {
  const iso = Option.map(value, (value) =>
    DateTime.formatIso(DateTime.toUtc(value))
  );
...
describe("DateTime", () => {
  describe("mutate", () => {
    ...
    it.effect("preserves the named zone when mutating across DST", () =>
      Effect.gen(function* () {
        ...
        strictEqual(
          DateTime.toDateUtc(future).toISOString(),
          "2024-06-30T12:00:00.000Z"
        );
        strictEqual(
          DateTime.toDate(future).toISOString(),
        ...
        strictEqual(
          DateTime.toDateUtc(plusOne).toISOString(),
          "2024-07-01T12:00:00.000Z"
        );
        strictEqual(
          DateTime.toDate(plusOne).toISOString(),
  ...
  describe("add", () => {
    ...
    it.effect(
      "preserves the named zone when adding calendar units across DST",
      () =>
        Effect.gen(function* () {
          yield* setTo2024NZ;
          const now = yield* DateTime.nowInCurrentZone.pipe(
          ...
          strictEqual(
            DateTime.toDateUtc(minusOne).toISOString(),
            "2024-06-30T12:00:00.000Z"
          );
          strictEqual(
            DateTime.toDate(minusOne).toISOString(),
            "2024-07-01T00:00:00.000Z"
          );
        })
    );
    ...
    it.effect("leap years", () =>
      Effect.gen(function* () {
        ...
        const future = Option.map(now, (value) =>
          DateTime.add(value, { years: 1 })
        );
        assertSome(
          Option.map(future, DateTime.formatIso),
  ...
  describe("formatIsoOffset", () => {
    it.effect("correctly adds offset", () =>
      Effect.gen(function* () {
        ...
        strictEqual(
          DateTime.formatIsoOffset(now),
          "1970-01-01T12:00:00.000+12:00"
        );
      })
    );
  });
  ...
  describe("makeZonedFromString", () => {
    it.effect("parses an instant with an offset and IANA zone", () =>
      Effect.gen(function* () {
        const dt = DateTime.makeZonedFromString(
          "2024-07-21T20:12:34.112546348+12:00[Pacific/Auckland]"
        );
        assertSome(
          Option.map(dt, (value) => value.toJSON()),
          "2024-07-21T08:12:34.112Z"
        );
      })
    );
    ...
    it.effect("parses an offset-only string as an Offset zone", () =>
      Effect.gen(function* () {
        const dt = DateTime.makeZonedFromString(
          "2024-07-21T20:12:34.112546348+12:00"
        );
        assertSome(
          Option.map(dt, (value) => value.zone._tag),
          "Offset"
        );
        assertSome(
          Option.map(dt, (value) => value.toJSON()),
    ...
    it.effect("parses a UTC offset-only string as an Offset zone", () =>
      Effect.gen(function* () {
        const dt = DateTime.makeZonedFromString(
          "2024-07-21T20:12:34.112546348+00:00"
        );
        assertSome(
          Option.map(dt, (value) => value.zone._tag),
          "Offset"
    ...
    it.effect("roundtrips a bracketed IANA zone string", () =>
      Effect.gen(function* () {
        ...
        assertSome(
          Option.map(dt, (value) => DateTime.zoneToString(value.zone)),
          "Pacific/Auckland"
        );
        assertSome(
          Option.map(dt, (value) => value.toJSON()),
  ...
  describe("Disambiguation", () => {
    it.each<{
      ...
      },
      {
        ...
        description:
          "America/New_York 01:30 ambiguous time during leap year (2024)",
        expectedResults: {
      ...
      },
      {
        ...
        description:
          "America/New_York 01:00:00 exact start of ambiguous period",
        expectedResults: {
      ...
      },
      {
        ...
        description:
          "America/New_York 01:59:59 last second of ambiguous period",
        expectedResults: {
      ...
      },
      {
        ...
        description:
          "Australia/Melbourne 02:00 gap time (DST starts, spring forward)",
        expectedResults: {
      ...
      },
      {
        ...
        description:
          "Australia/Sydney 02:30 ambiguous time (DST ends, fall back)",
        expectedResults: {
      ...
      },
      {
        ...
        description:
          "Australia/Sydney 02:30 gap time (DST starts, spring forward)",
        expectedResults: {
      ...
      },
      {
        ...
        description:
          "Europe/Athens 03:00 ambiguous time during leap year (2024)",
        expectedResults: {
      ...
      },
      {
        ...
        time: { year: 2025, month: 4, day: 6, hour: 2, minute: 30 },
        description:
          "Pacific/Auckland 02:30 ambiguous time (DST ends, fall back)",
        expectedResults: {
      ...
      },
      {
        ...
        description:
          "Pacific/Auckland 12:00 during standard time (NZST, UTC+12)",
        expectedResults: {
      ...
      },
      {
        ...
        description:
          "Pacific/Auckland 02:30 gap time (DST starts, spring forward)",
        expectedResults: {
      ...
      },
      {
        ...
        time: { year: 2025, month: 6, day: 15, hour: 12 },
        description:
          "Pacific/Kiritimati 12:00 extreme positive offset (UTC+14)",
        expectedResults: {
      ...
      },
      {
        ...
        time: { year: 2025, month: 6, day: 15, hour: 12 },
        description:
          "Pacific/Marquesas 12:00 unusual negative offset (UTC-09:30)",
        expectedResults: {
    ...
    ])("should handle $description", ({ expectedResults, time, zone }) => {
