...
describe("Array", () => {
  ...
  it("filterMap", () => {
    expect(
      Array.filterMap(numbersOrStrings, (item, i) => {
        expect(item).type.toBe<string | number>();
        expect(i).type.toBe<number>();
        return typeof item === "number"
          ? Result.succeed(item + i)
  ...
  it("takeWhileFilter", () => {
    expect(
      Array.takeWhileFilter(numbersOrStrings, (item, i) => {
        expect(item).type.toBe<string | number>();
        expect(i).type.toBe<number>();
        return typeof item === "number"
          ? Result.succeed(item + i)
  ...
  it("dropWhileFilter", () => {
    expect(
      Array.dropWhileFilter(numbersOrStrings, (item, i) => {
        expect(item).type.toBe<string | number>();
        expect(i).type.toBe<number>();
        return typeof item === "number"
          ? Result.succeed(item + i)
  ...
  it("separate", () => {
    ...
    expect(Array.separate([Result.succeed(1)])).type.toBe<
      [Array<never>, Array<number>]
    >();
    expect(Array.separate([Result.fail("a")])).type.toBe<
      [Array<string>, Array<never>]
    >();
    expect(Array.separate([Result.fail("a"), Result.succeed(1)])).type.toBe<
      [Array<string>, Array<number>]
    >();
    expect(
      Array.separate(hole<Array<Result.Result<number, string>>>())
    ).type.toBe<[Array<string>, Array<number>]>();
    expect(
      Array.separate(hole<Iterable<Result.Result<number, string>>>())
    ).type.toBe<[Array<string>, Array<number>]>();
    expect(
      Array.separate(
        hole<
          Iterable<Result.Result<number, string> | Result.Result<boolean, Date>>
        >()
      )
    ...
    expect(
      Array.separate(
        hole<
          | Iterable<Result.Result<number, string>>
          | Iterable<Result.Result<boolean, Date>>
        >()
      )
    ).type.toBe<[Array<string | Date>, Array<number | boolean>]>();
  });
  ...
  it("getSuccesses", () => {
    ...
    expect(Array.getSuccesses([Result.fail("a"), Result.succeed(1)])).type.toBe<
      Array<number>
    >();
    expect(
      Array.getSuccesses(hole<Array<Result.Result<number, string>>>())
    ).type.toBe<Array<number>>();
    expect(
      Array.getSuccesses(hole<Iterable<Result.Result<number, string>>>())
    ).type.toBe<Array<number>>();
    expect(
      Array.getSuccesses(
        hole<
  ...
  it("getFailures", () => {
    ...
    expect(Array.getFailures([Result.fail("a"), Result.succeed(1)])).type.toBe<
      Array<string>
    >();
    expect(
      Array.getFailures(hole<Array<Result.Result<number, string>>>())
    ).type.toBe<Array<string>>();
    expect(
      Array.getFailures(hole<Iterable<Result.Result<number, string>>>())
    ).type.toBe<Array<string>>();
    expect(
      Array.getFailures(
        hole<
  ...
  it("replace", () => {
    ...
    expect(Array.replace(numbers, 0, "a")).type.toBe<
    ...
    >();
    expect(pipe([], Array.replace(0, "a"))).type.toBe<
  ...
  describe("make", () => {
    ...
    it("should return a non-empty array", () => {
      ...
      expect(Array.make("a", 1, "b")).type.toBe<
  ...
  describe("window", () => {
    it("should infer a literal for n", () => {
      expect(Array.window(iterableString, 2)).type.toBe<
        Array<[string, string]>
      >();
      expect(pipe(iterableString, Array.window(2))).type.toBe<
        Array<[string, string]>
      >();
      expect(Array.window(2)(iterableString)).type.toBe<
        Array<[string, string]>
      >();
    });
    ...
    it("n: forced number", () => {
      ...
      expect(pipe(iterableString, Array.window(n))).type.toBe<
        Array<Array<string>>
      >();
    ...
    it("n: forced literal", () => {
      const two = hole<2>();
      expect(Array.window(iterableString, two)).type.toBe<
        Array<[string, string]>
      >();
      expect(pipe(iterableString, Array.window(two))).type.toBe<
        Array<[string, string]>
      >();
      expect(Array.window(two)(iterableString)).type.toBe<
        Array<[string, string]>
      >();
      ...
      expect(Array.window(iterableString, negativeOne)).type.toBe<
        Array<never>
      >();
      expect(pipe(iterableString, Array.window(negativeOne))).type.toBe<
        Array<never>
      >();
      expect(Array.window(negativeOne)(iterableString)).type.toBe<
        Array<never>
      >();
    });
  });
