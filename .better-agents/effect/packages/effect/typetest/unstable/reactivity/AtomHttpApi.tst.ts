...
class MiddlewareError extends Schema.ErrorClass<MiddlewareError>(
  "MiddlewareError"
)({
  _tag: Schema.tag("MiddlewareError"),
}) {}

class MiddlewareClientError extends Schema.ErrorClass<MiddlewareClientError>(
  "MiddlewareClientError"
)({
  _tag: Schema.tag("MiddlewareClientError"),
}) {}

class TestMiddleware extends HttpApiMiddleware.Service<
  TestMiddleware,
  {
