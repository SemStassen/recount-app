...
declare const refinementNumberOrString: Predicate.Refinement<
  number | string,
  number
>;
...
describe("Option", () => {
  it("filter", () => {
    expect(Option.filter(number, predicateNumberOrString)).type.toBe<
      Option.Option<number>
    >();
    expect(pipe(number, Option.filter(predicateNumberOrString))).type.toBe<
      Option.Option<number>
    >();

    expect(
      pipe(numberOrString, Option.filter(refinementNumberOrString))
    ).type.toBe<Option.Option<number>>();
    expect(Option.filter(numberOrString, refinementNumberOrString)).type.toBe<
      Option.Option<number>
    >();
  ...
  it("fromNullishOr", () => {
    ...
    expect(Option.fromNullishOr(undefinedOr)).type.toBe<
      Option.Option<number>
    >();
  });

  it("fromUndefinedOr", () => {
    expect(Option.fromUndefinedOr(nullish)).type.toBe<
      Option.Option<number | null>
    >();
    expect(Option.fromUndefinedOr(nullOr)).type.toBe<
      Option.Option<number | null>
    >();
    expect(Option.fromUndefinedOr(undefinedOr)).type.toBe<
      Option.Option<number>
    >();
  });

  it("fromNullOr", () => {
    expect(Option.fromNullOr(nullish)).type.toBe<
      Option.Option<number | undefined>
    >();
    expect(Option.fromNullOr(nullOr)).type.toBe<Option.Option<number>>();
    expect(Option.fromNullOr(undefinedOr)).type.toBe<
      Option.Option<number | undefined>
    >();
  });
});
