...
describe("Tuple", () => {
  it("empty", () => {
    ...
    expect(Schema.revealCodec(schema)).type.toBe<
      Schema.Codec<readonly [], readonly []>
    >();
  ...
  it("defaulted element", () => {
    ...
    expect(Schema.revealCodec(schema)).type.toBe<
      Schema.Codec<readonly [string], readonly [string]>
    >();
    expect(schema).type.toBe<
      Schema.Tuple<readonly [Schema.withConstructorDefault<Schema.String>]>
    >();
    expect(schema.annotate({})).type.toBe<
      Schema.Tuple<readonly [Schema.withConstructorDefault<Schema.String>]>
    >();

    expect(schema.elements).type.toBe<
      readonly [Schema.withConstructorDefault<Schema.String>]
    >();
  });
  ...
  it("readonly [String, Number?]", () => {
    ...
    expect(schema.elements).type.toBe<
      readonly [Schema.String, Schema.optionalKey<Schema.Number>]
    >();
  });

  it("mutable", () => {
    const schema = Schema.mutable(
      Schema.Tuple([Schema.String, Schema.FiniteFromString])
    );
    expect(Schema.revealCodec(schema)).type.toBe<
    ...
    expect(schema).type.toBe<
      Schema.mutable<
        Schema.Tuple<readonly [Schema.String, Schema.FiniteFromString]>
      >
    >();
    expect(schema.annotate({})).type.toBe<
      Schema.mutable<
  ...
  describe("mapElements", () => {
    it("appendElement", () => {
      ...
      >();
      expect(schema).type.toBe<
        Schema.Tuple<readonly [Schema.String, Schema.Number]>
      >();
    });
    ...
    it("appendElements", () => {
      ...
      >();
      expect(schema).type.toBe<
        Schema.Tuple<readonly [Schema.String, Schema.Number, Schema.Boolean]>
      >();
    });
    ...
    it("pick", () => {
      ...
      >();
      expect(schema).type.toBe<
        Schema.Tuple<readonly [Schema.String, Schema.Boolean]>
      >();
    });
    ...
    describe("evolve", () => {
      it("readonly [string] -> readonly [string?]", () => {
        ...
        >();
        expect(schema).type.toBe<
          Schema.Tuple<readonly [Schema.optionalKey<Schema.String>]>
        >();
      });
    ...
    describe("renameIndices", () => {
      it("partial index mapping", () => {
        ...
        >();
        expect(schema).type.toBe<
          Schema.Tuple<readonly [Schema.Number, Schema.String, Schema.Boolean]>
        >();
      });
      ...
      it("full index mapping", () => {
        ...
        >();
        expect(schema).type.toBe<
          Schema.Tuple<readonly [Schema.Boolean, Schema.Number, Schema.String]>
        >();
      });
    });
    ...
    it("NullOr", () => {
      ...
      expect(schema).type.toBe<
        Schema.Tuple<
          readonly [Schema.NullOr<Schema.String>, Schema.NullOr<Schema.Number>]
        >
      >();
    });
