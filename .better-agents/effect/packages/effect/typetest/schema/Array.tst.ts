...
describe("Array", () => {
  ...
  it("mutable Array<FiniteFromString> exposes .value", () => {
    ...
    expect(Schema.revealCodec(schema)).type.toBe<
      Schema.Codec<Array<number>, Array<string>>
    >();
    expect(schema).type.toBe<
      Schema.mutable<Schema.$Array<typeof Schema.FiniteFromString>>
    >();
    expect(schema.annotate({})).type.toBe<
      Schema.mutable<Schema.$Array<typeof Schema.FiniteFromString>>
    >();
...
describe("NonEmptyArray", () => {
  it("NonEmptyArray<FiniteFromString> exposes .value", () => {
    ...
    >();
    expect(schema).type.toBe<
      Schema.NonEmptyArray<typeof Schema.FiniteFromString>
    >();
    expect(schema.annotate({})).type.toBe<
      Schema.NonEmptyArray<typeof Schema.FiniteFromString>
    >();
  ...
  it("mutable NonEmptyArray<FiniteFromString> exposes .value", () => {
    const schema = Schema.mutable(
      Schema.NonEmptyArray(Schema.FiniteFromString)
    );
    expect(Schema.revealCodec(schema)).type.toBe<
      Schema.Codec<[number, ...Array<number>], [string, ...Array<string>]>
    >();
    expect(schema).type.toBe<
      Schema.mutable<Schema.NonEmptyArray<typeof Schema.FiniteFromString>>
    >();
    expect(schema.annotate({})).type.toBe<
      Schema.mutable<Schema.NonEmptyArray<typeof Schema.FiniteFromString>>
    >();
