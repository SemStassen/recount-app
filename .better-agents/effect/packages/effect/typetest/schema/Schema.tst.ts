...
describe("Schema", () => {
  describe("variance", () => {
    it("Type", () => {
      const f1 =
        hole<
          <A extends string, S extends Schema.Codec<A, unknown, unknown>>(
            schema: S
          ) => S
        >();
      const f2 =
    ...
    it("Encoded", () => {
      const f1 =
        hole<
          <A extends number, S extends Schema.Codec<unknown, A, unknown>>(
            schema: S
          ) => S
        >();
      const f2 =
  ...
  describe("type helpers type safety", () => {
    ...
    it("Codec", () => {
      function f<S extends Schema.Codec<unknown, unknown, unknown, unknown>>(
        _s: S
      ) {
  ...
  describe("makeEffect", () => {
    ...
    it("refine", () => {
      ...
      expect(schema.makeEffect).type.toBe<
        MakeEffect<Option.Option<string>, Option.Some<string>>
      >();
    });
    ...
    it("Struct", () => {
      ...
      expect(schema.makeEffect).type.toBe<
        MakeEffect<{ readonly a?: string }, { readonly a: string }>
      >();
    });
    ...
    it("Class", () => {
      ...
      expect(revealClass(A).makeEffect).type.toBe<
        MakeEffect<{ readonly a: string }, A>
      >();
    });
  });
  ...
  describe("make", () => {
    ...
    it("refine", () => {
      ...
      expect(schema.make).type.toBe<
        Make<Option.Option<string>, Option.Some<string>>
      >();
    });
    ...
    describe("Struct", () => {
      ...
      it("Class field", () => {
        ...
        expect(schema.make).type.toBe<
          Make<{ readonly a: A }, { readonly a: A }>
        >();
      });
    ...
    describe("Tuple", () => {
      it("simple element", () => {
        ...
        expect(schema.make).type.toBe<
          Make<readonly [string], readonly [string]>
        >();
      });
    ...
    describe("Class", () => {
      ...
      it("nested defaulted fields", () => {
        ...
        expect(A.make).type.toBe<
          Make<void | { readonly a?: { readonly b?: number } }, A>
        >();
        const schema = Schema.Struct({
          a: A,
        });
    ...
    it("NonEmptyArray", () => {
      const schema = Schema.NonEmptyArray(
        Schema.FiniteFromString.pipe(Schema.brand("a"))
      );
      expect(schema.make).type.toBe<
        Make<
          readonly [
            number & Brand.Brand<"a">,
            ...Array<number & Brand.Brand<"a">>,
          ],
          readonly [
            number & Brand.Brand<"a">,
            ...Array<number & Brand.Brand<"a">>,
    ...
    it("TupleWithRest", () => {
      const schema = Schema.TupleWithRest(
        ...
        [
          ...
          Schema.FiniteFromString.pipe(Schema.brand("c")),
        ]
      );
      expect(schema.make).type.toBe<
        Make<
          readonly [
            number & Brand.Brand<"a">,
            ...Array<number & Brand.Brand<"b">>,
            number & Brand.Brand<"c">,
          ],
          readonly [
            number & Brand.Brand<"a">,
            ...Array<number & Brand.Brand<"b">>,
  ...
  describe("encodedCodec", () => {
    ...
    it("revealCodec + annotate", () => {
      ...
      expect(schema.annotate({})).type.toBe<
        Schema.toEncoded<Schema.FiniteFromString>
      >();
    });
  });
  ...
  describe("annotateEncoded", () => {
    ...
    it("should constrain annotations to the Encoded type", () => {
      ...
      expect(
        Schema.annotateEncoded<Schema.NumberFromString>
      ).type.toBeCallableWith({ examples: ["a"] });
      // number annotations should not be valid for a string-encoded schema
      expect(
        Schema.annotateEncoded<Schema.NumberFromString>
      ).type.not.toBeCallableWith({ examples: [1] });
    });
  });
  ...
  it("annotateKey", () => {
    ...
    expect(Schema.String.annotateKey).type.toBeCallableWith({ default: "a" });
    expect(Schema.String.annotateKey).type.not.toBeCallableWith({ default: 1 });
  });
  ...
  it("TemplateLiteral", () => {
    ...
    expect(Schema.TemplateLiteral).type.not.toBeCallableWith([
      Schema.Undefined,
    ]);
    ...
    expect(Schema.TemplateLiteral(["a"])["Encoded"]).type.toBe<`a`>();
    expect(
      Schema.TemplateLiteral([Schema.Literal("a")])["Encoded"]
    ).type.toBe<`a`>();
    expect(Schema.TemplateLiteral([1])["Encoded"]).type.toBe<`1`>();
    expect(
      Schema.TemplateLiteral([Schema.Literal(1)])["Encoded"]
    ).type.toBe<`1`>();
    expect(
      Schema.TemplateLiteral([Schema.String])["Encoded"]
    ).type.toBe<`${string}`>();
    expect(
      Schema.TemplateLiteral([Schema.Number])["Encoded"]
    ).type.toBe<`${number}`>();
    expect(Schema.TemplateLiteral(["a", "b"])["Encoded"]).type.toBe<`ab`>();
    expect(
      Schema.TemplateLiteral([Schema.Literal("a"), Schema.Literal("b")])[
        "Encoded"
      ]
    ).type.toBe<`ab`>();
    expect(
      Schema.TemplateLiteral(["a", Schema.String])["Encoded"]
    ).type.toBe<`a${string}`>();
    expect(
      Schema.TemplateLiteral([Schema.Literal("a"), Schema.String])["Encoded"]
    ).type.toBe<`a${string}`>();
    expect(
      Schema.TemplateLiteral(["a", Schema.Number])["Encoded"]
    ).type.toBe<`a${number}`>();
    expect(
      Schema.TemplateLiteral([Schema.Literal("a"), Schema.Number])["Encoded"]
    ).type.toBe<`a${number}`>();
    expect(
      Schema.TemplateLiteral([Schema.String, "a"])["Encoded"]
    ).type.toBe<`${string}a`>();
    expect(
      Schema.TemplateLiteral([Schema.String, Schema.Literal("a")])["Encoded"]
    ).type.toBe<`${string}a`>();
    expect(
      Schema.TemplateLiteral([Schema.Number, "a"])["Encoded"]
    ).type.toBe<`${number}a`>();
    expect(
      Schema.TemplateLiteral([Schema.Number, Schema.Literal("a")])["Encoded"]
    ).type.toBe<`${number}a`>();
    expect(
      Schema.TemplateLiteral([Schema.String, 0])["Encoded"]
    ).type.toBe<`${string}0`>();
    expect(
      Schema.TemplateLiteral([Schema.String, 1n])["Encoded"]
    ).type.toBe<`${string}1`>();
    expect(
      Schema.TemplateLiteral([Schema.String, Schema.Literals(["a", 0])])[
        "Encoded"
      ]
    ...
    expect(
      Schema.TemplateLiteral(["a", Schema.FiniteFromString])["Encoded"]
    ).type.toBe<`a${string}`>();
  });

  it("TemplateLiteralParser", () => {
    expect(Schema.revealCodec(Schema.TemplateLiteralParser(["a"]))).type.toBe<
      Schema.Codec<readonly ["a"], "a">
    >();
    expect(
      Schema.revealCodec(Schema.TemplateLiteralParser([Schema.Literal("a")]))
    ).type.toBe<Schema.Codec<readonly ["a"], "a">>();
    expect(Schema.revealCodec(Schema.TemplateLiteralParser([1]))).type.toBe<
      Schema.Codec<readonly [1], "1">
    >();
    expect(
      Schema.revealCodec(Schema.TemplateLiteralParser([Schema.Literal(1)]))
    ).type.toBe<Schema.Codec<readonly [1], "1">>();
    expect(
      Schema.revealCodec(Schema.TemplateLiteralParser([Schema.String]))
    ).type.toBe<Schema.Codec<readonly [string], string>>();
    expect(
      Schema.revealCodec(Schema.TemplateLiteralParser([Schema.Number]))
    ).type.toBe<Schema.Codec<readonly [number], `${number}`>>();
    expect(
      Schema.revealCodec(Schema.TemplateLiteralParser(["a", "b"]))
    ).type.toBe<Schema.Codec<readonly ["a", "b"], "ab">>();
    expect(
      Schema.revealCodec(
        Schema.TemplateLiteralParser([Schema.Literal("a"), Schema.Literal("b")])
      )
    ).type.toBe<Schema.Codec<readonly ["a", "b"], "ab">>();
    expect(
      Schema.revealCodec(Schema.TemplateLiteralParser(["a", Schema.String]))
    ).type.toBe<Schema.Codec<readonly ["a", string], `a${string}`>>();
    expect(
      Schema.revealCodec(
        Schema.TemplateLiteralParser([Schema.Literal("a"), Schema.String])
      )
    ).type.toBe<Schema.Codec<readonly ["a", string], `a${string}`>>();
    expect(
      Schema.revealCodec(Schema.TemplateLiteralParser(["a", Schema.Number]))
    ).type.toBe<Schema.Codec<readonly ["a", number], `a${number}`>>();
    expect(
      Schema.revealCodec(
        Schema.TemplateLiteralParser([Schema.Literal("a"), Schema.Number])
      )
    ).type.toBe<Schema.Codec<readonly ["a", number], `a${number}`>>();
    expect(
      Schema.revealCodec(Schema.TemplateLiteralParser([Schema.String, "a"]))
    ).type.toBe<Schema.Codec<readonly [string, "a"], `${string}a`>>();
    expect(
      Schema.revealCodec(
        Schema.TemplateLiteralParser([Schema.String, Schema.Literal("a")])
      )
    ).type.toBe<Schema.Codec<readonly [string, "a"], `${string}a`>>();
    expect(
      Schema.revealCodec(Schema.TemplateLiteralParser([Schema.Number, "a"]))
    ).type.toBe<Schema.Codec<readonly [number, "a"], `${number}a`>>();
    expect(
      Schema.revealCodec(
        Schema.TemplateLiteralParser([Schema.Number, Schema.Literal("a")])
      )
    ).type.toBe<Schema.Codec<readonly [number, "a"], `${number}a`>>();
    expect(
      Schema.revealCodec(Schema.TemplateLiteralParser([Schema.String, 0]))
    ).type.toBe<Schema.Codec<readonly [string, 0], `${string}0`>>();
    expect(
      Schema.revealCodec(Schema.TemplateLiteralParser([Schema.String, "true"]))
    ).type.toBe<Schema.Codec<readonly [string, "true"], `${string}true`>>();
    expect(
      Schema.revealCodec(Schema.TemplateLiteralParser([Schema.String, "null"]))
    ).type.toBe<Schema.Codec<readonly [string, "null"], `${string}null`>>();
    expect(
      Schema.revealCodec(Schema.TemplateLiteralParser([Schema.String, 1n]))
    ).type.toBe<Schema.Codec<readonly [string, 1n], `${string}1`>>();
    expect(
      Schema.revealCodec(
        Schema.TemplateLiteralParser([Schema.String, Schema.Literals(["a", 0])])
      )
    ).type.toBe<
      Schema.Codec<readonly [string, 0 | "a"], `${string}a` | `${string}0`>
    >();
    expect(
      Schema.revealCodec(
      ...
      Schema.Codec<readonly [string, "/", number], `${string}/${number}`>
    >();
    expect(
      Schema.revealCodec(
        Schema.TemplateLiteralParser([Schema.String, "/", Schema.Number])
      )
    ).type.toBe<
      Schema.Codec<readonly [string, "/", number], `${string}/${number}`>
    >();
    ...
    expect(
      ...
      Schema.Codec<readonly [string & Brand.Brand<"MyBrand">], string>
    >();
    expect(
      Schema.revealCodec(
        Schema.TemplateLiteralParser([
          Schema.Number.pipe(Schema.brand("MyBrand")),
        ])
      )
    ).type.toBe<
      Schema.Codec<readonly [number & Brand.Brand<"MyBrand">], `${number}`>
    >();
    expect(
      Schema.revealCodec(
        Schema.TemplateLiteralParser([
      ...
      Schema.Codec<
        readonly ["a", string & Brand.Brand<"MyBrand">],
        `a${string}`
      >
    >();
    expect(
    ...
    expect(
      ...
      Schema.Codec<
        readonly ["a", number & Brand.Brand<"MyBrand">],
        `a${number}`
      >
    >();
    expect(
    ...
    expect(
      ...
      Schema.Codec<readonly ["a", string | number], `a${string}` | `a${number}`>
    >();
  });
  ...
  describe("flip", () => {
    ...
    it("decodeTo", () => {
      const schema = Schema.FiniteFromString;
      const flipped = Schema.flip(schema);
      expect(flipped).type.toBe<
        Schema.flip<Schema.decodeTo<Schema.Number, Schema.String>>
      >();
      expect(flipped.annotate({})).type.toBe<
        Schema.flip<Schema.decodeTo<Schema.Number, Schema.String>>
      >();
      expect(Schema.revealCodec(flipped)).type.toBe<
        Schema.Codec<string, number>
      >();
      expect(Schema.revealCodec(flipped.annotate({}))).type.toBe<
        Schema.Codec<string, number>
      >();
    });
    ...
    it("optionalKey", () => {
      ...
      const flipped = Schema.flip(schema);
      expect(Schema.revealCodec(flipped)).type.toBe<
        Schema.Codec<{ readonly a?: string }, { readonly a?: number }>
      >();
    });
    ...
    it("Struct & withConstructorDefault", () => {
      const schema = Schema.Struct({
        a: Schema.String.pipe(
          Schema.withConstructorDefault(Effect.succeed("c"))
        ),
      });
      expect(schema.make).type.toBe<
        (
  ...
  it("instanceOf", () => {
    ...
    expect(Schema.revealCodec(schema)).type.toBe<
      Schema.Codec<MyError, MyError, never, never>
    >();
  ...
  describe("decodeTo", () => {
    it("should allow partial application", () => {
      ...
      expect(f).type.toBe<
        <From extends Schema.Top>(
          from: From
        ) => Schema.compose<Schema.String, From>
      >();

      expect(f(Schema.Number)).type.toBe<
        Schema.compose<Schema.String, Schema.Number>
      >();
    });
  });
  ...
  it("optionalKey", () => {
    {
      ...
      expect(Schema.revealCodec(schema)).type.toBe<
        Schema.Codec<string, string, never>
      >();
  ...
  it("optional", () => {
    {
      ...
      expect(Schema.revealCodec(schema)).type.toBe<
        Schema.Codec<string | undefined, string | undefined, never>
      >();
  ...
  describe("readonlyKey", () => {
    ...
    it("top level call", () => {
      ...
      {
        const schema = Schema.mutableKey(Schema.String).pipe(
          Schema.readonlyKey
        );
        expect(Schema.revealCodec(schema)).type.toBe<
          Schema.Codec<string, string, never>
  ...
  describe("mutable", () => {
    it("should not be callable with a non-array schema", () => {
      expect(Schema.mutable).type.not.toBeCallableWith(
  ...
  describe("required", () => {
    it("should not be callable with a schema without Schema.optional", () => {
      ...
      expect(Schema.required).type.not.toBeCallableWith(
        Schema.optionalKey(Schema.String)
      );
    });
  ...
  describe("Class APIs", () => {
    describe("Class", () => {
      ...
      it("branded (unique symbol)", () => {
        ...
        class ABranded extends Schema.Class<
          ABranded,
          { readonly brand: unique symbol }
        >("ABranded")({
          a: Schema.String,
        }) {}
        class BBranded extends Schema.Class<
          BBranded,
          { readonly brand: unique symbol }
        >("BBranded")({
          a: Schema.String,
      ...
      it("branded (Brand module)", () => {
        class ABranded extends Schema.Class<ABranded, Brand.Brand<"A">>(
          "ABranded"
        )({
          a: Schema.String,
        }) {}
        class BBranded extends Schema.Class<BBranded, Brand.Brand<"B">>(
          "BBranded"
        )({
          a: Schema.String,
        }) {}
      ...
      it("extend & branded (unique symbol)", () => {
        ...
        class E1 extends Common.extend<
          E1,
          {},
          { readonly brand: unique symbol }
        >("E1")({
        ...
        class E2 extends Common.extend<
          E2,
          {},
          { readonly brand: unique symbol }
        >("E2")({
    ...
    describe("TaggedClass", () => {
      it("Fields argument", () => {
        ...
        expect(Schema.revealCodec(A)).type.toBe<
          Schema.Codec<A, { readonly _tag: "A"; readonly a: string }>
        >();
        expect(revealClass(A)).type.toBe<
          Schema.Class<
            A,
    ...
    describe("Error", () => {
      it("extend Fields", () => {
        ...
        expect(Schema.revealCodec(E)).type.toBe<
          Schema.Codec<E, { readonly a: string }>
        >();
  ...
  describe("brand", () => {
    it("brand", () => {
      ...
      expect(schema.annotate({})).type.toBe<
        Schema.brand<Schema.Number, "MyBrand">
      >();
    });
    ...
    expect(schema).type.toBe<
      Schema.compose<
        Schema.Struct<{
          ...
          readonly b: Schema.Union<readonly [Schema.Number, Schema.Undefined]>;
        }>,
        Schema.Struct<{
          readonly a: Schema.String;
          readonly b: Schema.FiniteFromString;
        }>
      >
    >();
    expect(schema.annotate({})).type.toBe<
  ...
  it("withDecodingDefaultKey", () => {
    ...
    expect(schema).type.toBe<
      Schema.Struct<{
        readonly a: Schema.withDecodingDefaultKey<Schema.FiniteFromString>;
      }>
    >();
    expect(Schema.revealCodec(schema)).type.toBe<
      Schema.Codec<
  ...
  it("withDecodingDefault", () => {
    ...
    expect(schema).type.toBe<
      Schema.Struct<{
        readonly a: Schema.withDecodingDefault<Schema.FiniteFromString>;
      }>
    >();
    expect(Schema.revealCodec(schema)).type.toBe<
      Schema.Codec<
  ...
  describe("fromBrand", () => {
    ...
    it("should convert a union of keys to an intersection of brands", () => {
      ...
      expect(schema).type.toBe<
        Schema.brand<Schema.Number, "Int" | "Positive">
      >();
      expect(Schema.revealCodec(schema)).type.toBe<
        Schema.Codec<
  ...
  describe("fieldsAssign", () => {
    ...
    it("should throw an error if there is a field that is not a struct", () => {
      expect(
        Schema.Union([Schema.String, Schema.Number]).mapMembers
  ...
  describe("Annotations", () => {
    describe("resolveAnnotations", () => {
      ...
      it("URL", () => {
        ...
        expect(Schema.resolveAnnotations(schema)).type.toBe<
          Schema.Annotations.Bottom<URL, readonly []> | undefined
        >();
      });
    ...
    describe("resolveAnnotationsKey", () => {
      it("String", () => {
        ...
        expect(Schema.resolveAnnotationsKey(schema)).type.toBe<
          Schema.Annotations.Key<string> | undefined
        >();
      });
    });
    ...
    it("URL", () => {
      const schema = Schema.URL;
      expect(Schema.resolveAnnotationsKey(schema)).type.toBe<
        Schema.Annotations.Key<URL> | undefined
      >();
    });
