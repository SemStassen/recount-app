...
describe("Record", () => {
  ...
  it("Record(String, NumberFromString)", () => {
    ...
    expect(schema).type.toBe<
      Schema.$Record<Schema.String, typeof Schema.NumberFromString>
    >();
    expect(schema.annotate({})).type.toBe<
      Schema.$Record<Schema.String, typeof Schema.NumberFromString>
    >();
  ...
  describe("Literals keys", () => {
    ...
    it("Record(Literals, optionalKey(Number))", () => {
      const schema = Schema.Record(
        Schema.Literals(["a", "b"]),
        Schema.optionalKey(Schema.FiniteFromString)
      );
      expect(Schema.revealCodec(schema)).type.toBe<
        Schema.Codec<
          { readonly a?: number; readonly b?: number },
      ...
      expect(schema).type.toBe<
        Schema.$Record<
          Schema.Literals<readonly ["a", "b"]>,
          Schema.optionalKey<typeof Schema.FiniteFromString>
        >
      >();
      expect(schema.annotate({})).type.toBe<
        Schema.$Record<
    ...
    it("Record(Literals, mutableKey(Number))", () => {
      const schema = Schema.Record(
        Schema.Literals(["a", "b"]),
        Schema.mutableKey(Schema.FiniteFromString)
      );
      expect(Schema.revealCodec(schema)).type.toBe<
      ...
      expect(schema).type.toBe<
        Schema.$Record<
          Schema.Literals<readonly ["a", "b"]>,
          Schema.mutableKey<typeof Schema.FiniteFromString>
        >
      >();
      expect(schema.annotate({})).type.toBe<
        Schema.$Record<
  ...
  describe("field mutability and optionality", () => {
    ...
    it("Record(String, optional(Number))", () => {
      ...
      >();
      expect(schema).type.toBe<
        Schema.$Record<Schema.String, Schema.optional<Schema.NumberFromString>>
      >();
      expect(schema.annotate({})).type.toBe<
        Schema.$Record<Schema.String, Schema.optional<Schema.NumberFromString>>
      >();
    ...
    it("Record(String, mutableKey(Number))", () => {
      const schema = Schema.Record(
        Schema.String,
        Schema.mutableKey(Schema.NumberFromString)
      );
      expect(Schema.revealCodec(schema)).type.toBe<
    ...
    it("recursive schema", () => {
      ...
      const schema = Schema.Record(
        Schema.String,
        Schema.mutableKey(Schema.suspend((): Schema.Codec<T> => schema))
      );
      expect(Schema.revealCodec(schema)).type.toBe<Schema.Codec<T>>();
      expect(schema).type.toBe<
        Schema.$Record<
          Schema.String,
          Schema.mutableKey<Schema.suspend<Schema.Codec<T>>>
        >
      >();
      expect(schema.annotate({})).type.toBe<
        Schema.$Record<
