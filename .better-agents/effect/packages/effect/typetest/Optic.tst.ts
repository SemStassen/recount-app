...
describe("Optic", () => {
  describe("key", () => {
    it("should not be allowed on union types", () => {
      type S =
        ...
        | { readonly _tag: "B"; readonly a?: number };
  ...
  describe("pick", () => {
    ...
    it("Struct", () => {
      ...
      expect(optic).type.toBe<
        Optic.Lens<S, { readonly a: string; readonly c: boolean }>
      >();
    });
  });
  ...
  describe("Result", () => {
    it("success", () => {
      ...
      expect(optic).type.toBe<
        Optic.Prism<Result.Result<number, string>, number>
      >();
    });
    ...
    it("failure", () => {
      ...
      expect(optic).type.toBe<
        Optic.Prism<Result.Result<number, string>, string>
      >();
    });
  });
});
