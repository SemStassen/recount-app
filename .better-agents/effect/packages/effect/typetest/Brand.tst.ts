...
describe("Brand", () => {
  it("FromConstructor", () => {
    ...
    expect<
      Brand.Brand.FromConstructor<typeof Positive>
    >().type.toBe<Positive>();
  });
  ...
  it("Brands", () => {
    ...
    type PositiveInt = number & Brand.Brand<"Int"> & Brand.Brand<"Positive">;
    expect<Brand.Brand.Brands<PositiveInt>>().type.toBe<
      Brand.Brand<"Int"> & Brand.Brand<"Positive">
    >();
  });
  ...
  it("EnsureCommonBase", () => {
    ...
    expect<
      Brand.Brand.EnsureCommonBase<[typeof Positive, typeof Int]>
    >().type.toBe<[typeof Positive, typeof Int]>();

    type MyString = string & Brand.Brand<"MyString">;
    const MyString = Brand.nominal<MyString>();

    expect<
      Brand.Brand.EnsureCommonBase<[typeof MyString, typeof Int]>
    >().type.toBe<
