...
export const make = (
  ...
  start: Effect.fnUntraced(function* <O = unknown, I = unknown>() {
    ...
    return identity<WorkerRunner.WorkerRunner<O, I>>({
      run,
      send,
      sendUnsafe,
      disconnects,
 ...
 * @since 4.0.0
 */
export const layer: Layer.Layer<WorkerRunner.WorkerRunnerPlatform> = Layer.sync(
...
): Layer.Layer<WorkerRunner.WorkerRunnerPlatform> =>
