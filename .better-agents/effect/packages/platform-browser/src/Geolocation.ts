 ...
 * @since 4.0.0
 */
export class PositionUnavailable extends Data.TaggedError(
  "PositionUnavailable"
)<{
...
const makeQueue = (
  ...
  Queue.sliding<GeolocationPosition, GeolocationError>(
...
export const watchPosition = (
  ...
  Stream.unwrap(
    Effect.map(Effect.service(Geolocation), (geolocation) =>
