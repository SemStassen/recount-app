...
export const APIError = Schema.Struct({
  ...
  type: Schema.Literal("api_error").annotate({
    title: "Type",
    default: "api_error",
  }),
...
export const AuthenticationError = Schema.Struct({
  ...
  type: Schema.Literal("authentication_error").annotate({
    title: "Type",
...
export const Base64PDFSource = Schema.Struct({
  data: Schema.String.annotate({ title: "Data", format: "byte" }),
  media_type: Schema.Literal("application/pdf").annotate({
    title: "Media Type",
  }),
  type: Schema.Literal("base64").annotate({ title: "Type" }),
...
export const BetaAllThinkingTurns = Schema.Struct({
  type: Schema.Literal("all").annotate({ title: "Type" }),
...
export const BetaBillingError = Schema.Struct({
  ...
  type: Schema.Literal("billing_error").annotate({
    title: "Type",
...
export const BetaBody_create_skill_v1_skills_post = Schema.Struct({
  ...
  files: Schema.optionalKey(
    Schema.Union([
      Schema.Array(Schema.String.annotate({ format: "binary" })),
      Schema.Null,
    ]).annotate({
      title: "Files",
      description:
...
export const BetaBody_create_skill_version_v1_skills__skill_id__versions_post =
  Schema.Struct({
    files: Schema.optionalKey(
      Schema.Union([
        Schema.Array(Schema.String.annotate({ format: "binary" })),
...
export const BetaCanceledResult = Schema.Struct({
  type: Schema.Literal("canceled").annotate({
    title: "Type",
    default: "canceled",
  }),
...
export const BetaCompactionContentBlockDelta = Schema.Struct({
  ...
  type: Schema.Literal("compaction_delta").annotate({
    title: "Type",
...
export const BetaDirectCaller = Schema.Struct({
  type: Schema.Literal("direct").annotate({ title: "Type" }),
}).annotate({
  title: "DirectCaller",
  description: "Tool invocation directly from the model.",
});
export type BetaEffortLevel = "low" | "medium" | "high" | "max";
export const BetaEffortLevel = Schema.Literals([
  "low",
  "medium",
  "high",
  "max",
...
export const BetaExpiredResult = Schema.Struct({
  type: Schema.Literal("expired").annotate({
    title: "Type",
    default: "expired",
  }),
...
export const BetaFileMetadataSchema = Schema.Struct({
  ...
  size_bytes: Schema.Number.annotate({
    title: "Size Bytes",
...
export const BetaGatewayTimeoutError = Schema.Struct({
  ...
  type: Schema.Literal("timeout_error").annotate({
    title: "Type",
...
export const BetaInputJsonContentBlockDelta = Schema.Struct({
  ...
  type: Schema.Literal("input_json_delta").annotate({
    title: "Type",
...
export const BetaInputTokensClearAtLeast = Schema.Struct({
  ...
  value: Schema.Number.annotate({ title: "Value" })
    .check(Schema.isInt())
    .check(Schema.isGreaterThanOrEqualTo(0)),
...
export const BetaInvalidRequestError = Schema.Struct({
  ...
  type: Schema.Literal("invalid_request_error").annotate({
    title: "Type",
...
export const BetaMCPToolConfig = Schema.Struct({
  defer_loading: Schema.optionalKey(
    Schema.Boolean.annotate({ title: "Defer Loading" })
  ),
...
export const BetaMessageBatch = Schema.Struct({
  ...
  cancel_initiated_at: Schema.Union([
    Schema.String.annotate({ format: "date-time" }),
    Schema.Null,
  ]).annotate({
  ...
  processing_status: Schema.Literals([
    "in_progress",
    "canceling",
    "ended",
  ]).annotate({
...
export const BetaMessageStopEvent = Schema.Struct({
  type: Schema.Literal("message_stop").annotate({
    title: "Type",
...
export const BetaNotFoundError = Schema.Struct({
  ...
  type: Schema.Literal("not_found_error").annotate({
    title: "Type",
...
export const BetaPermissionError = Schema.Struct({
  ...
  type: Schema.Literal("permission_error").annotate({
    title: "Type",
...
export const BetaRateLimitError = Schema.Struct({
  ...
  type: Schema.Literal("rate_limit_error").annotate({
    title: "Type",
...
export const BetaRequestCharLocationCitation = Schema.Struct({
  ...
  document_index: Schema.Number.annotate({ title: "Document Index" })
    .check(Schema.isInt())
    .check(Schema.isGreaterThanOrEqualTo(0)),
  ...
  end_char_index: Schema.Number.annotate({ title: "End Char Index" }).check(
    Schema.isInt()
  ),
  start_char_index: Schema.Number.annotate({ title: "Start Char Index" })
    .check(Schema.isInt())
    .check(Schema.isGreaterThanOrEqualTo(0)),
...
export const BetaRequestContentBlockLocationCitation = Schema.Struct({
  ...
  end_block_index: Schema.Number.annotate({ title: "End Block Index" }).check(
    Schema.isInt()
  ),
  start_block_index: Schema.Number.annotate({ title: "Start Block Index" })
    .check(Schema.isInt())
    .check(Schema.isGreaterThanOrEqualTo(0)),
...
export const BetaRequestMCPServerToolConfiguration = Schema.Struct({
  ...
  enabled: Schema.optionalKey(
    Schema.Union([Schema.Boolean, Schema.Null]).annotate({ title: "Enabled" })
  ),
...
export const BetaRequestPageLocationCitation = Schema.Struct({
  ...
  end_page_number: Schema.Number.annotate({ title: "End Page Number" }).check(
    Schema.isInt()
  ),
  start_page_number: Schema.Number.annotate({ title: "Start Page Number" })
    .check(Schema.isInt())
    .check(Schema.isGreaterThanOrEqualTo(1)),
...
export const BetaRequestSearchResultLocationCitation = Schema.Struct({
  ...
  search_result_index: Schema.Number.annotate({ title: "Search Result Index" })
    .check(Schema.isInt())
    .check(Schema.isGreaterThanOrEqualTo(0)),
...
export const BetaRequestTextEditorCodeExecutionCreateResultBlock =
  Schema.Struct({
...
export const BetaRequestTextEditorCodeExecutionStrReplaceResultBlock =
  Schema.Struct({
...
export const BetaRequestWebSearchResultBlock = Schema.Struct({
  ...
  page_age: Schema.optionalKey(
    Schema.Union([Schema.String, Schema.Null]).annotate({ title: "Page Age" })
  ),
...
export const BetaRequestWebSearchResultLocationCitation = Schema.Struct({
  ...
  title: Schema.Union([
    Schema.String.check(Schema.isMinLength(1)).check(Schema.isMaxLength(512)),
    Schema.Null,
...
export const BetaResponseCharLocationCitation = Schema.Struct({
  ...
  document_index: Schema.Number.annotate({ title: "Document Index" })
    .check(Schema.isInt())
    .check(Schema.isGreaterThanOrEqualTo(0)),
  document_title: Schema.Union([Schema.String, Schema.Null]).annotate({
    title: "Document Title",
  }),
  end_char_index: Schema.Number.annotate({ title: "End Char Index" }).check(
    Schema.isInt()
  ),
  file_id: Schema.Union([Schema.String, Schema.Null]).annotate({
    title: "File Id",
    default: null,
  }),
  start_char_index: Schema.Number.annotate({ title: "Start Char Index" })
    .check(Schema.isInt())
    .check(Schema.isGreaterThanOrEqualTo(0)),
  type: Schema.Literal("char_location").annotate({
    title: "Type",
...
export const BetaResponseContentBlockLocationCitation = Schema.Struct({
  ...
  start_block_index: Schema.Number.annotate({ title: "Start Block Index" })
    .check(Schema.isInt())
    .check(Schema.isGreaterThanOrEqualTo(0)),
  type: Schema.Literal("content_block_location").annotate({
    title: "Type",
...
export const BetaResponseMCPToolUseBlock = Schema.Struct({
  id: Schema.String.annotate({ title: "Id" }).check(
  ...
  server_name: Schema.String.annotate({
    title: "Server Name",
    description: "The name of the MCP server",
  }),
  type: Schema.Literal("mcp_tool_use").annotate({
    title: "Type",
...
export const BetaResponsePageLocationCitation = Schema.Struct({
  ...
  start_page_number: Schema.Number.annotate({ title: "Start Page Number" })
    .check(Schema.isInt())
    .check(Schema.isGreaterThanOrEqualTo(1)),
  type: Schema.Literal("page_location").annotate({
    title: "Type",
...
export const BetaResponseRedactedThinkingBlock = Schema.Struct({
  data: Schema.String.annotate({ title: "Data" }),
  type: Schema.Literal("redacted_thinking").annotate({
    title: "Type",
...
export const BetaResponseSearchResultLocationCitation = Schema.Struct({
  ...
  type: Schema.Literal("search_result_location").annotate({
    title: "Type",
...
export const BetaResponseTextEditorCodeExecutionCreateResultBlock =
  Schema.Struct({
    is_file_update: Schema.Boolean.annotate({ title: "Is File Update" }),
    type: Schema.Literal("text_editor_code_execution_create_result").annotate({
      title: "Type",
...
export const BetaResponseTextEditorCodeExecutionStrReplaceResultBlock =
  Schema.Struct({
    lines: Schema.Union([Schema.Array(Schema.String), Schema.Null]).annotate({
      title: "Lines",
      default: null,
    }),
    new_lines: Schema.Union([
...
export const BetaResponseThinkingBlock = Schema.Struct({
  ...
  type: Schema.Literal("thinking").annotate({
    title: "Type",
    default: "thinking",
  }),
...
export const BetaResponseToolReferenceBlock = Schema.Struct({
  tool_name: Schema.String.annotate({ title: "Tool Name" })
    .check(Schema.isMinLength(1))
...
export const BetaResponseWebSearchResultBlock = Schema.Struct({
  encrypted_content: Schema.String.annotate({ title: "Encrypted Content" }),
  page_age: Schema.Union([Schema.String, Schema.Null]).annotate({
    title: "Page Age",
    default: null,
  }),
  title: Schema.String.annotate({ title: "Title" }),
  type: Schema.Literal("web_search_result").annotate({
    title: "Type",
...
export type BetaServerToolCaller_20260120 = {
  readonly tool_id: string;
...
export const BetaSignatureContentBlockDelta = Schema.Struct({
  signature: Schema.String.annotate({ title: "Signature" }),
  type: Schema.Literal("signature_delta").annotate({
    title: "Type",
...
export const BetaSpeed = Schema.Literals(["standard", "fast"]).annotate({
  title: "Speed",
});
...
export const BetaTextContentBlockDelta = Schema.Struct({
  ...
  type: Schema.Literal("text_delta").annotate({
    title: "Type",
    default: "text_delta",
  }),
...
export const BetaThinkingContentBlockDelta = Schema.Struct({
  thinking: Schema.String.annotate({ title: "Thinking" }),
  type: Schema.Literal("thinking_delta").annotate({
    title: "Type",
...
export const BetaToolChoiceNone = Schema.Struct({
  type: Schema.Literal("none").annotate({ title: "Type" }),
}).annotate({
...
export const BetaUserLocation = Schema.Struct({
  ...
  country: Schema.optionalKey(
    Schema.Union([
      Schema.String.check(Schema.isMinLength(2)).check(Schema.isMaxLength(2)),
      Schema.Null,
    ]).annotate({
      title: "Country",
      description:
...
export const Body_create_skill_version_v1_skills__skill_id__versions_post =
  Schema.Struct({
    files: Schema.optionalKey(
      Schema.Union([
        Schema.Array(Schema.String.annotate({ format: "binary" })),
...
export const DirectCaller = Schema.Struct({
  type: Schema.Literal("direct").annotate({ title: "Type" }),
}).annotate({
  title: "DirectCaller",
  description: "Tool invocation directly from the model.",
...
export const RequestTextEditorCodeExecutionStrReplaceResultBlock =
  Schema.Struct({
    lines: Schema.optionalKey(
      Schema.Union([Schema.Array(Schema.String), Schema.Null]).annotate({
        title: "Lines",
...
export type ServerToolCaller_20260120 = {
  readonly tool_id: string;
  readonly type: "code_execution_20260120";
};
...
export const ToolChoiceNone = Schema.Struct({
  type: Schema.Literal("none").annotate({ title: "Type" }),
}).annotate({
  title: "ToolChoiceNone",
  description: "The model will not be allowed to use tools.",
...
export const BetaMemoryTool_20250818_ViewCommand = Schema.Struct({
  command: Schema.Literal("view").annotate({
  ...
  view_range: Schema.optionalKey(
    Schema.Array(Schema.Number.check(Schema.isInt()))
      .annotate({
...
export const BetaMemoryTool_20250818_CreateCommand = Schema.Struct({
  command: Schema.Literal("create").annotate({
    description: "Command type identifier",
    default: "create",
  }),
  path: Schema.String.annotate({
  ...
  file_text: Schema.String.annotate({
...
export const BetaMemoryTool_20250818_StrReplaceCommand = Schema.Struct({
  ...
  old_str: Schema.String.annotate({
...
export const BetaMemoryTool_20250818_InsertCommand = Schema.Struct({
  command: Schema.Literal("insert").annotate({
    description: "Command type identifier",
    default: "insert",
  }),
  path: Schema.String.annotate({
...
export const BetaMemoryTool_20250818_RenameCommand = Schema.Struct({
  command: Schema.Literal("rename").annotate({
    description: "Command type identifier",
    default: "rename",
  }),
  old_path: Schema.String.annotate({
    description: "Current path of the file or directory",
  }),
  new_path: Schema.String.annotate({
...
export const BetaCodeExecutionTool_20250522 = Schema.Struct({
  ...
  cache_control: Schema.optionalKey(
    Schema.Union([
      Schema.Union([BetaCacheControlEphemeral], { mode: "oneOf" }),
      Schema.Null,
    ]).annotate({
      title: "Cache Control",
...
export const BetaCountMessageTokensResponse = Schema.Struct({
  context_management: Schema.Union([
...
export type BetaBashTool_20241022 = {
  ...
  readonly cache_control?: BetaCacheControlEphemeral | null;
  readonly defer_loading?: boolean;
  readonly input_examples?: ReadonlyArray<{
    readonly [x: string]: BetaJsonValue;
  }>;
  readonly name: "bash";
  readonly strict?: boolean;
...
export const BetaBashTool_20241022 = Schema.Struct({
  ...
  input_examples: Schema.optionalKey(
    Schema.Array(Schema.Record(Schema.String, BetaJsonValue)).annotate({
...
export const BetaTool = Schema.Struct({
  type: Schema.optionalKey(
    Schema.Union([Schema.Null, Schema.Literal("custom")]).annotate({
      title: "Type",
    })
  ),
  ...
  name: Schema.String.annotate({
    ...
    .check(Schema.isPattern(new RegExp("^[a-zA-Z0-9_-]{1,128}$"))),
...
export const BetaMCPToolset = Schema.Struct({
  ...
  configs: Schema.optionalKey(
    Schema.Union([
      Schema.Record(Schema.String, BetaMCPToolConfig),
      Schema.Null,
    ]).annotate({
      title: "Configs",
      description:
  ...
  default_config: Schema.optionalKey(
    Schema.Struct({
      ...
      enabled: Schema.optionalKey(
        Schema.Boolean.annotate({ title: "Enabled" })
      ),
    }).annotate({
...
export const BetaErrorResponse = Schema.Struct({
  ...
  request_id: Schema.Union([Schema.String, Schema.Null]).annotate({
    title: "Request Id",
    default: null,
  }),
...
export const BetaRequestBashCodeExecutionResultBlock = Schema.Struct({
  content: Schema.Array(BetaRequestBashCodeExecutionOutputBlock).annotate({
    title: "Content",
  }),
...
export const BetaRequestMCPServerURLDefinition = Schema.Struct({
  ...
  name: Schema.String.annotate({ title: "Name" }),
  tool_configuration: Schema.optionalKey(
    Schema.Union([BetaRequestMCPServerToolConfiguration, Schema.Null])
  ),
  type: Schema.Literal("url").annotate({ title: "Type" }),
  url: Schema.String.annotate({ title: "Url" }),
    ...
    Schema.Union([
      ...
      Schema.Array(
        Schema.Struct({
          ...
          text: Schema.String.annotate({ title: "Text" }).check(
...
export const BetaResponseBashCodeExecutionResultBlock = Schema.Struct({
  content: Schema.Array(BetaResponseBashCodeExecutionOutputBlock).annotate({
    title: "Content",
  }),
  return_code: Schema.Number.annotate({ title: "Return Code" }).check(
    Schema.isInt()
...
export const BetaResponseDocumentBlock = Schema.Struct({
  ...
  source: Schema.Union([BetaBase64PDFSource, BetaPlainTextSource], {
    mode: "oneOf",
...
export type BetaResponseContextManagement = {
  readonly applied_edits: ReadonlyArray<
...
export const BetaResponseMCPToolResultBlock = Schema.Struct({
    ...
    Schema.Array(
      Schema.Struct({
        ...
        text: Schema.String.annotate({ title: "Text" })
          ...
          .check(Schema.isMaxLength(5000000)),
  ...
  type: Schema.Literal("mcp_tool_result").annotate({
    title: "Type",
...
export const BetaRequestServerToolUseBlock = Schema.Struct({
  ...
  caller: Schema.optionalKey(
    Schema.Union(
      [BetaDirectCaller, BetaServerToolCaller, BetaServerToolCaller_20260120],
      { mode: "oneOf" }
    ).annotate({
      title: "Caller",
    })
...
export const BetaContainerParams = Schema.Struct({
  ...
  skills: Schema.optionalKey(
    Schema.Union([
      Schema.Array(BetaSkillParams).check(Schema.isMaxLength(8)),
      Schema.Null,
    ]).annotate({
      title: "Skills",
...
export const BetaListSkillVersionsResponse = Schema.Struct({
  data: Schema.Array(BetaSkillVersion).annotate({
    title: "Data",
...
export const BetaClearThinking20251015 = Schema.Struct({
  keep: Schema.optionalKey(
    Schema.Union([
      Schema.Union([BetaThinkingTurns, BetaAllThinkingTurns], {
        mode: "oneOf",
      }),
      Schema.Literal("all"),
    ]).annotate({
...
export const BetaClearToolUses20250919 = Schema.Struct({
  ...
  trigger: Schema.optionalKey(
    Schema.Union([BetaInputTokensTrigger, BetaToolUsesTrigger], {
      mode: "oneOf",
    }).annotate({
      title: "Trigger",
...
export const BetaListSkillsResponse = Schema.Struct({
  data: Schema.Array(Betaapi__schemas__skills__Skill).annotate({
    title: "Data",
...
export const CodeExecutionTool_20250522 = Schema.Struct({
  ...
  cache_control: Schema.optionalKey(
    Schema.Union([
      Schema.Union([CacheControlEphemeral], { mode: "oneOf" }),
      Schema.Null,
    ]).annotate({
      title: "Cache Control",
      description: "Create a cache control breakpoint at this content block.",
...
export const BashTool_20250124 = Schema.Struct({
  ...
  input_examples: Schema.optionalKey(
    Schema.Array(Schema.Record(Schema.String, JsonValue)).annotate({
      title: "Input Examples",
    })
  ),
  name: Schema.Literal("bash").annotate({
...
export const RequestServerToolUseBlock = Schema.Struct({
  ...
  caller: Schema.optionalKey(
    Schema.Union([DirectCaller, ServerToolCaller, ServerToolCaller_20260120], {
      mode: "oneOf",
    }).annotate({
      title: "Caller",
    })
...
export const ResponseServerToolUseBlock = Schema.Struct({
  caller: Schema.Union(
    [DirectCaller, ServerToolCaller, ServerToolCaller_20260120],
    { mode: "oneOf" }
  ).annotate({
    title: "Caller",
    default: { type: "direct" },
...
export type BetaIterationsUsage = ReadonlyArray<
  BetaMessageIterationUsage | BetaCompactionIterationUsage
> | null;
export const BetaIterationsUsage = Schema.Union([
  Schema.Array(
    Schema.Union([BetaMessageIterationUsage, BetaCompactionIterationUsage])
  ),
  Schema.Null,
]).annotate({
  title: "Iterations",
...
export type BetaErroredResult = {
  readonly error: BetaErrorResponse;
...
export type BetaContextManagementConfig = {
  readonly edits?: ReadonlyArray<
    BetaClearToolUses20250919 | BetaClearThinking20251015 | BetaCompact20260112
  >;
};
...
export type BetaContentBlockSource = {
  readonly content:
    | string
    | ReadonlyArray<BetaRequestTextBlock | BetaRequestImageBlock>;
...
export const BetaContentBlockSource = Schema.Struct({
  content: Schema.Union([
    Schema.String,
    Schema.Array(
      Schema.Union([BetaRequestTextBlock, BetaRequestImageBlock], {
        mode: "oneOf",
      }).annotate({
...
export type BetaRequestWebSearchToolResultBlock = {
  ...
  readonly caller?:
    ...
    | BetaServerToolCaller_20260120;
  readonly content:
    | ReadonlyArray<BetaRequestWebSearchResultBlock>
...
export const BetaRequestWebSearchToolResultBlock = Schema.Struct({
  ...
  content: Schema.Union([
    Schema.Array(BetaRequestWebSearchResultBlock).annotate({
      title: "Result Block",
    }),
    BetaRequestWebSearchToolResultError,
  ]).annotate({ title: "Content" }),
...
export type BetaResponseWebSearchToolResultBlock = {
  ...
  readonly content:
    ...
    | ReadonlyArray<BetaResponseWebSearchResultBlock>;
  readonly tool_use_id: string;
  readonly type: "web_search_tool_result";
};
export const BetaResponseWebSearchToolResultBlock = Schema.Struct({
  ...
  content: Schema.Union([
    BetaResponseWebSearchToolResultError,
    Schema.Array(BetaResponseWebSearchResultBlock),
  ]).annotate({ title: "Content" }),
  tool_use_id: Schema.String.annotate({ title: "Tool Use Id" }).check(
    Schema.isPattern(new RegExp("^srvtoolu_[a-zA-Z0-9_]+$"))
  ),
...
export type ContentBlockSource = {
  readonly content:
    | string
    | ReadonlyArray<RequestTextBlock | RequestImageBlock>;
  readonly type: "content";
};
export const ContentBlockSource = Schema.Struct({
  content: Schema.Union([
    Schema.String,
    Schema.Array(
      Schema.Union([RequestTextBlock, RequestImageBlock], {
        mode: "oneOf",
      }).annotate({
...
export type RequestWebSearchToolResultBlock = {
  ...
  readonly caller?: DirectCaller | ServerToolCaller | ServerToolCaller_20260120;
  readonly content:
    | ReadonlyArray<RequestWebSearchResultBlock>
...
export const RequestWebSearchToolResultBlock = Schema.Struct({
  ...
  content: Schema.Union([
    Schema.Array(RequestWebSearchResultBlock).annotate({
...
export type ResponseWebSearchToolResultBlock = {
  ...
  readonly content:
    ...
    | ReadonlyArray<ResponseWebSearchResultBlock>;
  readonly tool_use_id: string;
  readonly type: "web_search_tool_result";
};
export const ResponseWebSearchToolResultBlock = Schema.Struct({
  ...
  content: Schema.Union([
    ResponseWebSearchToolResultError,
    Schema.Array(ResponseWebSearchResultBlock),
  ]).annotate({
    title: "Content",
  }),
  tool_use_id: Schema.String.annotate({ title: "Tool Use Id" }).check(
...
export const BetaRequestDocumentBlock = Schema.Struct({
  ...
  citations: Schema.optionalKey(
    Schema.Union([BetaRequestCitationsConfig, Schema.Null])
  ),
  context: Schema.optionalKey(
    Schema.Union([
      Schema.String.check(Schema.isMinLength(1)),
      Schema.Null,
    ]).annotate({ title: "Context" })
  ),
  source: Schema.Union(
    [
      BetaBase64PDFSource,
...
export const RequestDocumentBlock = Schema.Struct({
  ...
  citations: Schema.optionalKey(
    Schema.Union([RequestCitationsConfig, Schema.Null])
  ),
  context: Schema.optionalKey(
    Schema.Union([
      Schema.String.check(Schema.isMinLength(1)),
...
export const BetaMessage = Schema.Struct({
  ...
  usage: Schema.Struct({
    ...
    service_tier: Schema.Union([
      Schema.Literals(["standard", "priority", "batch"]),
      Schema.Null,
    ]).annotate({
      title: "Service Tier",
...
export const BetaInputContentBlock = Schema.Union(
  [
    ...
    Schema.Struct({
      ...
      is_error: Schema.optionalKey(
        Schema.Boolean.annotate({ title: "Is Error" })
      ),
      tool_use_id: Schema.String.annotate({ title: "Tool Use Id" }).check(
        Schema.isPattern(new RegExp("^[a-zA-Z0-9_-]+$"))
      ),
...
export const BetaInputMessage = Schema.Struct({
  content: Schema.Union([
    Schema.String,
    Schema.Array(BetaInputContentBlock),
  ]).annotate({ title: "Content" }),
...
export const InputMessage = Schema.Struct({
  content: Schema.Union([
    Schema.String,
    Schema.Array(InputContentBlock),
  ]).annotate({ title: "Content" }),
  role: Schema.Literals(["user", "assistant"]).annotate({ title: "Role" }),
}).annotate({ title: "InputMessage" });
...
export const BetaCountMessageTokensParams = Schema.Struct({
  ...
  mcp_servers: Schema.optionalKey(
    Schema.Array(BetaRequestMCPServerURLDefinition)
      .annotate({
        title: "Mcp Servers",
...
export const BetaMessageBatchIndividualRequestParams = Schema.Struct({
  ...
  params: Schema.Struct({
    ...
    system: Schema.optionalKey(
      Schema.Union([
        Schema.String,
        Schema.Array(BetaRequestTextBlock),
      ]).annotate({
        title: "System",
        description:
          "System prompt.\n\nA system prompt is a way of providing context and instructions to Claude, such as specifying a particular goal or role. See our [guide to system prompts](https://docs.claude.com/en/docs/system-prompts).",
...
export type CountMessageTokensParams = {
  ...
  readonly output_config?: {
    ...
    readonly format?: JsonOutputFormat | null;
  };
...
export const BetaCreateMessageBatchParams = Schema.Struct({
  requests: Schema.Array(BetaMessageBatchIndividualRequestParams)
    .annotate({
      title: "Requests",
      description:
...
export type CreateMessageBatchParams = {
  readonly requests: ReadonlyArray<MessageBatchIndividualRequestParams>;
};
export const CreateMessageBatchParams = Schema.Struct({
  requests: Schema.Array(MessageBatchIndividualRequestParams)
    .annotate({
      title: "Requests",
      description:
        "List of requests for prompt completion. Each is an individual request to create a Message.",
...
export type CompletePostParams = {
...
export type MessageBatchesPostParams = {
  readonly "anthropic-version"?: string;
};
...
export type MessageBatchesRetrieveParams = {
  readonly "anthropic-version"?: string;
  readonly "x-api-key"?: string;
};
...
export type MessageBatchesDeleteParams = {
  readonly "anthropic-version"?: string;
  readonly "x-api-key"?: string;
};
...
export type MessageBatchesCancelParams = {
  readonly "anthropic-version"?: string;
};
...
export type MessagesCountTokensPostParams = {
  readonly "anthropic-version"?: string;
};
...
export type UploadFileV1FilesPostParams = {
  readonly "anthropic-beta"?: string;
  readonly "anthropic-version"?: string;
};
...
export type CreateSkillV1SkillsPostRequestFormData =
  Body_create_skill_v1_skills_post;
export const CreateSkillV1SkillsPostRequestFormData =
  Body_create_skill_v1_skills_post;
...
export type ListSkillVersionsV1SkillsSkillIdVersionsGet200 =
  ListSkillVersionsResponse;
export const ListSkillVersionsV1SkillsSkillIdVersionsGet200 =
  ListSkillVersionsResponse;
...
export const CreateSkillVersionV1SkillsSkillIdVersionsPostParams =
  Schema.Struct({
    "anthropic-beta": Schema.optionalKey(
      Schema.String.annotate({
        title: "Anthropic-Beta",
...
export const CreateSkillVersionV1SkillsSkillIdVersionsPostRequestFormData =
  Body_create_skill_version_v1_skills__skill_id__versions_post;
export type CreateSkillVersionV1SkillsSkillIdVersionsPost200 =
  CreateSkillVersionResponse;
export const CreateSkillVersionV1SkillsSkillIdVersionsPost200 =
  CreateSkillVersionResponse;
...
export const GetSkillVersionV1SkillsSkillIdVersionsVersionGetParams =
  Schema.Struct({
    "anthropic-beta": Schema.optionalKey(
      Schema.String.annotate({
        title: "Anthropic-Beta",
...
export type GetSkillVersionV1SkillsSkillIdVersionsVersionGet200 =
  GetSkillVersionResponse;
export const GetSkillVersionV1SkillsSkillIdVersionsVersionGet200 =
  GetSkillVersionResponse;
export type GetSkillVersionV1SkillsSkillIdVersionsVersionGet4XX = ErrorResponse;
export const GetSkillVersionV1SkillsSkillIdVersionsVersionGet4XX =
  ErrorResponse;
...
export const DeleteSkillVersionV1SkillsSkillIdVersionsVersionDeleteParams =
  Schema.Struct({
    "anthropic-beta": Schema.optionalKey(
      Schema.String.annotate({
        title: "Anthropic-Beta",
...
export type DeleteSkillVersionV1SkillsSkillIdVersionsVersionDelete200 =
  DeleteSkillVersionResponse;
export const DeleteSkillVersionV1SkillsSkillIdVersionsVersionDelete200 =
  DeleteSkillVersionResponse;
export type DeleteSkillVersionV1SkillsSkillIdVersionsVersionDelete4XX =
  ErrorResponse;
export const DeleteSkillVersionV1SkillsSkillIdVersionsVersionDelete4XX =
  ErrorResponse;
export type BetaMessagesPostParams = {
  readonly "anthropic-beta"?: string;
  readonly "anthropic-version"?: string;
};
...
export type BetaMessageBatchesPostParams = {
  readonly "anthropic-beta"?: string;
  readonly "anthropic-version"?: string;
};
...
export type BetaMessagesCountTokensPostRequestJson =
  BetaCountMessageTokensParams;
export const BetaMessagesCountTokensPostRequestJson =
  BetaCountMessageTokensParams;
...
export type BetaUploadFileV1FilesPostRequestFormData = {
...
export type BetaCreateSkillV1SkillsPostRequestFormData =
  BetaBody_create_skill_v1_skills_post;
export const BetaCreateSkillV1SkillsPostRequestFormData =
  BetaBody_create_skill_v1_skills_post;
...
export const BetaListSkillVersionsV1SkillsSkillIdVersionsGetParams =
  Schema.Struct({
    page: Schema.optionalKey(
      Schema.Union([Schema.String, Schema.Null]).annotate({
        title: "Page",
...
export type BetaListSkillVersionsV1SkillsSkillIdVersionsGet200 =
  BetaListSkillVersionsResponse;
export const BetaListSkillVersionsV1SkillsSkillIdVersionsGet200 =
  BetaListSkillVersionsResponse;
export type BetaListSkillVersionsV1SkillsSkillIdVersionsGet4XX =
  BetaErrorResponse;
export const BetaListSkillVersionsV1SkillsSkillIdVersionsGet4XX =
  BetaErrorResponse;
export type BetaCreateSkillVersionV1SkillsSkillIdVersionsPostParams = {
  readonly "anthropic-beta"?: string;
  readonly "anthropic-version"?: string;
};
export const BetaCreateSkillVersionV1SkillsSkillIdVersionsPostParams =
  Schema.Struct({
    "anthropic-beta": Schema.optionalKey(
      Schema.String.annotate({
        title: "Anthropic-Beta",
...
export const BetaCreateSkillVersionV1SkillsSkillIdVersionsPostRequestFormData =
  BetaBody_create_skill_version_v1_skills__skill_id__versions_post;
export type BetaCreateSkillVersionV1SkillsSkillIdVersionsPost200 =
  BetaCreateSkillVersionResponse;
export const BetaCreateSkillVersionV1SkillsSkillIdVersionsPost200 =
  BetaCreateSkillVersionResponse;
export type BetaCreateSkillVersionV1SkillsSkillIdVersionsPost4XX =
  BetaErrorResponse;
export const BetaCreateSkillVersionV1SkillsSkillIdVersionsPost4XX =
  BetaErrorResponse;
...
export const BetaGetSkillVersionV1SkillsSkillIdVersionsVersionGetParams =
  Schema.Struct({
    "anthropic-beta": Schema.optionalKey(
      Schema.String.annotate({
        title: "Anthropic-Beta",
...
export type BetaGetSkillVersionV1SkillsSkillIdVersionsVersionGet200 =
  BetaGetSkillVersionResponse;
export const BetaGetSkillVersionV1SkillsSkillIdVersionsVersionGet200 =
  BetaGetSkillVersionResponse;
export type BetaGetSkillVersionV1SkillsSkillIdVersionsVersionGet4XX =
  BetaErrorResponse;
export const BetaGetSkillVersionV1SkillsSkillIdVersionsVersionGet4XX =
  BetaErrorResponse;
...
export const BetaDeleteSkillVersionV1SkillsSkillIdVersionsVersionDeleteParams =
  Schema.Struct({
    "anthropic-beta": Schema.optionalKey(
      Schema.String.annotate({
        title: "Anthropic-Beta",
...
export type BetaDeleteSkillVersionV1SkillsSkillIdVersionsVersionDelete200 =
  BetaDeleteSkillVersionResponse;
export const BetaDeleteSkillVersionV1SkillsSkillIdVersionsVersionDelete200 =
  BetaDeleteSkillVersionResponse;
export type BetaDeleteSkillVersionV1SkillsSkillIdVersionsVersionDelete4XX =
  BetaErrorResponse;
export const BetaDeleteSkillVersionV1SkillsSkillIdVersionsVersionDelete4XX =
  BetaErrorResponse;
...
export const make = (
  ...
  const decodeError =
    <const Tag extends string, Schema extends Schema.Top>(
      tag: Tag,
      schema: Schema
    ) =>
    (response: HttpClientResponse.HttpClientResponse) =>
  ...
  return {
    ...
    messagesPost: (options) =>
      HttpClientRequest.post(`/v1/messages`).pipe(
        HttpClientRequest.setHeaders({
          "anthropic-version":
            options.params?.["anthropic-version"] ?? undefined,
        }),
      ...
      HttpClientRequest.get(`/v1/files/${fileId}`).pipe(
        ...
        withResponse(options?.config)(
          HttpClientResponse.matchStatus({
            ...
            "4xx": decodeError(
              "GetFileMetadataV1FilesFileIdGet4XX",
              GetFileMetadataV1FilesFileIdGet4XX
            ),
            orElse: unexpectedStatus,
          })
      ...
      HttpClientRequest.delete(`/v1/files/${fileId}`).pipe(
        ...
        withResponse(options?.config)(
          HttpClientResponse.matchStatus({
            ...
            "4xx": decodeError(
              "DeleteFileV1FilesFileIdDelete4XX",
              DeleteFileV1FilesFileIdDelete4XX
            ),
            orElse: unexpectedStatus,
          })
      ...
      HttpClientRequest.delete(`/v1/skills/${skillId}`).pipe(
        ...
        withResponse(options?.config)(
          HttpClientResponse.matchStatus({
            ...
            "4xx": decodeError(
              "DeleteSkillV1SkillsSkillIdDelete4XX",
              DeleteSkillV1SkillsSkillIdDelete4XX
            ),
            orElse: unexpectedStatus,
          })
    ...
    listSkillVersionsV1SkillsSkillIdVersionsGet: (skillId, options) =>
      HttpClientRequest.get(`/v1/skills/${skillId}/versions`).pipe(
        ...
        withResponse(options?.config)(
          HttpClientResponse.matchStatus({
            "2xx": decodeSuccess(
              ListSkillVersionsV1SkillsSkillIdVersionsGet200
            ),
            "4xx": decodeError(
    ...
    createSkillVersionV1SkillsSkillIdVersionsPost: (skillId, options) =>
      HttpClientRequest.post(`/v1/skills/${skillId}/versions`).pipe(
        ...
        withResponse(options.config)(
          HttpClientResponse.matchStatus({
            "2xx": decodeSuccess(
              CreateSkillVersionV1SkillsSkillIdVersionsPost200
            ),
            "4xx": decodeError(
    ...
    getSkillVersionV1SkillsSkillIdVersionsVersionGet: (
      ...
      HttpClientRequest.get(`/v1/skills/${skillId}/versions/${version}`).pipe(
        ...
        withResponse(options?.config)(
          HttpClientResponse.matchStatus({
            "2xx": decodeSuccess(
              GetSkillVersionV1SkillsSkillIdVersionsVersionGet200
            ),
            "4xx": decodeError(
    ...
    deleteSkillVersionV1SkillsSkillIdVersionsVersionDelete: (
      ...
      HttpClientRequest.delete(
        ...
        withResponse(options?.config)(
          HttpClientResponse.matchStatus({
            "2xx": decodeSuccess(
              DeleteSkillVersionV1SkillsSkillIdVersionsVersionDelete200
            ),
            "4xx": decodeError(
      ...
      HttpClientRequest.get(`/v1/files/${fileId}?beta=true`).pipe(
        ...
        withResponse(options?.config)(
          HttpClientResponse.matchStatus({
            ...
            "4xx": decodeError(
              "BetaGetFileMetadataV1FilesFileIdGet4XX",
              BetaGetFileMetadataV1FilesFileIdGet4XX
            ),
            orElse: unexpectedStatus,
          })
      ...
      HttpClientRequest.delete(`/v1/files/${fileId}?beta=true`).pipe(
        ...
        withResponse(options?.config)(
          HttpClientResponse.matchStatus({
            ...
            "4xx": decodeError(
              "BetaDeleteFileV1FilesFileIdDelete4XX",
              BetaDeleteFileV1FilesFileIdDelete4XX
            ),
            orElse: unexpectedStatus,
          })
      ...
      HttpClientRequest.post(`/v1/skills?beta=true`).pipe(
        ...
        withResponse(options.config)(
          HttpClientResponse.matchStatus({
            ...
            "4xx": decodeError(
              "BetaCreateSkillV1SkillsPost4XX",
              BetaCreateSkillV1SkillsPost4XX
            ),
            orElse: unexpectedStatus,
          })
    ...
    betaListSkillVersionsV1SkillsSkillIdVersionsGet: (skillId, options) =>
      HttpClientRequest.get(`/v1/skills/${skillId}/versions?beta=true`).pipe(
        ...
        withResponse(options?.config)(
          HttpClientResponse.matchStatus({
            "2xx": decodeSuccess(
              BetaListSkillVersionsV1SkillsSkillIdVersionsGet200
            ),
            "4xx": decodeError(
    ...
    betaCreateSkillVersionV1SkillsSkillIdVersionsPost: (skillId, options) =>
      HttpClientRequest.post(`/v1/skills/${skillId}/versions?beta=true`).pipe(
        ...
        withResponse(options.config)(
          HttpClientResponse.matchStatus({
            "2xx": decodeSuccess(
              BetaCreateSkillVersionV1SkillsSkillIdVersionsPost200
            ),
            "4xx": decodeError(
    ...
    betaGetSkillVersionV1SkillsSkillIdVersionsVersionGet: (
      skillId,
      version,
      options
    ) =>
      HttpClientRequest.get(
        `/v1/skills/${skillId}/versions/${version}?beta=true`
      ).pipe(
        HttpClientRequest.setHeaders({
          "anthropic-beta": options?.params?.["anthropic-beta"] ?? undefined,
          "anthropic-version":
        ...
        withResponse(options?.config)(
          HttpClientResponse.matchStatus({
            "2xx": decodeSuccess(
              BetaGetSkillVersionV1SkillsSkillIdVersionsVersionGet200
            ),
            "4xx": decodeError(
    ...
    betaDeleteSkillVersionV1SkillsSkillIdVersionsVersionDelete: (
      skillId,
      version,
      options
    ) =>
      HttpClientRequest.delete(
        ...
        withResponse(options?.config)(
          HttpClientResponse.matchStatus({
            "2xx": decodeSuccess(
              BetaDeleteSkillVersionV1SkillsSkillIdVersionsVersionDelete200
            ),
            "4xx": decodeError(
...
export interface AnthropicClient {
   ...
   */
  readonly messagesPost: <Config extends OperationConfig>(options: {
    ...
    | SchemaError
    | AnthropicClientError<"MessagesPost4XX", typeof MessagesPost4XX.Type>
  >;
  /**
   ...
   */
  readonly completePost: <Config extends OperationConfig>(options: {
    ...
    | HttpClientError.HttpClientError
    | SchemaError
    | AnthropicClientError<"CompletePost4XX", typeof CompletePost4XX.Type>
  >;
  /**
  ...
  readonly modelsList: <Config extends OperationConfig>(
    options:
      | {
          readonly params?: typeof ModelsListParams.Encoded | undefined;
          readonly config?: Config | undefined;
        }
      | undefined
  ) => Effect.Effect<
    ...
    | HttpClientError.HttpClientError
    | SchemaError
    | AnthropicClientError<"ModelsList4XX", typeof ModelsList4XX.Type>
  >;
  /**
  ...
  readonly modelsGet: <Config extends OperationConfig>(
    ...
    options:
      | {
          readonly params?: typeof ModelsGetParams.Encoded | undefined;
          readonly config?: Config | undefined;
        }
      | undefined
  ) => Effect.Effect<
    ...
    | HttpClientError.HttpClientError
    | SchemaError
    | AnthropicClientError<"ModelsGet4XX", typeof ModelsGet4XX.Type>
  >;
  /**
  ...
  readonly messageBatchesList: <Config extends OperationConfig>(
    ...
    | AnthropicClientError<
        "MessageBatchesList4XX",
        typeof MessageBatchesList4XX.Type
      >
  >;
  /**
   ...
   * Learn more about the Message Batches API in our [user guide](https://docs.claude.com/en/docs/build-with-claude/batch-processing)
   */
  readonly messageBatchesPost: <Config extends OperationConfig>(options: {
    ...
    | AnthropicClientError<
        ...
        typeof MessageBatchesPost4XX.Type
      >
  >;
  /**
  ...
  readonly messageBatchesRetrieve: <Config extends OperationConfig>(
    ...
    options:
      | {
          readonly params?:
            | typeof MessageBatchesRetrieveParams.Encoded
            | undefined;
          readonly config?: Config | undefined;
        }
      | undefined
    ...
    | AnthropicClientError<
        "MessageBatchesRetrieve4XX",
        typeof MessageBatchesRetrieve4XX.Type
      >
  >;
  /**
  ...
  readonly messageBatchesDelete: <Config extends OperationConfig>(
    ...
    options:
      | {
          readonly params?:
            | typeof MessageBatchesDeleteParams.Encoded
            | undefined;
          readonly config?: Config | undefined;
        }
      | undefined
    ...
    | AnthropicClientError<
        "MessageBatchesDelete4XX",
        typeof MessageBatchesDelete4XX.Type
      >
  >;
  /**
  ...
  readonly messageBatchesCancel: <Config extends OperationConfig>(
    ...
    options:
      | {
          readonly params?:
            | typeof MessageBatchesCancelParams.Encoded
            | undefined;
          readonly config?: Config | undefined;
        }
      | undefined
    ...
    | AnthropicClientError<
        "MessageBatchesCancel4XX",
        typeof MessageBatchesCancel4XX.Type
      >
  >;
  /**
  ...
  readonly messageBatchesResults: <Config extends OperationConfig>(
    ...
    options:
      | {
          readonly params?:
            | typeof MessageBatchesResultsParams.Encoded
            | undefined;
          readonly config?: Config | undefined;
        }
      | undefined
    ...
    | AnthropicClientError<
        "MessageBatchesResults4XX",
        typeof MessageBatchesResults4XX.Type
      >
  >;
  /**
   ...
   */
  readonly messagesCountTokensPost: <Config extends OperationConfig>(options: {
    ...
    | AnthropicClientError<
        "MessagesCountTokensPost4XX",
        typeof MessagesCountTokensPost4XX.Type
      >
  >;
  /**
   * List Files
  ...
  readonly listFilesV1FilesGet: <Config extends OperationConfig>(
    options:
      | {
          readonly params?:
            | typeof ListFilesV1FilesGetParams.Encoded
            | undefined;
          readonly config?: Config | undefined;
        }
      | undefined
    ...
    | AnthropicClientError<
        "ListFilesV1FilesGet4XX",
        typeof ListFilesV1FilesGet4XX.Type
      >
  >;
  /**
   * Upload File
   */
  readonly uploadFileV1FilesPost: <Config extends OperationConfig>(options: {
    ...
    | AnthropicClientError<
        "UploadFileV1FilesPost4XX",
        typeof UploadFileV1FilesPost4XX.Type
      >
  >;
  /**
   * Get File Metadata
  ...
  readonly getFileMetadataV1FilesFileIdGet: <Config extends OperationConfig>(
    ...
    options:
      | {
          readonly params?:
            | typeof GetFileMetadataV1FilesFileIdGetParams.Encoded
            | undefined;
          readonly config?: Config | undefined;
        }
      | undefined
    ...
    WithOptionalResponse<
      typeof GetFileMetadataV1FilesFileIdGet200.Type,
      Config
    >,
    | HttpClientError.HttpClientError
    | SchemaError
    | AnthropicClientError<
        "GetFileMetadataV1FilesFileIdGet4XX",
        typeof GetFileMetadataV1FilesFileIdGet4XX.Type
      >
  >;
  /**
   * Delete File
  ...
  readonly deleteFileV1FilesFileIdDelete: <Config extends OperationConfig>(
    ...
    options:
      | {
          readonly params?:
            | typeof DeleteFileV1FilesFileIdDeleteParams.Encoded
            | undefined;
          readonly config?: Config | undefined;
        }
      | undefined
    ...
    | AnthropicClientError<
        "DeleteFileV1FilesFileIdDelete4XX",
        typeof DeleteFileV1FilesFileIdDelete4XX.Type
      >
  >;
  /**
   * Download File
  ...
  >(
    ...
    options:
      | {
          readonly params?:
            | typeof DownloadFileV1FilesFileIdContentGetParams.Encoded
            | undefined;
          readonly config?: Config | undefined;
        }
      | undefined
  ...
  readonly listSkillsV1SkillsGet: <Config extends OperationConfig>(
    options:
      | {
          readonly params?:
            | typeof ListSkillsV1SkillsGetParams.Encoded
            | undefined;
          readonly config?: Config | undefined;
        }
      | undefined
    ...
    | AnthropicClientError<
        "ListSkillsV1SkillsGet4XX",
        typeof ListSkillsV1SkillsGet4XX.Type
      >
  >;
  /**
   * Create Skill
   */
  readonly createSkillV1SkillsPost: <Config extends OperationConfig>(options: {
    ...
    | AnthropicClientError<
        "CreateSkillV1SkillsPost4XX",
        typeof CreateSkillV1SkillsPost4XX.Type
      >
  >;
  /**
   * Get Skill
  ...
  readonly getSkillV1SkillsSkillIdGet: <Config extends OperationConfig>(
    ...
    options:
      | {
          readonly params?:
            | typeof GetSkillV1SkillsSkillIdGetParams.Encoded
            | undefined;
          readonly config?: Config | undefined;
        }
      | undefined
    ...
    | AnthropicClientError<
        "GetSkillV1SkillsSkillIdGet4XX",
        typeof GetSkillV1SkillsSkillIdGet4XX.Type
      >
  >;
  /**
   * Delete Skill
  ...
  readonly deleteSkillV1SkillsSkillIdDelete: <Config extends OperationConfig>(
    ...
    options:
      | {
          readonly params?:
            | typeof DeleteSkillV1SkillsSkillIdDeleteParams.Encoded
            | undefined;
          readonly config?: Config | undefined;
        }
      | undefined
    ...
    WithOptionalResponse<
      typeof DeleteSkillV1SkillsSkillIdDelete200.Type,
      Config
    >,
    | HttpClientError.HttpClientError
    | SchemaError
    | AnthropicClientError<
        "DeleteSkillV1SkillsSkillIdDelete4XX",
        typeof DeleteSkillV1SkillsSkillIdDelete4XX.Type
      >
  >;
  /**
   * List Skill Versions
  ...
  >(
    ...
    options:
      | {
          readonly params?:
            | typeof ListSkillVersionsV1SkillsSkillIdVersionsGetParams.Encoded
            | undefined;
          readonly config?: Config | undefined;
        }
      | undefined
    ...
    WithOptionalResponse<
      typeof ListSkillVersionsV1SkillsSkillIdVersionsGet200.Type,
      Config
    >,
    | HttpClientError.HttpClientError
    | SchemaError
  ...
  >(
    ...
    options: {
      readonly params?:
        | typeof CreateSkillVersionV1SkillsSkillIdVersionsPostParams.Encoded
        | undefined;
    ...
    WithOptionalResponse<
      typeof CreateSkillVersionV1SkillsSkillIdVersionsPost200.Type,
      Config
    >,
    | HttpClientError.HttpClientError
    | SchemaError
  ...
  >(
    ...
    options:
      | {
          readonly params?:
            | typeof GetSkillVersionV1SkillsSkillIdVersionsVersionGetParams.Encoded
            | undefined;
          readonly config?: Config | undefined;
        }
      | undefined
    ...
    WithOptionalResponse<
      typeof GetSkillVersionV1SkillsSkillIdVersionsVersionGet200.Type,
      Config
    >,
    | HttpClientError.HttpClientError
    | SchemaError
  ...
  >(
    ...
    options:
      | {
          readonly params?:
            | typeof DeleteSkillVersionV1SkillsSkillIdVersionsVersionDeleteParams.Encoded
            | undefined;
          readonly config?: Config | undefined;
        }
      | undefined
    ...
    WithOptionalResponse<
      typeof DeleteSkillVersionV1SkillsSkillIdVersionsVersionDelete200.Type,
      Config
    >,
    | HttpClientError.HttpClientError
    | SchemaError
   ...
   * Learn more about the Messages API in our [user guide](https://docs.claude.com/en/docs/initial-setup)
   */
  readonly betaMessagesPost: <Config extends OperationConfig>(options: {
    ...
    | AnthropicClientError<
        "BetaMessagesPost4XX",
        typeof BetaMessagesPost4XX.Type
      >
  >;
  /**
   * List available models.
  ...
  readonly betaModelsList: <Config extends OperationConfig>(
    options:
      | {
          readonly params?: typeof BetaModelsListParams.Encoded | undefined;
          readonly config?: Config | undefined;
        }
      | undefined
  ) => Effect.Effect<
  ...
  readonly betaModelsGet: <Config extends OperationConfig>(
    ...
    options:
      | {
          readonly params?: typeof BetaModelsGetParams.Encoded | undefined;
          readonly config?: Config | undefined;
        }
      | undefined
  ) => Effect.Effect<
  ...
  readonly betaMessageBatchesList: <Config extends OperationConfig>(
    options:
      | {
          readonly params?:
            | typeof BetaMessageBatchesListParams.Encoded
            | undefined;
          readonly config?: Config | undefined;
        }
      | undefined
    ...
    | AnthropicClientError<
        "BetaMessageBatchesList4XX",
        typeof BetaMessageBatchesList4XX.Type
      >
  >;
  /**
   * Send a batch of Message creation requests.
   ...
   * Learn more about the Message Batches API in our [user guide](https://docs.claude.com/en/docs/build-with-claude/batch-processing)
   */
  readonly betaMessageBatchesPost: <Config extends OperationConfig>(options: {
    ...
    | AnthropicClientError<
        "BetaMessageBatchesPost4XX",
        typeof BetaMessageBatchesPost4XX.Type
      >
  >;
  /**
   * This endpoint is idempotent and can be used to poll for Message Batch completion. To access the results of a Message Batch, make a request to the `results_url` field in the response.
  ...
  readonly betaMessageBatchesRetrieve: <Config extends OperationConfig>(
    ...
    options:
      | {
          readonly params?:
            | typeof BetaMessageBatchesRetrieveParams.Encoded
            | undefined;
          readonly config?: Config | undefined;
        }
      | undefined
    ...
    | AnthropicClientError<
        "BetaMessageBatchesRetrieve4XX",
        typeof BetaMessageBatchesRetrieve4XX.Type
      >
  >;
  /**
   * Delete a Message Batch.
  ...
  readonly betaMessageBatchesDelete: <Config extends OperationConfig>(
    ...
    options:
      | {
          readonly params?:
            | typeof BetaMessageBatchesDeleteParams.Encoded
            | undefined;
          readonly config?: Config | undefined;
        }
      | undefined
    ...
    | AnthropicClientError<
        "BetaMessageBatchesDelete4XX",
        typeof BetaMessageBatchesDelete4XX.Type
      >
  >;
  /**
   * Batches may be canceled any time before processing ends. Once cancellation is initiated, the batch enters a `canceling` state, at which time the system may complete any in-progress, non-interruptible requests before finalizing cancellation.
  ...
  readonly betaMessageBatchesCancel: <Config extends OperationConfig>(
    ...
    options:
      | {
          readonly params?:
            | typeof BetaMessageBatchesCancelParams.Encoded
            | undefined;
          readonly config?: Config | undefined;
        }
      | undefined
    ...
    | AnthropicClientError<
        "BetaMessageBatchesCancel4XX",
        typeof BetaMessageBatchesCancel4XX.Type
      >
  >;
  /**
   * Streams the results of a Message Batch as a `.jsonl` file.
  ...
  readonly betaMessageBatchesResults: <Config extends OperationConfig>(
    ...
    options:
      | {
          readonly params?:
            | typeof BetaMessageBatchesResultsParams.Encoded
            | undefined;
          readonly config?: Config | undefined;
        }
      | undefined
    ...
    | AnthropicClientError<
        "BetaMessageBatchesResults4XX",
        typeof BetaMessageBatchesResults4XX.Type
      >
  >;
  /**
   * Count the number of tokens in a Message.
  ...
  >(options: {
    readonly params?:
      | typeof BetaMessagesCountTokensPostParams.Encoded
      | undefined;
    ...
    | AnthropicClientError<
        "BetaMessagesCountTokensPost4XX",
        typeof BetaMessagesCountTokensPost4XX.Type
      >
  >;
  /**
   * List Files
  ...
  readonly betaListFilesV1FilesGet: <Config extends OperationConfig>(
    options:
      | {
          readonly params?:
            | typeof BetaListFilesV1FilesGetParams.Encoded
            | undefined;
          readonly config?: Config | undefined;
        }
      | undefined
    ...
    | AnthropicClientError<
        "BetaListFilesV1FilesGet4XX",
        typeof BetaListFilesV1FilesGet4XX.Type
      >
  >;
  /**
   * Upload File
  ...
  >(options: {
    readonly params?:
      | typeof BetaUploadFileV1FilesPostParams.Encoded
      | undefined;
    ...
    | AnthropicClientError<
        "BetaUploadFileV1FilesPost4XX",
        typeof BetaUploadFileV1FilesPost4XX.Type
      >
  >;
  /**
   * Get File Metadata
  ...
  >(
    ...
    options:
      | {
          readonly params?:
            | typeof BetaGetFileMetadataV1FilesFileIdGetParams.Encoded
            | undefined;
          readonly config?: Config | undefined;
        }
      | undefined
    ...
    WithOptionalResponse<
      typeof BetaGetFileMetadataV1FilesFileIdGet200.Type,
      Config
    >,
    | HttpClientError.HttpClientError
    | SchemaError
    | AnthropicClientError<
        "BetaGetFileMetadataV1FilesFileIdGet4XX",
        typeof BetaGetFileMetadataV1FilesFileIdGet4XX.Type
      >
  >;
  /**
   * Delete File
  ...
  readonly betaDeleteFileV1FilesFileIdDelete: <Config extends OperationConfig>(
    ...
    options:
      | {
          readonly params?:
            | typeof BetaDeleteFileV1FilesFileIdDeleteParams.Encoded
            | undefined;
          readonly config?: Config | undefined;
        }
      | undefined
    ...
    WithOptionalResponse<
      typeof BetaDeleteFileV1FilesFileIdDelete200.Type,
      Config
    >,
    | HttpClientError.HttpClientError
    | SchemaError
    | AnthropicClientError<
        "BetaDeleteFileV1FilesFileIdDelete4XX",
        typeof BetaDeleteFileV1FilesFileIdDelete4XX.Type
      >
  >;
  /**
   * Download File
  ...
  >(
    ...
    options:
      | {
          readonly params?:
            | typeof BetaDownloadFileV1FilesFileIdContentGetParams.Encoded
            | undefined;
          readonly config?: Config | undefined;
        }
      | undefined
  ...
  readonly betaListSkillsV1SkillsGet: <Config extends OperationConfig>(
    options:
      | {
          readonly params?:
            | typeof BetaListSkillsV1SkillsGetParams.Encoded
            | undefined;
          readonly config?: Config | undefined;
        }
      | undefined
    ...
    | AnthropicClientError<
        "BetaListSkillsV1SkillsGet4XX",
        typeof BetaListSkillsV1SkillsGet4XX.Type
      >
  >;
  /**
   * Create Skill
  ...
  >(options: {
    readonly params?:
      | typeof BetaCreateSkillV1SkillsPostParams.Encoded
      | undefined;
    ...
    | AnthropicClientError<
        "BetaCreateSkillV1SkillsPost4XX",
        typeof BetaCreateSkillV1SkillsPost4XX.Type
      >
  >;
  /**
   * Get Skill
  ...
  readonly betaGetSkillV1SkillsSkillIdGet: <Config extends OperationConfig>(
    ...
    options:
      | {
          readonly params?:
            | typeof BetaGetSkillV1SkillsSkillIdGetParams.Encoded
            | undefined;
          readonly config?: Config | undefined;
        }
      | undefined
    ...
    | AnthropicClientError<
        "BetaGetSkillV1SkillsSkillIdGet4XX",
        typeof BetaGetSkillV1SkillsSkillIdGet4XX.Type
      >
  >;
  /**
   * Delete Skill
  ...
  >(
    ...
    options:
      | {
          readonly params?:
            | typeof BetaDeleteSkillV1SkillsSkillIdDeleteParams.Encoded
            | undefined;
          readonly config?: Config | undefined;
        }
      | undefined
    ...
    WithOptionalResponse<
      typeof BetaDeleteSkillV1SkillsSkillIdDelete200.Type,
      Config
    >,
    | HttpClientError.HttpClientError
    | SchemaError
  ...
  >(
    ...
    options:
      | {
          readonly params?:
            | typeof BetaListSkillVersionsV1SkillsSkillIdVersionsGetParams.Encoded
            | undefined;
          readonly config?: Config | undefined;
        }
      | undefined
    ...
    WithOptionalResponse<
      typeof BetaListSkillVersionsV1SkillsSkillIdVersionsGet200.Type,
      Config
    >,
    | HttpClientError.HttpClientError
    | SchemaError
  ...
  >(
    ...
    options: {
      readonly params?:
        | typeof BetaCreateSkillVersionV1SkillsSkillIdVersionsPostParams.Encoded
        | undefined;
    ...
    WithOptionalResponse<
      typeof BetaCreateSkillVersionV1SkillsSkillIdVersionsPost200.Type,
      Config
    >,
    | HttpClientError.HttpClientError
    | SchemaError
  ...
  >(
    ...
    options:
      | {
          readonly params?:
            | typeof BetaGetSkillVersionV1SkillsSkillIdVersionsVersionGetParams.Encoded
            | undefined;
          readonly config?: Config | undefined;
        }
      | undefined
    ...
    WithOptionalResponse<
      typeof BetaGetSkillVersionV1SkillsSkillIdVersionsVersionGet200.Type,
      Config
    >,
    | HttpClientError.HttpClientError
    | SchemaError
  ...
  >(
    ...
    options:
      | {
          readonly params?:
            | typeof BetaDeleteSkillVersionV1SkillsSkillIdVersionsVersionDeleteParams.Encoded
            | undefined;
          readonly config?: Config | undefined;
        }
      | undefined
    ...
    WithOptionalResponse<
      typeof BetaDeleteSkillVersionV1SkillsSkillIdVersionsVersionDelete200.Type,
      Config
    >,
    | HttpClientError.HttpClientError
    | SchemaError
