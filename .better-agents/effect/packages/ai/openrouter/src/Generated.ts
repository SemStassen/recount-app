...
export const ReasoningSummaryText = Schema.Struct({
...
export const OutputItemFunctionCall = Schema.Struct({
  ...
  status: Schema.optionalKey(
    Schema.Literals(["completed", "incomplete", "in_progress"])
  ),
});
...
export type WebSearchStatus =
  ...
  | "in_progress"
  | "failed";
export const WebSearchStatus = Schema.Literals([
  "completed",
  "searching",
  "in_progress",
  "failed",
...
export type ImageGenerationStatus =
  ...
  | "generating"
  | "failed";
export const ImageGenerationStatus = Schema.Literals([
  "in_progress",
  "completed",
  "generating",
  "failed",
...
export const OpenAIResponsesIncompleteDetails = Schema.Struct({
  reason: Schema.optionalKey(
    Schema.Literals(["max_output_tokens", "content_filter"])
  ),
});
...
export const OpenAIResponsesUsage = Schema.Struct({
  ...
  input_tokens_details: Schema.Struct({
    cached_tokens: Schema.Number.check(Schema.isFinite()),
  }),
  output_tokens: Schema.Number.check(Schema.isFinite()),
  output_tokens_details: Schema.Struct({
    reasoning_tokens: Schema.Number.check(Schema.isFinite()),
  }),
...
export const ResponseInputText = Schema.Struct({
...
export const ResponseInputAudio = Schema.Struct({
  ...
  input_audio: Schema.Struct({
    data: Schema.String,
    format: Schema.Literals(["mp3", "wav"]),
  }),
...
export const ResponsesSearchContextSize = Schema.Literals([
  "low",
  "medium",
  "high",
]).annotate({
...
export type OpenAIResponsesReasoningEffort =
  ...
  | "minimal"
  | "none";
export const OpenAIResponsesReasoningEffort = Schema.Literals([
  "xhigh",
  "high",
  "medium",
  "low",
...
export const ReasoningSummaryVerbosity = Schema.Literals([
  "auto",
  "concise",
  "detailed",
]);
export type OpenAIResponsesServiceTier =
  ...
  | "priority"
  | "scale";
export const OpenAIResponsesServiceTier = Schema.Literals([
  "auto",
  "default",
  "flex",
  "priority",
...
export const BigNumberUnion = Schema.String.annotate({
...
export const PDFParserEngine = Schema.Literals([
  "mistral-ocr",
  "pdf-text",
  "native",
]).annotate({
...
export const AnthropicMessagesStreamEvent = Schema.Union(
                  ...
                  Schema.Union(
                    [
                      Schema.Struct({
                        ...
                        document_index: Schema.Number.check(Schema.isFinite()),
                        document_title: Schema.String,
                        start_char_index: Schema.Number.check(
                          Schema.isFinite()
                        ),
                        end_char_index: Schema.Number.check(Schema.isFinite()),
                        file_id: Schema.String,
                      ...
                      Schema.Struct({
                        ...
                        document_index: Schema.Number.check(Schema.isFinite()),
                        document_title: Schema.String,
                        start_page_number: Schema.Number.check(
                          Schema.isFinite()
                        ),
                        end_page_number: Schema.Number.check(Schema.isFinite()),
                        file_id: Schema.String,
                      ...
                      Schema.Struct({
                        ...
                        document_index: Schema.Number.check(Schema.isFinite()),
                        document_title: Schema.String,
                        start_block_index: Schema.Number.check(
                          Schema.isFinite()
                        ),
                        end_block_index: Schema.Number.check(Schema.isFinite()),
                        file_id: Schema.String,
                      ...
                      Schema.Struct({
                        type: Schema.Literal("search_result_location"),
                        cited_text: Schema.String,
                        search_result_index: Schema.Number.check(
                          Schema.isFinite()
                        ),
                        source: Schema.String,
                        title: Schema.String,
  ...
  { mode: "oneOf" }
).annotate({ description: "Union of all possible streaming events" });
                                ...
                                Schema.Union(
                                  [
                                    Schema.Struct({
                                      type: Schema.Literal("char_location"),
                                      cited_text: Schema.String,
                                      document_index: Schema.Number.check(
                                        Schema.isFinite()
                                      ),
                                      document_title: Schema.String,
                                      start_char_index: Schema.Number.check(
                                      ...
                                      end_char_index: Schema.Number.check(
                                        Schema.isFinite()
                                      ),
                                    }),
                                    Schema.Struct({
                                      ...
                                      end_page_number: Schema.Number.check(
                                        Schema.isFinite()
                                      ),
                                    }),
                                    Schema.Struct({
                                      ...
                                      end_block_index: Schema.Number.check(
                                        Schema.isFinite()
                                      ),
                                    }),
                                    Schema.Struct({
...
export const ActivityItem = Schema.Struct({
  ...
  requests: Schema.Number.annotate({
  ...
  reasoning_tokens: Schema.Number.annotate({
...
export const TopProviderInfo = Schema.Struct({
  ...
  is_moderated: Schema.Boolean.annotate({
...
export const DefaultParameters = Schema.Struct({
  ...
  frequency_penalty: Schema.optionalKey(
    Schema.Number.check(Schema.isFinite())
      .check(Schema.isGreaterThanOrEqualTo(-2))
      .check(Schema.isLessThanOrEqualTo(2))
  ),
...
export const PercentileStats = Schema.Struct({
  p50: Schema.Number.annotate({
    description: "Median (50th percentile)",
  }).check(Schema.isFinite()),
  p75: Schema.Number.annotate({ description: "75th percentile" }).check(
    Schema.isFinite()
  ),
  p90: Schema.Number.annotate({ description: "90th percentile" }).check(
    Schema.isFinite()
  ),
  p99: Schema.Number.annotate({ description: "99th percentile" }).check(
    Schema.isFinite()
  ),
}).annotate({
  description:
...
export type ChatCompletionFinishReason =
  ...
  | "content_filter"
  | "error";
export const ChatCompletionFinishReason = Schema.Literals([
  "tool_calls",
  "stop",
  "length",
  "content_filter",
...
export const JSONSchemaConfig = Schema.Struct({
  ...
  schema: Schema.optionalKey(
    Schema.Struct({}).check(Schema.isPropertyNames(Schema.String))
  ),
...
export const ChatStreamingMessageToolCall = Schema.Struct({
  ...
  type: Schema.optionalKey(
    Schema.Union([Schema.Literal("function"), Schema.Null])
  ),
...
export const ChatError = Schema.Struct({
  error: Schema.Struct({
    code: Schema.Union([
      Schema.Union([Schema.String, Schema.Number.check(Schema.isFinite())]),
      Schema.Null,
    ]),
    message: Schema.String,
...
export const OpenAIResponsesAnnotation = Schema.Union([
  FileCitation,
  URLCitation,
  FilePath,
]);
...
export type UnauthorizedResponse = {
  readonly error: UnauthorizedResponseErrorData;
  readonly user_id?: string;
};
...
export type NotFoundResponse = {
  readonly error: NotFoundResponseErrorData;
  readonly user_id?: string;
};
...
export type RequestTimeoutResponse = {
  readonly error: RequestTimeoutResponseErrorData;
  readonly user_id?: string;
};
...
export type InternalServerResponse = {
  readonly error: InternalServerResponseErrorData;
  readonly user_id?: string;
};
...
export const ProviderSortConfig = Schema.Struct({
  ...
  partition: Schema.optionalKey(
    Schema.Union([Schema.Literals(["model", "none"]), Schema.Null])
  ),
});
...
export const PDFParserOptions = Schema.Struct({
  engine: Schema.optionalKey(PDFParserEngine),
}).annotate({
  description: "Options for PDF parsing.",
});
export type ForbiddenResponse = {
  readonly error: ForbiddenResponseErrorData;
  readonly user_id?: string;
};
...
export const ModelArchitecture = Schema.Struct({
  ...
  modality: Schema.String.annotate({
    description: "Primary modality of the model",
  }),
  input_modalities: Schema.Array(InputModality).annotate({
    description: "Supported input modalities",
  }),
  output_modalities: Schema.Array(OutputModality).annotate({
...
export const PublicEndpoint = Schema.Struct({
  name: Schema.String,
  model_id: Schema.String.annotate({
...
export const __schema26 = Schema.Union([
...
export const ProviderSortUnion = Schema.Union([
  ProviderSort,
  ProviderSortConfig,
]);
...
export const ProviderPreferences = Schema.Struct({
  ...
  max_price: Schema.optionalKey(
    Schema.Struct({
      ...
      image: Schema.optionalKey(
        Schema.String.annotate({ description: "Price per image" })
      ),
      audio: Schema.optionalKey(
        Schema.String.annotate({ description: "Price per audio unit" })
      ),
      request: Schema.optionalKey(
        Schema.String.annotate({ description: "Price per request" })
      ),
    }).annotate({
      description:
...
export const AnthropicMessagesRequest = Schema.Struct({
  ...
  metadata: Schema.optionalKey(
    Schema.Struct({ user_id: Schema.optionalKey(Schema.String) })
  ),
    ...
    Schema.Union(
      [
        Schema.Struct({
          ...
          budget_tokens: Schema.Number.check(Schema.isFinite()),
        }),
...
export const Model = Schema.Struct({
  ...
  canonical_slug: Schema.String.annotate({
  ...
  description: Schema.optionalKey(
    Schema.String.annotate({ description: "Description of the model" })
  ),
  pricing: PublicPricing,
  context_length: Schema.Number.annotate({
...
export type ListEndpointsResponse = {
  ...
  readonly architecture: {
    ...
    readonly instruct_type:
      ...
      | "qwen3";
    readonly modality: string;
    readonly input_modalities: ReadonlyArray<
      "text" | "image" | "file" | "audio" | "video"
    >;
    readonly output_modalities: ReadonlyArray<
...
export const ListEndpointsResponse = Schema.Struct({
  ...
  architecture: Schema.Struct({
    tokenizer: Schema.Union([
      Schema.Literal("Router").annotate({
        description: "Tokenizer type used by the model",
      }),
      Schema.Literal("Media").annotate({
        description: "Tokenizer type used by the model",
      }),
      Schema.Literal("Other").annotate({
        description: "Tokenizer type used by the model",
      }),
      Schema.Literal("GPT").annotate({
        description: "Tokenizer type used by the model",
      }),
      Schema.Literal("Claude").annotate({
        description: "Tokenizer type used by the model",
      }),
      Schema.Literal("Gemini").annotate({
        description: "Tokenizer type used by the model",
      }),
      Schema.Literal("Grok").annotate({
        description: "Tokenizer type used by the model",
      }),
      Schema.Literal("Cohere").annotate({
        description: "Tokenizer type used by the model",
      }),
      Schema.Literal("Nova").annotate({
        description: "Tokenizer type used by the model",
      }),
      Schema.Literal("Qwen").annotate({
        description: "Tokenizer type used by the model",
      }),
      Schema.Literal("Yi").annotate({
        description: "Tokenizer type used by the model",
      }),
      Schema.Literal("DeepSeek").annotate({
        description: "Tokenizer type used by the model",
      }),
      Schema.Literal("Mistral").annotate({
        description: "Tokenizer type used by the model",
      }),
      Schema.Literal("Llama2").annotate({
        description: "Tokenizer type used by the model",
      }),
      Schema.Literal("Llama3").annotate({
        description: "Tokenizer type used by the model",
      }),
      Schema.Literal("Llama4").annotate({
        description: "Tokenizer type used by the model",
      }),
      Schema.Literal("PaLM").annotate({
        description: "Tokenizer type used by the model",
      }),
      Schema.Literal("RWKV").annotate({
        description: "Tokenizer type used by the model",
      }),
      Schema.Literal("Qwen3").annotate({
        description: "Tokenizer type used by the model",
      }),
    ]).annotate({ description: "Tokenizer type used by the model" }),
    instruct_type: Schema.Union([
      Schema.Literal("none").annotate({
        description: "Instruction format type",
      }),
      Schema.Literal("airoboros").annotate({
        description: "Instruction format type",
      }),
      Schema.Literal("alpaca").annotate({
        description: "Instruction format type",
      }),
      Schema.Literal("alpaca-modif").annotate({
        description: "Instruction format type",
      }),
      Schema.Literal("chatml").annotate({
        description: "Instruction format type",
      }),
      Schema.Literal("claude").annotate({
        description: "Instruction format type",
      }),
      Schema.Literal("code-llama").annotate({
        description: "Instruction format type",
      }),
      Schema.Literal("gemma").annotate({
        description: "Instruction format type",
      }),
      Schema.Literal("llama2").annotate({
        description: "Instruction format type",
      ...
      Schema.Literal("nemotron").annotate({
        description: "Instruction format type",
      }),
      Schema.Literal("neural").annotate({
        description: "Instruction format type",
      }),
      Schema.Literal("openchat").annotate({
        description: "Instruction format type",
      }),
      Schema.Literal("phi3").annotate({
        description: "Instruction format type",
      }),
      Schema.Literal("rwkv").annotate({
        description: "Instruction format type",
      }),
      Schema.Literal("vicuna").annotate({
        description: "Instruction format type",
      }),
      Schema.Literal("zephyr").annotate({
        description: "Instruction format type",
      }),
      Schema.Literal("deepseek-r1").annotate({
        description: "Instruction format type",
      }),
      Schema.Literal("deepseek-v3.1").annotate({
        description: "Instruction format type",
      }),
      Schema.Literal("qwq").annotate({
        description: "Instruction format type",
      }),
      Schema.Literal("qwen3").annotate({
        description: "Instruction format type",
  ...
  endpoints: Schema.Array(PublicEndpoint).annotate({
          ...
          [
            Schema.Struct({
              ...
              url_citation: Schema.Struct({
                url: Schema.String,
                title: Schema.optionalKey(Schema.String),
                start_index: Schema.optionalKey(
                  Schema.Number.check(Schema.isFinite())
                ),
                end_index: Schema.optionalKey(
                  Schema.Number.check(Schema.isFinite())
                ),
...
export const SystemMessage = Schema.Struct({
  ...
  content: Schema.Union([
    Schema.String,
    Schema.Array(ChatMessageContentItemText),
  ]),
...
export const ModelsListResponseData = Schema.Array(Model).annotate({
...
export const ChatStreamingChoice = Schema.Struct({
  ...
  index: Schema.Number.check(Schema.isFinite()),
  logprobs: Schema.optionalKey(
    Schema.Union([ChatMessageTokenLogprobs, Schema.Null])
  ),
});
...
export const AssistantMessage = Schema.Struct({
  ...
  content: Schema.optionalKey(
    Schema.Union([
      Schema.Union([Schema.String, Schema.Array(ChatMessageContentItem)]),
      Schema.Null,
    ])
  ),
  name: Schema.optionalKey(Schema.String),
...
export const ModelsListResponse = Schema.Struct({
            ...
            Schema.Union([
              Schema.Union([
                ...
                Schema.Struct({
                  ...
                  text: Schema.String,
                  annotations: Schema.optionalKey(
                    Schema.Array(OpenAIResponsesAnnotation)
                  ),
                  logprobs: Schema.optionalKey(
                    Schema.Array(
                      Schema.Struct({
  ...
  usage: Schema.optionalKey(
    Schema.Struct({
      ...
      cost: Schema.optionalKey(
        Schema.Number.annotate({ description: "Cost of the completion" }).check(
          Schema.isFinite()
        )
      ),
      ...
      cost_details: Schema.optionalKey(
        Schema.Struct({
          ...
          upstream_inference_output_cost: Schema.Number.check(
            Schema.isFinite()
          ),
        })
      ),
...
export type ChatGenerationParams = {
  readonly provider?: {
    ...
    readonly quantizations?: ReadonlyArray<
      | "int4"
      | "int8"
      | "fp4"
      | "fp6"
  ...
  readonly plugins?: ReadonlyArray<
    ...
    | {
        ...
        readonly enabled?: boolean;
        readonly pdf?: {
          readonly engine?: "mistral-ocr" | "pdf-text" | "native";
        };
      }
    | { readonly id: "response-healing"; readonly enabled?: boolean }
  >;
...
export const ChatGenerationParams = Schema.Struct({
        ...
        max_price: Schema.optionalKey(
          Schema.Struct({
            prompt: Schema.optionalKey(
              Schema.Union([__schema11, ModelName, __schema13])
            ),
            completion: Schema.optionalKey(
              Schema.Union([__schema11, ModelName, __schema13])
            ),
            ...
            pdf: Schema.optionalKey(
              Schema.Struct({
                engine: Schema.optionalKey(
                  Schema.Literals(["mistral-ocr", "pdf-text", "native"])
                ),
              })
            ),
          }),
  ...
  route: Schema.optionalKey(
    Schema.Union([Schema.Literals(["fallback", "sort"]), Schema.Null])
  ),
  user: Schema.optionalKey(Schema.String),
  session_id: Schema.optionalKey(
    Schema.String.annotate({
  ...
  reasoning: Schema.optionalKey(
    Schema.Struct({
      ...
      summary: Schema.optionalKey(
        Schema.Union([ReasoningSummaryVerbosity, Schema.Null])
      ),
    })
  ),
  ...
  stop: Schema.optionalKey(
    Schema.Union([
      Schema.Union([
        Schema.String,
        Schema.Array(ModelName).check(Schema.isMaxLength(4)),
      ]),
      Schema.Null,
    ])
  ),
  ...
  stream_options: Schema.optionalKey(
    Schema.Union([ChatStreamOptions, Schema.Null])
  ),
  temperature: Schema.optionalKey(
    Schema.Union([
      Schema.Number.check(Schema.isFinite())
  ...
  debug: Schema.optionalKey(
    Schema.Struct({ echo_upstream_body: Schema.optionalKey(Schema.Boolean) })
  ),
  image_config: Schema.optionalKey(
    Schema.Struct({}).check(Schema.isPropertyNames(Schema.String))
  ),
...
export const CreateResponses200Sse = Schema.Struct({
...
export type CreateMessages200Sse = {
  ...
  readonly data: AnthropicMessagesStreamEvent;
};
export const CreateMessages200Sse = Schema.Struct({
  event: Schema.String,
  data: AnthropicMessagesStreamEvent,
});
...
export const GetUserActivity200 = Schema.Struct({
  data: Schema.Array(ActivityItem).annotate({
...
export const GetCredits200 = Schema.Struct({
  data: Schema.Struct({
    total_credits: Schema.Number.annotate({
      description: "Total credits purchased",
    }).check(Schema.isFinite()),
    total_usage: Schema.Number.annotate({
...
export const GetGenerationParams = Schema.Struct({
...
export const GetGeneration200 = Schema.Struct({
  data: Schema.Struct({
    ...
    app_id: Schema.Number.annotate({
      description: "ID of the app that made the request",
    }).check(Schema.isFinite()),
    streamed: Schema.Boolean.annotate({
    ...
    latency: Schema.Number.annotate({
      description: "Total latency in milliseconds",
    }).check(Schema.isFinite()),
    moderation_latency: Schema.Number.annotate({
      description: "Moderation latency in milliseconds",
    }).check(Schema.isFinite()),
    generation_time: Schema.Number.annotate({
      description: "Time taken for generation in milliseconds",
    }).check(Schema.isFinite()),
    finish_reason: Schema.String.annotate({
      description: "Reason the generation finished",
    }),
    tokens_prompt: Schema.Number.annotate({
      description: "Number of tokens in the prompt",
    }).check(Schema.isFinite()),
    tokens_completion: Schema.Number.annotate({
      description: "Number of tokens in the completion",
    }).check(Schema.isFinite()),
    native_tokens_prompt: Schema.Number.annotate({
...
export type ListEndpointsZdr200 = {
  readonly data: ReadonlyArray<PublicEndpoint>;
};
export const ListEndpointsZdr200 = Schema.Struct({
  data: Schema.Array(PublicEndpoint),
});
...
export const ListProviders200 = Schema.Struct({
  data: Schema.Array(
    Schema.Struct({
      ...
      privacy_policy_url: Schema.String.annotate({
...
export type ListParams = {
  readonly include_disabled?: string;
...
export const List200 = Schema.Struct({
  data: Schema.Array(
    Schema.Struct({
      ...
      limit_remaining: Schema.Number.annotate({
        description: "Remaining spending limit in USD",
      }).check(Schema.isFinite()),
      limit_reset: Schema.String.annotate({
      ...
      usage_daily: Schema.Number.annotate({
      ...
      byok_usage: Schema.Number.annotate({
...
export const UpdateKeysRequestJson = Schema.Struct({
  name: Schema.optionalKey(
    Schema.String.annotate({ description: "New name for the API key" })
  ),
  disabled: Schema.optionalKey(
    Schema.Boolean.annotate({ description: "Whether to disable the API key" })
  ),
  limit: Schema.optionalKey(
    Schema.Number.annotate({
...
export const ListGuardrails200 = Schema.Struct({
  data: Schema.Array(
    Schema.Struct({
      ...
      description: Schema.optionalKey(
        Schema.String.annotate({ description: "Description of the guardrail" })
      ),
      limit_usd: Schema.optionalKey(
        Schema.Number.annotate({ description: "Spending limit in USD" })
          .check(Schema.isFinite())
          .check(Schema.isGreaterThanOrEqualTo(0))
      ),
  ...
  total_count: Schema.Number.annotate({
...
export const CreateGuardrailRequestJson = Schema.Struct({
  name: Schema.String.annotate({ description: "Name for the new guardrail" })
    .check(Schema.isMinLength(1))
  ...
  allowed_providers: Schema.optionalKey(
    Schema.Array(Schema.String)
      .annotate({ description: "List of allowed provider IDs" })
      .check(Schema.isMinLength(1))
  ),
  allowed_models: Schema.optionalKey(
    Schema.Array(Schema.String)
...
export const UpdateGuardrailRequestJson = Schema.Struct({
  name: Schema.optionalKey(
    Schema.String.annotate({ description: "New name for the guardrail" })
      .check(Schema.isMinLength(1))
      .check(Schema.isMaxLength(200))
  ),
  description: Schema.optionalKey(
  ...
  limit_usd: Schema.optionalKey(
    Schema.Number.annotate({ description: "New spending limit in USD" })
      .check(Schema.isFinite())
      .check(Schema.isGreaterThanOrEqualTo(0))
  ),
  reset_interval: Schema.optionalKey(
  ...
  allowed_providers: Schema.optionalKey(
    Schema.Array(Schema.String)
      .annotate({ description: "New list of allowed provider IDs" })
      .check(Schema.isMinLength(1))
  ),
  allowed_models: Schema.optionalKey(
    Schema.Array(Schema.String)
...
export type ListKeyAssignmentsParams = {
  readonly offset?: string;
  readonly limit?: string;
};
...
export type ListMemberAssignmentsParams = {
  readonly offset?: string;
  readonly limit?: string;
};
...
export const ListMemberAssignments200 = Schema.Struct({
  data: Schema.Array(
    Schema.Struct({
      ...
      user_id: Schema.String.annotate({
...
export type ListGuardrailKeyAssignmentsParams = {
  readonly offset?: string;
  readonly limit?: string;
};
...
export type BulkAssignKeysToGuardrailRequestJson = {
  readonly key_hashes: ReadonlyArray<string>;
};
export const BulkAssignKeysToGuardrailRequestJson = Schema.Struct({
  key_hashes: Schema.Array(Schema.String.check(Schema.isMinLength(1)))
    .annotate({
...
export const BulkAssignKeysToGuardrail200 = Schema.Struct({
  assigned_count: Schema.Number.annotate({
...
export type ListGuardrailMemberAssignmentsParams = {
  readonly offset?: string;
  readonly limit?: string;
};
...
export type BulkAssignMembersToGuardrailRequestJson = {
  readonly member_user_ids: ReadonlyArray<string>;
};
export const BulkAssignMembersToGuardrailRequestJson = Schema.Struct({
  member_user_ids: Schema.Array(Schema.String.check(Schema.isMinLength(1)))
    .annotate({
      description: "Array of member user IDs to assign to the guardrail",
    })
    .check(Schema.isMinLength(1)),
});
export type BulkAssignMembersToGuardrail200 = {
...
export type BulkUnassignKeysFromGuardrailRequestJson = {
  readonly key_hashes: ReadonlyArray<string>;
};
...
export type BulkUnassignMembersFromGuardrailRequestJson = {
  readonly member_user_ids: ReadonlyArray<string>;
};
...
export const GetCurrentKey200 = Schema.Struct({
  data: Schema.Struct({
    ...
    is_free_tier: Schema.Boolean.annotate({
      description: "Whether this is a free tier API key",
    }),
    is_management_key: Schema.Boolean.annotate({
      description: "Whether this is a management key",
    }),
    is_provisioning_key: Schema.Boolean.annotate({
      description: "Whether this is a management key",
    }),
    limit_remaining: Schema.Number.annotate({
      description: "Remaining spending limit in USD",
...
export const ExchangeAuthCodeForAPIKeyRequestJson = Schema.Struct({
  ...
  code_challenge_method: Schema.optionalKey(
    Schema.Literals(["S256", "plain"]).annotate({
      description: "The method used to generate the code challenge",
    })
  ),
});
export type ExchangeAuthCodeForAPIKey200 = {
  readonly key: string;
  readonly user_id: string;
};
...
export const make = (
  ...
  const sseRequest =
    <Type, DecodingServices>(schema: Schema.Decoder<Type, DecodingServices>) =>
    (
      request: HttpClientRequest.HttpClientRequest
    ): Stream.Stream<
      {
      ...
      HttpClientRequest.post(`/credits/coinbase`).pipe(
        ...
        withResponse(options.config)(
          HttpClientResponse.matchStatus({
            ...
            "400": decodeError(
              "CreateCoinbaseCharge400",
              CreateCoinbaseCharge400
            ),
            "401": decodeError(
              "CreateCoinbaseCharge401",
              CreateCoinbaseCharge401
            ),
            "429": decodeError(
    ...
    getModels: (options) =>
      HttpClientRequest.get(`/models`).pipe(
        HttpClientRequest.setUrlParams({
          ...
          supported_parameters: options?.params?.[
      ...
      HttpClientRequest.get(`/guardrails/assignments/members`).pipe(
        ...
        withResponse(options?.config)(
          HttpClientResponse.matchStatus({
            ...
            "401": decodeError(
              "ListMemberAssignments401",
              ListMemberAssignments401
            ),
            "500": decodeError(
              "ListMemberAssignments500",
              ListMemberAssignments500
            ),
            orElse: unexpectedStatus,
          })
      ...
      HttpClientRequest.get(`/guardrails/${id}/assignments/keys`).pipe(
        ...
        withResponse(options?.config)(
          HttpClientResponse.matchStatus({
            ...
            "401": decodeError(
              "ListGuardrailKeyAssignments401",
              ListGuardrailKeyAssignments401
            ),
            "404": decodeError(
              "ListGuardrailKeyAssignments404",
              ListGuardrailKeyAssignments404
            ),
            "500": decodeError(
              "ListGuardrailKeyAssignments500",
              ListGuardrailKeyAssignments500
            ),
            orElse: unexpectedStatus,
          })
      ...
      HttpClientRequest.post(`/guardrails/${id}/assignments/keys`).pipe(
        ...
        withResponse(options.config)(
          HttpClientResponse.matchStatus({
            ...
            "404": decodeError(
              "BulkAssignKeysToGuardrail404",
              BulkAssignKeysToGuardrail404
            ),
            "500": decodeError(
              "BulkAssignKeysToGuardrail500",
              BulkAssignKeysToGuardrail500
            ),
            orElse: unexpectedStatus,
          })
      ...
      HttpClientRequest.get(`/guardrails/${id}/assignments/members`).pipe(
        ...
        withResponse(options?.config)(
          HttpClientResponse.matchStatus({
            ...
            "404": decodeError(
              "ListGuardrailMemberAssignments404",
              ListGuardrailMemberAssignments404
            ),
            "500": decodeError(
              "ListGuardrailMemberAssignments500",
              ListGuardrailMemberAssignments500
            ),
            orElse: unexpectedStatus,
          })
      ...
      HttpClientRequest.post(`/guardrails/${id}/assignments/members`).pipe(
        ...
        withResponse(options.config)(
          HttpClientResponse.matchStatus({
            ...
            "401": decodeError(
              "BulkAssignMembersToGuardrail401",
              BulkAssignMembersToGuardrail401
            ),
            "404": decodeError(
              "BulkAssignMembersToGuardrail404",
              BulkAssignMembersToGuardrail404
            ),
            "500": decodeError(
      ...
      HttpClientRequest.post(`/guardrails/${id}/assignments/keys/remove`).pipe(
        ...
        withResponse(options.config)(
          HttpClientResponse.matchStatus({
            ...
            "400": decodeError(
              "BulkUnassignKeysFromGuardrail400",
              BulkUnassignKeysFromGuardrail400
            ),
            "401": decodeError(
            ...
            "404": decodeError(
              "BulkUnassignKeysFromGuardrail404",
              BulkUnassignKeysFromGuardrail404
            ),
            "500": decodeError(
              "BulkUnassignKeysFromGuardrail500",
              BulkUnassignKeysFromGuardrail500
            ),
            orElse: unexpectedStatus,
          })
      ...
      HttpClientRequest.post(
        ...
        withResponse(options.config)(
          HttpClientResponse.matchStatus({
            ...
            "404": decodeError(
              "BulkUnassignMembersFromGuardrail404",
              BulkUnassignMembersFromGuardrail404
            ),
            "500": decodeError(
              "BulkUnassignMembersFromGuardrail500",
              BulkUnassignMembersFromGuardrail500
            ),
            orElse: unexpectedStatus,
          })
      ...
      HttpClientRequest.post(`/auth/keys`).pipe(
        ...
        withResponse(options.config)(
          HttpClientResponse.matchStatus({
            ...
            "400": decodeError(
              "ExchangeAuthCodeForAPIKey400",
              ExchangeAuthCodeForAPIKey400
            ),
            "403": decodeError(
              "ExchangeAuthCodeForAPIKey403",
              ExchangeAuthCodeForAPIKey403
            ),
            "500": decodeError(
      ...
      HttpClientRequest.post(`/chat/completions`).pipe(
        ...
        withResponse(options.config)(
          HttpClientResponse.matchStatus({
            ...
            "400": decodeError(
              "SendChatCompletionRequest400",
              SendChatCompletionRequest400
            ),
            "401": decodeError(
              "SendChatCompletionRequest401",
              SendChatCompletionRequest401
            ),
            "429": decodeError(
...
export interface OpenRouterClient {
   ...
   */
  readonly createResponses: <Config extends OperationConfig>(options: {
    readonly payload: typeof CreateResponsesRequestJson.Encoded;
    ...
    | OpenRouterClientError<
        "CreateResponses400",
        typeof CreateResponses400.Type
      >
    | OpenRouterClientError<
        "CreateResponses401",
        typeof CreateResponses401.Type
      >
    | OpenRouterClientError<
        "CreateResponses402",
        typeof CreateResponses402.Type
      >
    | OpenRouterClientError<
        "CreateResponses404",
        typeof CreateResponses404.Type
      >
    | OpenRouterClientError<
        "CreateResponses408",
        typeof CreateResponses408.Type
      >
    | OpenRouterClientError<
        "CreateResponses413",
        typeof CreateResponses413.Type
      >
    | OpenRouterClientError<
        "CreateResponses422",
        typeof CreateResponses422.Type
      >
    | OpenRouterClientError<
        "CreateResponses429",
        typeof CreateResponses429.Type
      >
    | OpenRouterClientError<
        "CreateResponses500",
        typeof CreateResponses500.Type
      >
    | OpenRouterClientError<
        "CreateResponses502",
        typeof CreateResponses502.Type
      >
    | OpenRouterClientError<
        "CreateResponses503",
        typeof CreateResponses503.Type
      >
    | OpenRouterClientError<
        "CreateResponses524",
        typeof CreateResponses524.Type
      >
    | OpenRouterClientError<
        "CreateResponses529",
        typeof CreateResponses529.Type
      >
  >;
  /**
   * Creates a streaming or non-streaming response using OpenResponses API format
   */
  readonly createResponsesSse: (options: {
    readonly payload: typeof CreateResponsesRequestJson.Encoded;
  }) => Stream.Stream<
    {
      readonly event: string;
      readonly id: string | undefined;
      readonly data: typeof CreateResponses200Sse.Type;
    },
    HttpClientError.HttpClientError | SchemaError | Sse.Retry,
   ...
   */
  readonly createMessages: <Config extends OperationConfig>(options: {
    readonly payload: typeof CreateMessagesRequestJson.Encoded;
    readonly config?: Config | undefined;
  }) => Effect.Effect<
   ...
   * Creates a message using the Anthropic Messages API format. Supports text, images, PDFs, tools, and extended thinking.
   */
  readonly createMessagesSse: (options: {
    readonly payload: typeof CreateMessagesRequestJson.Encoded;
  }) => Stream.Stream<
    {
      readonly event: string;
      readonly id: string | undefined;
      readonly data: typeof CreateMessages200Sse.Type;
    },
    HttpClientError.HttpClientError | SchemaError | Sse.Retry,
  ...
  readonly getUserActivity: <Config extends OperationConfig>(
    ...
    | OpenRouterClientError<
        "GetUserActivity400",
        typeof GetUserActivity400.Type
      >
    | OpenRouterClientError<
        "GetUserActivity401",
        typeof GetUserActivity401.Type
      >
    | OpenRouterClientError<
        "GetUserActivity403",
        typeof GetUserActivity403.Type
      >
    | OpenRouterClientError<
        "GetUserActivity500",
        typeof GetUserActivity500.Type
      >
  >;
  /**
   ...
   */
  readonly createCoinbaseCharge: <Config extends OperationConfig>(options: {
    readonly payload: typeof CreateCoinbaseChargeRequestJson.Encoded;
    readonly config?: Config | undefined;
  }) => Effect.Effect<
    ...
    | OpenRouterClientError<
        "CreateCoinbaseCharge400",
        typeof CreateCoinbaseCharge400.Type
      >
    | OpenRouterClientError<
        "CreateCoinbaseCharge401",
        typeof CreateCoinbaseCharge401.Type
      >
    | OpenRouterClientError<
        "CreateCoinbaseCharge429",
        typeof CreateCoinbaseCharge429.Type
      >
    | OpenRouterClientError<
        "CreateCoinbaseCharge500",
        typeof CreateCoinbaseCharge500.Type
      >
  >;
  /**
   * Submits an embedding request to the embeddings router
   */
  readonly createEmbeddings: <Config extends OperationConfig>(options: {
    readonly payload: typeof CreateEmbeddingsRequestJson.Encoded;
    readonly config?: Config | undefined;
  }) => Effect.Effect<
    ...
    | OpenRouterClientError<
        "CreateEmbeddings400",
        typeof CreateEmbeddings400.Type
      >
    | OpenRouterClientError<
        "CreateEmbeddings401",
        typeof CreateEmbeddings401.Type
      >
    | OpenRouterClientError<
        "CreateEmbeddings402",
        typeof CreateEmbeddings402.Type
      >
    | OpenRouterClientError<
        "CreateEmbeddings404",
        typeof CreateEmbeddings404.Type
      >
    | OpenRouterClientError<
        "CreateEmbeddings429",
        typeof CreateEmbeddings429.Type
      >
    | OpenRouterClientError<
        "CreateEmbeddings500",
        typeof CreateEmbeddings500.Type
      >
    | OpenRouterClientError<
        "CreateEmbeddings502",
        typeof CreateEmbeddings502.Type
      >
    | OpenRouterClientError<
        "CreateEmbeddings503",
        typeof CreateEmbeddings503.Type
      >
    | OpenRouterClientError<
        "CreateEmbeddings524",
        typeof CreateEmbeddings524.Type
      >
    | OpenRouterClientError<
        "CreateEmbeddings529",
        typeof CreateEmbeddings529.Type
      >
  >;
  /**
   * Submits an embedding request to the embeddings router
   */
  readonly createEmbeddingsSse: (options: {
    readonly payload: typeof CreateEmbeddingsRequestJson.Encoded;
  }) => Stream.Stream<
    {
      readonly event: string;
      readonly id: string | undefined;
      readonly data: typeof CreateEmbeddings200Sse.Type;
    },
    HttpClientError.HttpClientError | SchemaError | Sse.Retry,
  ...
  readonly listEmbeddingsModels: <Config extends OperationConfig>(
    ...
    | OpenRouterClientError<
        "ListEmbeddingsModels400",
        typeof ListEmbeddingsModels400.Type
      >
    | OpenRouterClientError<
        "ListEmbeddingsModels500",
        typeof ListEmbeddingsModels500.Type
      >
  >;
  /**
   * Get request & usage metadata for a generation
   */
  readonly getGeneration: <Config extends OperationConfig>(options: {
    readonly params: typeof GetGenerationParams.Encoded;
    readonly config?: Config | undefined;
  }) => Effect.Effect<
  ...
  readonly listModelsCount: <Config extends OperationConfig>(
    ...
    | OpenRouterClientError<
        "ListModelsCount500",
        typeof ListModelsCount500.Type
      >
  >;
  /**
  ...
  readonly getModels: <Config extends OperationConfig>(
    options:
      | {
          readonly params?: typeof GetModelsParams.Encoded | undefined;
          readonly config?: Config | undefined;
        }
      | undefined
  ) => Effect.Effect<
  ...
  readonly listEndpointsZdr: <Config extends OperationConfig>(
    ...
    | OpenRouterClientError<
        "ListEndpointsZdr500",
        typeof ListEndpointsZdr500.Type
      >
  >;
  /**
   * List all providers
  ...
  readonly list: <Config extends OperationConfig>(
    options:
      | {
          readonly params?: typeof ListParams.Encoded | undefined;
          readonly config?: Config | undefined;
        }
      | undefined
  ) => Effect.Effect<
   ...
   */
  readonly createKeys: <Config extends OperationConfig>(options: {
    readonly payload: typeof CreateKeysRequestJson.Encoded;
    readonly config?: Config | undefined;
  }) => Effect.Effect<
  ...
  readonly updateKeys: <Config extends OperationConfig>(
    hash: string,
    options: {
      readonly payload: typeof UpdateKeysRequestJson.Encoded;
      readonly config?: Config | undefined;
    }
  ) => Effect.Effect<
  ...
  readonly listGuardrails: <Config extends OperationConfig>(
    options:
      | {
          readonly params?: typeof ListGuardrailsParams.Encoded | undefined;
          readonly config?: Config | undefined;
        }
      | undefined
  ) => Effect.Effect<
   ...
   */
  readonly createGuardrail: <Config extends OperationConfig>(options: {
    readonly payload: typeof CreateGuardrailRequestJson.Encoded;
    readonly config?: Config | undefined;
  }) => Effect.Effect<
    ...
    | OpenRouterClientError<
        "CreateGuardrail400",
        typeof CreateGuardrail400.Type
      >
    | OpenRouterClientError<
        "CreateGuardrail401",
        typeof CreateGuardrail401.Type
      >
    | OpenRouterClientError<
        "CreateGuardrail500",
        typeof CreateGuardrail500.Type
      >
  >;
  /**
  ...
  readonly deleteGuardrail: <Config extends OperationConfig>(
    ...
    | OpenRouterClientError<
        "DeleteGuardrail401",
        typeof DeleteGuardrail401.Type
      >
    | OpenRouterClientError<
        "DeleteGuardrail404",
        typeof DeleteGuardrail404.Type
      >
    | OpenRouterClientError<
        "DeleteGuardrail500",
        typeof DeleteGuardrail500.Type
      >
  >;
  /**
  ...
  readonly updateGuardrail: <Config extends OperationConfig>(
    id: string,
    options: {
      readonly payload: typeof UpdateGuardrailRequestJson.Encoded;
      readonly config?: Config | undefined;
    }
  ) => Effect.Effect<
    ...
    | OpenRouterClientError<
        "UpdateGuardrail400",
        typeof UpdateGuardrail400.Type
      >
    | OpenRouterClientError<
        "UpdateGuardrail401",
        typeof UpdateGuardrail401.Type
      >
    | OpenRouterClientError<
        "UpdateGuardrail404",
    ...
    | OpenRouterClientError<
        "UpdateGuardrail500",
        typeof UpdateGuardrail500.Type
      >
  >;
  /**
  ...
  readonly listKeyAssignments: <Config extends OperationConfig>(
    ...
    | OpenRouterClientError<
        ...
        typeof ListKeyAssignments401.Type
      >
    | OpenRouterClientError<
        "ListKeyAssignments500",
        typeof ListKeyAssignments500.Type
      >
  >;
  /**
  ...
  readonly listMemberAssignments: <Config extends OperationConfig>(
    options:
      | {
          readonly params?:
            | typeof ListMemberAssignmentsParams.Encoded
            | undefined;
          readonly config?: Config | undefined;
        }
      | undefined
    ...
    | OpenRouterClientError<
        "ListMemberAssignments401",
        typeof ListMemberAssignments401.Type
      >
    | OpenRouterClientError<
        "ListMemberAssignments500",
        typeof ListMemberAssignments500.Type
      >
  >;
  /**
  ...
  readonly listGuardrailKeyAssignments: <Config extends OperationConfig>(
    ...
    options:
      | {
          readonly params?:
            | typeof ListGuardrailKeyAssignmentsParams.Encoded
            | undefined;
          readonly config?: Config | undefined;
        }
      | undefined
    ...
    | OpenRouterClientError<
        "ListGuardrailKeyAssignments401",
        typeof ListGuardrailKeyAssignments401.Type
      >
    | OpenRouterClientError<
        "ListGuardrailKeyAssignments404",
        typeof ListGuardrailKeyAssignments404.Type
      >
    | OpenRouterClientError<
        "ListGuardrailKeyAssignments500",
        typeof ListGuardrailKeyAssignments500.Type
      >
  >;
  /**
  ...
  readonly bulkAssignKeysToGuardrail: <Config extends OperationConfig>(
    ...
    | OpenRouterClientError<
        "BulkAssignKeysToGuardrail400",
        typeof BulkAssignKeysToGuardrail400.Type
      >
    | OpenRouterClientError<
        "BulkAssignKeysToGuardrail401",
        typeof BulkAssignKeysToGuardrail401.Type
      >
    | OpenRouterClientError<
        "BulkAssignKeysToGuardrail404",
        typeof BulkAssignKeysToGuardrail404.Type
      >
    | OpenRouterClientError<
        "BulkAssignKeysToGuardrail500",
        typeof BulkAssignKeysToGuardrail500.Type
      >
  >;
  /**
  ...
  readonly listGuardrailMemberAssignments: <Config extends OperationConfig>(
    ...
    options:
      | {
          readonly params?:
            | typeof ListGuardrailMemberAssignmentsParams.Encoded
            | undefined;
          readonly config?: Config | undefined;
        }
      | undefined
    ...
    | OpenRouterClientError<
        "ListGuardrailMemberAssignments401",
        typeof ListGuardrailMemberAssignments401.Type
      >
    | OpenRouterClientError<
        "ListGuardrailMemberAssignments404",
        typeof ListGuardrailMemberAssignments404.Type
      >
    | OpenRouterClientError<
        "ListGuardrailMemberAssignments500",
        typeof ListGuardrailMemberAssignments500.Type
      >
  >;
  /**
  ...
  readonly bulkAssignMembersToGuardrail: <Config extends OperationConfig>(
    ...
    | OpenRouterClientError<
        "BulkAssignMembersToGuardrail400",
        typeof BulkAssignMembersToGuardrail400.Type
      >
    | OpenRouterClientError<
        "BulkAssignMembersToGuardrail401",
        typeof BulkAssignMembersToGuardrail401.Type
      >
    | OpenRouterClientError<
        "BulkAssignMembersToGuardrail404",
        typeof BulkAssignMembersToGuardrail404.Type
      >
    | OpenRouterClientError<
        "BulkAssignMembersToGuardrail500",
        typeof BulkAssignMembersToGuardrail500.Type
      >
  >;
  /**
  ...
  readonly bulkUnassignKeysFromGuardrail: <Config extends OperationConfig>(
    ...
    | OpenRouterClientError<
        "BulkUnassignKeysFromGuardrail400",
        typeof BulkUnassignKeysFromGuardrail400.Type
      >
    | OpenRouterClientError<
        "BulkUnassignKeysFromGuardrail401",
        typeof BulkUnassignKeysFromGuardrail401.Type
      >
    | OpenRouterClientError<
        "BulkUnassignKeysFromGuardrail404",
        typeof BulkUnassignKeysFromGuardrail404.Type
      >
    | OpenRouterClientError<
        "BulkUnassignKeysFromGuardrail500",
        typeof BulkUnassignKeysFromGuardrail500.Type
      >
  >;
  /**
  ...
  readonly bulkUnassignMembersFromGuardrail: <Config extends OperationConfig>(
    ...
    | OpenRouterClientError<
        "BulkUnassignMembersFromGuardrail400",
        typeof BulkUnassignMembersFromGuardrail400.Type
      >
    | OpenRouterClientError<
        "BulkUnassignMembersFromGuardrail401",
        typeof BulkUnassignMembersFromGuardrail401.Type
      >
    | OpenRouterClientError<
        "BulkUnassignMembersFromGuardrail404",
        typeof BulkUnassignMembersFromGuardrail404.Type
      >
    | OpenRouterClientError<
        "BulkUnassignMembersFromGuardrail500",
        typeof BulkUnassignMembersFromGuardrail500.Type
      >
  >;
  /**
  ...
  >(options: {
    ...
    | OpenRouterClientError<
        "ExchangeAuthCodeForAPIKey400",
        typeof ExchangeAuthCodeForAPIKey400.Type
      >
    | OpenRouterClientError<
        "ExchangeAuthCodeForAPIKey403",
        typeof ExchangeAuthCodeForAPIKey403.Type
      >
    | OpenRouterClientError<
        "ExchangeAuthCodeForAPIKey500",
        typeof ExchangeAuthCodeForAPIKey500.Type
      >
  >;
  /**
   * Create an authorization code for the PKCE flow to generate a user-controlled API key
   */
  readonly createAuthKeysCode: <Config extends OperationConfig>(options: {
    readonly payload: typeof CreateAuthKeysCodeRequestJson.Encoded;
    readonly config?: Config | undefined;
  }) => Effect.Effect<
    ...
    | SchemaError
    | OpenRouterClientError<
        "CreateAuthKeysCode400",
        typeof CreateAuthKeysCode400.Type
      >
    | OpenRouterClientError<
        "CreateAuthKeysCode401",
        typeof CreateAuthKeysCode401.Type
      >
    | OpenRouterClientError<
        "CreateAuthKeysCode500",
        typeof CreateAuthKeysCode500.Type
      >
  >;
  /**
  ...
  >(options: {
    ...
    | OpenRouterClientError<
        "SendChatCompletionRequest400",
        typeof SendChatCompletionRequest400.Type
      >
    | OpenRouterClientError<
        "SendChatCompletionRequest401",
        typeof SendChatCompletionRequest401.Type
      >
    | OpenRouterClientError<
        "SendChatCompletionRequest429",
        typeof SendChatCompletionRequest429.Type
      >
    | OpenRouterClientError<
        "SendChatCompletionRequest500",
        typeof SendChatCompletionRequest500.Type
      >
  >;
  /**
   * Sends a request for a model response for the given chat conversation. Supports both streaming and non-streaming modes.
   */
  readonly sendChatCompletionRequestSse: (options: {
    readonly payload: typeof SendChatCompletionRequestRequestJson.Encoded;
  }) => Stream.Stream<
    {
      readonly event: string;
