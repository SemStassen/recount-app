...
export const ProviderOptionsKey =
  "@effect/ai-openai-compat/OpenAiLanguageModel/ProviderOptions";

/** @internal */
export const ProviderMetadataKey =
  "@effect/ai-openai-compat/OpenAiLanguageModel/ProviderMetadata";
...
/** @internal */
export const escapeJSONDelta = (delta: string): string =>
