 ...
 * @category registry
 */
export const registryKey = Symbol.for(
  "@effect/atom-vue/registryKey"
) as InjectionKey<AtomRegistry.AtomRegistry>;
  ...
  return ((value: W | ((value: R) => W)) => {
    registry.set(
      ...
      typeof value === "function"
        ? (value as any)(registry.get(atomRef.value))
        : value
    );
  }) as any;
}
