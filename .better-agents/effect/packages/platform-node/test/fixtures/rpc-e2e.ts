...
>()("UsersClient") {
  ...
  static layerTest = Layer.effect(UsersClient)(
  ...
  describe(name, { concurrent, timeout: 30_000 }, () => {
    it.effect("should get user", () =>
      Effect.gen(function* () {
        ...
        assert.deepStrictEqual(
          user,
          new User({ id: "1", name: "Logged in user" })
        );
    ...
    it.effect("headers", () =>
      Effect.gen(function* () {
        ...
        assert.deepStrictEqual(
          user,
          new User({ id: "123", name: "Logged in user" })
        );
    ...
    it.effect("timing middleware", () =>
      Effect.gen(function* () {
        ...
        const { count, defect, success } =
          yield* client.GetTimingMiddlewareMetrics();
