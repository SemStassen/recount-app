 ...
 * @since 4.0.0
 */
export const logLevelToSeverityNumber = (
...
> = Effect.gen(function* () {
  ...
  return Logger.make((options) => {
    ...
    for (const [label, startTime] of options.fiber.getRef(
...
export const layerLoggerProvider = (
  processor:
    ...
    | NonEmptyReadonlyArray<Otel.LogRecordProcessor>,
